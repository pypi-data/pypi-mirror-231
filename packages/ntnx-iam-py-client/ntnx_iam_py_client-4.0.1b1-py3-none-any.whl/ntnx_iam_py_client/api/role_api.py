...
class RoleApi(object):
    ...
    def list_role_api(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """List role(s)
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authz.ListRoleApiResponse`.
    ...
    def update_role_api(self, extId, body, **kwargs):  # noqa: E501
        """Update role

        >>> response = api.update_role_api(extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_role_api(extId, body, async_req=True)
        >>> result = thread.get()
    ...
    def view_role_api(self, extId, **kwargs):  # noqa: E501
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authz.ViewRoleApiResponse`.
