...
class AuthorizationPolicyApi(object):
    """IGNORE:
    ...
    def create_authorization_policy_api(self, body, **kwargs):  # noqa: E501
        """Create authorization policy

        >>> response = api.create_authorization_policy_api(body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.create_authorization_policy_api(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_authorization_policy_api`")  # noqa: E501
    ...
    def delete_authorization_policy_api(self, extId, **kwargs):  # noqa: E501
        """Delete authorization policy

        >>> response = api.delete_authorization_policy_api(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.delete_authorization_policy_api(extId, async_req=True)
        >>> result = thread.get()
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `delete_authorization_policy_api`")  # noqa: E501
    ...
    def list_authorization_policy_api(self, _page=None, _limit=None, _filter=None, _orderby=None, _expand=None, _select=None, **kwargs):  # noqa: E501
        """List authorization policy(ies)

        >>> response = api.list_authorization_policy_api((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _expand, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_authorization_policy_api(async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authz.ListAuthorizationPolicyApiResponse`.
        ...
        if kwargs.get('async_req'):
            return self.api_client._call_api(
                ...
                post_params=form_params,
                files=local_var_files,
                response_type='iam.v4.authz.ListAuthorizationPolicyApiResponse',  # noqa: E501
                auth_settings=auth_settings,
                async_req=params.get('async_req'),
                _return_http_data_only=params.get('_return_http_data_only'),
                _preload_content=params.get('_preload_content', True),
    ...
    def update_authorization_policy_api(self, extId, body, **kwargs):  # noqa: E501
        """Update authorization policy

        >>> response = api.update_authorization_policy_api(extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_authorization_policy_api(extId, body, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `update_authorization_policy_api`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_authorization_policy_api`")  # noqa: E501
    ...
    def view_authorization_policy_api(self, extId, **kwargs):  # noqa: E501
        """Get authorization policy

        >>> response = api.view_authorization_policy_api(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.view_authorization_policy_api(extId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authz.ViewAuthorizationPolicyApiResponse`.
        ...
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `view_authorization_policy_api`")  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.api_client._call_api(
                ...
                post_params=form_params,
                files=local_var_files,
                response_type='iam.v4.authz.ViewAuthorizationPolicyApiResponse',  # noqa: E501
                auth_settings=auth_settings,
                async_req=params.get('async_req'),
                _return_http_data_only=params.get('_return_http_data_only'),
                _preload_content=params.get('_preload_content', True),
