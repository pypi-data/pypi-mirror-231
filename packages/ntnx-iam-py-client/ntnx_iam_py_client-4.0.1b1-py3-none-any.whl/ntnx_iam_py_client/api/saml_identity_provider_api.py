...
class SamlIdentityProviderApi(object):
    ...
    def get_saml_identity_provider_list(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authn.ListSamlIdentityProviderApiResponse`.
    ...
    def update_saml_identity_provider(self, extId, body, **kwargs):  # noqa: E501
        """Update SAML Identity Provider

        >>> response = api.update_saml_identity_provider(extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_saml_identity_provider(extId, body, async_req=True)
        >>> result = thread.get()
