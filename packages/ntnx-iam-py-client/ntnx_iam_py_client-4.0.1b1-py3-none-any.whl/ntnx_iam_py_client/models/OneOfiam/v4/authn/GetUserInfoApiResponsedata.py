...
class GetUserInfoApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'iam.v4.authn.OidcUserinfo': 'iam.v4.authn.OidcUserinfo',
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.GetUserInfoApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetUserInfoApiResponsedata.discriminator_value_class_map.values():
            return list(GetUserInfoApiResponsedata.discriminator_value_class_map.keys())[list(GetUserInfoApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetUserInfoApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetUserInfoApiResponsedata):
            return False
