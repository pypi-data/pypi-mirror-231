...
class ListAuthorizationPolicyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authz.ListAuthorizationPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListAuthorizationPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(ListAuthorizationPolicyApiResponsedata.discriminator_value_class_map.keys())[list(ListAuthorizationPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListAuthorizationPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAuthorizationPolicyApiResponsedata):
            return False
