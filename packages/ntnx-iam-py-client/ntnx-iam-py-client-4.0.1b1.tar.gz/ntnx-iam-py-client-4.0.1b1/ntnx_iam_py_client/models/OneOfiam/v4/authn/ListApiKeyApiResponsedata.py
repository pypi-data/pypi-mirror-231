...
class ListApiKeyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.ListApiKeyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListApiKeyApiResponsedata.discriminator_value_class_map.values():
            return list(ListApiKeyApiResponsedata.discriminator_value_class_map.keys())[list(ListApiKeyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListApiKeyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListApiKeyApiResponsedata):
            return False
