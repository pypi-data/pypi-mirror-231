...
from ntnx_iam_py_client.models.OneOfiam.v4.tenant.TenantConfigurationResponsedata import TenantConfigurationResponsedata  # noqa: F401,E501
from ntnx_iam_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class TenantConfigurationResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfiam.v4.tenant.TenantConfigurationResponsedata',
    ...
    def _initialize_object_type(self):
        return 'iam.v4.tenant.TenantConfigurationResponse'

    def _initialize_fq_object_type(self):
        return 'iam.v4.r0.b1.tenant.TenantConfigurationResponse'
    ...
    def _to_dict(self, sanitize):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if attr_type.startswith('OneOf'):
                type = getattr(ntnx_iam_py_client.models, 'TenantTenantConfigurationResponse')
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(TenantConfigurationResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TenantConfigurationResponse):
            return False
