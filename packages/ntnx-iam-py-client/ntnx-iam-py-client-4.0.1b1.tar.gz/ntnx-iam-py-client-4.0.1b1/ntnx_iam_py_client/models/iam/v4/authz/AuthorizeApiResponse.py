...
from ntnx_iam_py_client.models.OneOfiam.v4.authz.AuthorizeApiResponsedata import AuthorizeApiResponsedata  # noqa: F401,E501
from ntnx_iam_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class AuthorizeApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfiam.v4.authz.AuthorizeApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'iam.v4.authz.AuthorizeApiResponse'

    def _initialize_fq_object_type(self):
        return 'iam.v4.r0.b1.authz.AuthorizeApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_iam_py_client.models.iam.v4.authz.AuthorizationResponse` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AuthorizeApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthorizeApiResponse):
            return False
