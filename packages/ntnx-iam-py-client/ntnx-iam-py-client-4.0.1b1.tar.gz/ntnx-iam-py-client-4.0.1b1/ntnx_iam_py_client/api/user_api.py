...
class UserApi(object):
    ...
    def create_user_bucket_key(self, extId, body, **kwargs):  # noqa: E501
        """Create bucket access key for user

        >>> response = api.create_user_bucket_key(extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.create_user_bucket_key(extId, body, async_req=True)
        >>> result = thread.get()

        :param extId: External Identifier of the user
        :type extId:
            :class:`str`, required
        :param body: Create access key Id and secret access key to call Nutanix Buckets service.
        :type body:
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `create_user_bucket_key`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_user_bucket_key`")  # noqa: E501
    ...
    def get_user_bucket_keys(self, extId, _page=None, _limit=None, _filter=None, _orderby=None, **kwargs):  # noqa: E501
        """List bucket access keys of user

        >>> response = api.get_user_bucket_keys(extId, (optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_user_bucket_keys(extId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authn.ListUserKeyApiResponse`.
        ...
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_user_bucket_keys`")  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.api_client._call_api(
                ...
                post_params=form_params,
                files=local_var_files,
                response_type='iam.v4.authn.ListUserKeyApiResponse',  # noqa: E501
                auth_settings=auth_settings,
                async_req=params.get('async_req'),
                _return_http_data_only=params.get('_return_http_data_only'),
                _preload_content=params.get('_preload_content', True),
    ...
    def get_user_list(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """List user(s)
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authn.ListUserApiResponse`.
    ...
    def update_user(self, extId, body, **kwargs):  # noqa: E501
        """Update user

        >>> response = api.update_user(extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_user(extId, body, async_req=True)
        >>> result = thread.get()
