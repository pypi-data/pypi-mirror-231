...
class UserGroupApi(object):
    ...
    def get_user_group_list(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """List user group(s)

        >>> response = api.get_user_group_list((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authn.ListUserGroupApiResponse`.
        ...
        if kwargs.get('async_req'):
            return self.api_client._call_api(
                ...
                post_params=form_params,
                files=local_var_files,
                response_type='iam.v4.authn.ListUserGroupApiResponse',  # noqa: E501
                auth_settings=auth_settings,
                async_req=params.get('async_req'),
                _return_http_data_only=params.get('_return_http_data_only'),
                _preload_content=params.get('_preload_content', True),
