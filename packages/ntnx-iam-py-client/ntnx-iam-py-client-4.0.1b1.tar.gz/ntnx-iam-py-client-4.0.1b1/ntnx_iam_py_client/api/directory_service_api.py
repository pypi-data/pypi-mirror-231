...
class DirectoryServiceApi(object):
    ...
    def get_directory_service_list(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authn.ListDirectoryServiceApiResponse`.
    ...
    def update_directory_service(self, extId, body, **kwargs):  # noqa: E501
        """Update directory service

        >>> response = api.update_directory_service(extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_directory_service(extId, body, async_req=True)
        >>> result = thread.get()
