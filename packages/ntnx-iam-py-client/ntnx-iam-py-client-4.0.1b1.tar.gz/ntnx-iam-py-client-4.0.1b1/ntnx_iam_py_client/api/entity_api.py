...
class EntityApi(object):
    ...
    def list_entity_api(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """List entities

        >>> response = api.list_entity_api((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_entity_api(async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authz.ListEntityApiResponse`.
        ...
        if kwargs.get('async_req'):
            return self.api_client._call_api(
                ...
                response_type='iam.v4.authz.ListEntityApiResponse',  # noqa: E501
    ...
    def view_entity_api(self, extId, **kwargs):  # noqa: E501
        """Get entity

        >>> response = api.view_entity_api(extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.view_entity_api(extId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_iam_py_client.models.iam.v4.authz.ViewEntityApiResponse`.
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `view_entity_api`")  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.api_client._call_api(
                ...
                post_params=form_params,
                files=local_var_files,
                response_type='iam.v4.authz.ViewEntityApiResponse',  # noqa: E501
                auth_settings=auth_settings,
                async_req=params.get('async_req'),
                _return_http_data_only=params.get('_return_http_data_only'),
                _preload_content=params.get('_preload_content', True),
