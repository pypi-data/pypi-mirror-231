...
class AnyaTable(Component):
    """An AnyaTable component.
...
- columns (list of dicts; optional):
    ...
    - renderOptions (dict; optional)
        ...
        - renderType (a value equal to: 'row-merge', 'text', 'icon'; optional)
...
- style (dict; optional):
    Inline CSS style."""
    _children_props = ['columns[].title', 'data[]{}']
    _base_nodes = ['children']
    _namespace = 'anya_dash'
    _type = 'AnyaTable'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, columns=Component.UNDEFINED, data=Component.UNDEFINED, bordered=Component.UNDEFINED, maxHeight=Component.UNDEFINED, maxWidth=Component.UNDEFINED, size=Component.UNDEFINED, pagination=Component.UNDEFINED, cellUpdateOptimize=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'bordered', 'cellUpdateOptimize', 'className', 'columns', 'data', 'maxHeight', 'maxWidth', 'pagination', 'size', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'bordered', 'cellUpdateOptimize', 'className', 'columns', 'data', 'maxHeight', 'maxWidth', 'pagination', 'size', 'style']
        ...
        super(AnyaTable, self).__init__(**args)
