...
- style (dict; optional):
    ...
    _type = 'AnyaIcon'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, icon=Component.UNDEFINED, nClicks=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'className', 'icon', 'nClicks', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'icon', 'nClicks', 'style']
