# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/02_dirs.ipynb.

# %% auto 0
__all__ = ['ROOT_DIR', 'NBKS_DIR', 'EXPL_DIR', 'DATA_DIR', 'RSLT_DIR', 'FIGS_DIR', 'pathabrv', 'epath', 'Dir', 'RelDir']
