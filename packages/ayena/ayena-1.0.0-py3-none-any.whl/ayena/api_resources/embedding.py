...
from ayena import util
from ayena.api_resources.abstract.engine_api_resource import EngineAPIResource
from ayena.datalib.numpy_helper import assert_has_numpy
from ayena.datalib.numpy_helper import numpy as np
from ayena.error import TryAgain
...
class Embedding(EngineAPIResource):
    ...
    def create(cls, *args, **kwargs):
        ...
        See https://platform.ayena.com/docs/api-reference/embeddings for a list
        of valid parameters.
        """
        start = time.time()
