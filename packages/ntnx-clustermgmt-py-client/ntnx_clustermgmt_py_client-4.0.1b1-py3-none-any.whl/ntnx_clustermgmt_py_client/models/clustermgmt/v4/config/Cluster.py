...
class Cluster(ExternalizableAbstractModel):
    ...
    def __init__(self, name=None, nodes=None, config=None, network=None, upgrade_status=None, vm_count=None, inefficient_vm_count=None, container_name=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_fq_object_type(self):
        return 'clustermgmt.v4.r0.b1.config.Cluster'
