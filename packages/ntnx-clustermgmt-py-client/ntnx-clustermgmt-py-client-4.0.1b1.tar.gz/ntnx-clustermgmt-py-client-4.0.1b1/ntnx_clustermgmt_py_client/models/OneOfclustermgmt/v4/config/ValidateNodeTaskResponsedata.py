...
class ValidateNodeTaskResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.ValidateNodeTaskResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ValidateNodeTaskResponsedata.discriminator_value_class_map.values():
            return list(ValidateNodeTaskResponsedata.discriminator_value_class_map.keys())[list(ValidateNodeTaskResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ValidateNodeTaskResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValidateNodeTaskResponsedata):
            return False
