...
class OktaUserManager(BaseUserManager):
	...
	def create_user(self, login, email, firstName, lastName, password = None, groups = (), **other_fields):
		'''Create a local user
	...
	def create_superuser(self, login, email, firstName, lastName, password = None, groups = (), **other_fields):
