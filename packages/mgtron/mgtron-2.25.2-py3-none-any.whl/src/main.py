...
def main() -> None:  # noqa: D401 D202 D205
    ...
    with dpg.window(
        ...
        with dpg.child_window(
            ...
            dpg.add_text(
                default_value="FREQ: 50 MHz to 6400 MHz", pos=(10, 39 - ADJUSTMENT + 5)
            )
        ...
        with dpg.child_window(
            ...
            dpg.add_text(
                ...
                pos=(dpg.get_item_width(item="col_pwr") / 7, 39 - ADJUSTMENT + 5),
            )
        ...
        with dpg.child_window(
            ...
            dpg.add_text(
                ...
                pos=(dpg.get_item_width(item="col_bw") / 7, 39 - ADJUSTMENT + 5),
            )
    ...
    with dpg.handler_registry():
        ...
        # dpg.add_mouse_down_handler(callback=mouse_drag_callback)
