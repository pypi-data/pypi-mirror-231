...
-------------------------------------------------------------------------------
## ✳️ [2.25.1] - 2023 SEP 15
- feat: created pre-commit changelog hook script
- feat: added pre-commit to requirements.txt
- fix: made requirements_hook executable
- wip: finished modified hook scripts
