...
def uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_rgb_lib_checksum_method_wallet_fail_transfers() != 16189:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgb_lib_checksum_method_wallet_get_address() != 58219:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_rgb_lib_checksum_method_wallet_issue_asset_cfa() != 51998:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgb_lib_checksum_method_wallet_list_assets() != 37274:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgb_lib_checksum_method_wallet_list_transactions() != 41002:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgb_lib_checksum_method_wallet_list_transfers() != 13871:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class Wallet:
    ...
    def get_address(self, ) -> "str":
        return FfiConverterString.lift(
            rust_call(_UniFFILib.uniffi_rgb_lib_fn_method_wallet_get_address,self._pointer,)
        )
    ...
    def list_assets(self, filter_asset_ifaces: "typing.List[AssetIface]") -> "Assets":
    ...
    def list_transfers(self, asset_id: "str") -> "typing.List[Transfer]":
...
class WalletData:
    ...
    def __init__(self, data_dir, bitcoin_network, database_type, max_allocations_per_utxo, pubkey, mnemonic):
    ...
    def __str__(self):
        return "WalletData(data_dir={}, bitcoin_network={}, database_type={}, max_allocations_per_utxo={}, pubkey={}, mnemonic={})".format(self.data_dir, self.bitcoin_network, self.database_type, self.max_allocations_per_utxo, self.pubkey, self.mnemonic)
