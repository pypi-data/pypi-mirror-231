...
class BodyCreateOrUpdateWandbConfig(BaseModel):
    wandb_api_key: constr(min_length=1, max_length=4096) = Field(
        ..., examples=['YOUR_WANDB_API_KEY'], title='Wandb Api Key'
    )
    wandb_project_name: constr(min_length=1, max_length=4096) = Field(
        ..., examples=['dreambooth'], title='Wandb Project Name'
    )
    override_wandb_run_name: Optional[bool] = Field(
        False, title='Override Wandb Run Name'
    )
