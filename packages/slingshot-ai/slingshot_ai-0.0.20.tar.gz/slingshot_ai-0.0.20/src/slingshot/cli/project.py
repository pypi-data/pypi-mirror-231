...
@app.command("fork", requires_project=True)
async def fork_project(sdk: SlingshotSDK) -> None:
    """
    Forks the current project and opens it in your default browser.
    """
    assert sdk.project, "Project should be set"  # TODO: make selector if unset
    new_project_id_resp = await sdk._api.fork_project(sdk.project.project_id)  # TODO: add flow like in slingshot init
