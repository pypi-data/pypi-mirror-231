...
class Rotate(ImgaugAdapter):
    ...
    def __init__(self, degree: float = 20.0, cval: int = 127, mode: str = 'constant') -> None:
        ...
        super().__init__(iaa.Rotate(rotate=degree, cval=cval, mode=mode))
...
class RandomRotate(ImgaugAdapter):
    ...
    def __init__(
        ...
        super().__init__(iaa.Rotate(rotate=(degree_min, degree_max), cval=cval, mode=mode))
...
class RandomPerspective(ImgaugAdapter):
    ...
    def __init__(
        ...
        Args:
            scale_min: Scale minimum, 标准差最小值, [0.0, 0.1], 0.0
            scale_min: Scale maximum, 标准差最大值, [0.0, 0.1], 0.1
        ...
        if random.random() < p:
            super().__init__(
                iaa.PerspectiveTransform(scale=(scale_min, scale_max), cval=cval, mode=mode))
        else:
            super().__init__(iaa.Identity())
...
class RandomAffine(ImgaugAdapter):
    ...
    def __init__(
        ...
        super(RandomAffine, self).__init__(iaa.Sequential(aug_list))
