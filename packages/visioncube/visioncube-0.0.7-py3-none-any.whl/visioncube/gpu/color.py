...
from ..common import eval_arg, AbstractTransform, INTERPOLATION
...
class GrayScale(AbstractTransform):
    ...
    def __call__(self, sample):
        ...
        sample.shape = sample.image.shape
        return sample
...
class Brightness(AbstractTransform):
    ...
    def __init__(self, factor: float = 1.0) -> None:
        ...
        Args:
            factor: Brightness factor, 亮度系数, [0.0, 2.0], 1.0
        """
...
class CLAHE(AbstractTransform):
    ...
    def __init__(self, clip_limit: float = 1.0, gw: int = 2, gh: int = 2) -> None:
        ...
        """
        self.clip_limit = eval_arg(clip_limit, None)
...
class RandomBrightness(AbstractTransform):
    ...
    def __init__(self, factor_min: float = 0.0, factor_max: float = 2.0) -> None:
        ...
        Args:
            factor_min: Brightness minimum, 亮度系数最小值, [0, 2], 0.0
            factor_max: Brightness maximum, 亮度系数最大值, [0, 2], 2.0
        """
...
class RandomSaturation(AbstractTransform):
    ...
    def __init__(self, factor_min: float = 0.0, factor_max: float = 2.0) -> None:
        ...
        Args:
            factor_min: Saturation minimum, 饱和度系数最小值, [0.0, 2], 0.0
            factor_max: Saturation maximum, 饱和度系数最大值, [0.0, 2], 2.0
        """
        factor_min = eval_arg(factor_min, None)
        factor_max = eval_arg(factor_max, None)
...
class RandomGamma(Gamma):
    ...
    def __init__(
        ...
        Args:
            gamma_min: Gamma minimum, 伽玛校正系数最小值, [0.1, 3.0], 0.1
            gamma_max: Gamma maximum, 伽玛校正系数最大值, [0.1, 3.0], 3.0
            gain_min: Gain minimum, 乘数最小值, [0.1, 10.0], 0.1
            gain_max: Gain maximum, 乘数最大值, [0.1, 10.0], 10.0
        """
...
class RandomColor(AbstractTransform):
    ...
    def __init__(
        ...
        Args:
            ...
            rnd_contrast: Contrast factor, 亮度系数, [0.0, 2.0], 0.2
        ...
        self.operator = transforms.ColorJitter(brightness=rnd_brightness,
...
class RandomKMeansColor(KMeansColor):
    ...
    def __init__(
        ...
        super().__init__(n_colors=(n_colors_min, n_colors_max),
