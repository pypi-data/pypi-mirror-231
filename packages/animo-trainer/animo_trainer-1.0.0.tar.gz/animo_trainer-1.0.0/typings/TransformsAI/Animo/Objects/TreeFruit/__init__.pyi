...
class PlantTreeFruitBesideReward(TargetedReward):
...
class PlantTreeFruitOnReward(TargetedReward):
    def __init__(self, categoryId: str, rewardId: str) -> None: ...
    @property
    def CanUserTargetSelf(self) -> bool: ...
    @property
...
class TreeFruitInfo(ObjectInfo, IEquatable_1[TreeFruitInfo]):
    ...
    def __eq__(self, left: TreeFruitInfo, right: TreeFruitInfo) -> bool: ...
    def __ne__(self, left: TreeFruitInfo, right: TreeFruitInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: TreeFruitInfo) -> bool:...
        @typing.overload
...
class TreeFruitObject(HoldableObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    TreeFruitsToSpawnMax : int
    TreeFruitsToSpawnMin : int
    WasPlanted : bool
    @property
...
class TreeFruitRewards(RewardCategory):
    def __init__(self) -> None: ...
    name : str
    PlantTreeFruitBeside : PlantTreeFruitBesideReward
    PlantTreeFruitOn : PlantTreeFruitOnReward
    TreeFruit : ObjectDestroyedReward
    @property
