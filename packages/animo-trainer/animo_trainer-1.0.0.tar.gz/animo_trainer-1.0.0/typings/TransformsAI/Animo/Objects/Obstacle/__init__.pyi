...
class ObstacleInfo(ObjectInfo, IEquatable_1[ObstacleInfo]):
    ...
    def __eq__(self, left: ObstacleInfo, right: ObstacleInfo) -> bool: ...
    def __ne__(self, left: ObstacleInfo, right: ObstacleInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: ObstacleInfo) -> bool:...
        @typing.overload
...
class ObstacleObject(GridObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    @property
