...
class AxeInfo(ObjectInfo, IEquatable_1[AxeInfo]):
    ...
    def __eq__(self, left: AxeInfo, right: AxeInfo) -> bool: ...
    def __ne__(self, left: AxeInfo, right: AxeInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: AxeInfo) -> bool:...
        @typing.overload
...
class AxeObject(HoldableObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    @property
...
class AxeRewards(RewardCategory):
    def __init__(self) -> None: ...
    Destroyed : ObjectDestroyedReward
    name : str
    Slash : SlashReward
    SlashMiss : SlashMissReward
    @property
...
class SlashIntent(HeldUseIntent):
    def __init__(self) -> None: ...
    Causers : HashSet_1[GridObject]
    id : int
    SlashedObjects : List_1[GridObject]
    @property
...
class SlashReward(TargetedReward):
    def __init__(self, categoryId: str, rewardId: str) -> None: ...
    @property
