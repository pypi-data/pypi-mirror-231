...
class NpcObstacleInfo(ObjectInfo, IEquatable_1[NpcObstacleInfo]):
    ...
    def __eq__(self, left: NpcObstacleInfo, right: NpcObstacleInfo) -> bool: ...
    def __ne__(self, left: NpcObstacleInfo, right: NpcObstacleInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: NpcObstacleInfo) -> bool:...
        @typing.overload
...
class NpcObstacleObject(GridObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    @property
