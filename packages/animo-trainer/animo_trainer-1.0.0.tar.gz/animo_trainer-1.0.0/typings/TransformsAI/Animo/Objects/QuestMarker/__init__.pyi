...
class QuestMarkerInfo(ObjectInfo, IEquatable_1[QuestMarkerInfo]):
    ...
    def __eq__(self, left: QuestMarkerInfo, right: QuestMarkerInfo) -> bool: ...
    def __ne__(self, left: QuestMarkerInfo, right: QuestMarkerInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: QuestMarkerInfo) -> bool:...
        @typing.overload
...
class QuestMarkerObject(GridObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    @property
