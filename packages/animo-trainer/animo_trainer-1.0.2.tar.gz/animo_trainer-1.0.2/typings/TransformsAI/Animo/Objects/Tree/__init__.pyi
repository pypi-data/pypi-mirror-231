...
class MakeTreeGrowReward(Reward):
...
class TreeInfo(ObjectInfo, IEquatable_1[TreeInfo]):
    ...
    def __eq__(self, left: TreeInfo, right: TreeInfo) -> bool: ...
    def __ne__(self, left: TreeInfo, right: TreeInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: TreeInfo) -> bool:...
        @typing.overload
...
class TreeRewards(RewardCategory):
    def __init__(self) -> None: ...
    Destroy : ObjectDestroyedReward
    MakeGrow : MakeTreeGrowReward
    name : str
    @property
