...
class IndestructiblePropInfo(ObjectInfo, IEquatable_1[IndestructiblePropInfo]):
    ...
    def __eq__(self, left: IndestructiblePropInfo, right: IndestructiblePropInfo) -> bool: ...
    def __ne__(self, left: IndestructiblePropInfo, right: IndestructiblePropInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: IndestructiblePropInfo) -> bool:...
        @typing.overload
...
class IndestructiblePropObject(GridObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    @property
