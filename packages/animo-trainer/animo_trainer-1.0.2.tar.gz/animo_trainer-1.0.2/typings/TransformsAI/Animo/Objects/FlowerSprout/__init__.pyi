...
class FlowerSproutInfo(ObjectInfo, IEquatable_1[FlowerSproutInfo]):
    ...
    def __eq__(self, left: FlowerSproutInfo, right: FlowerSproutInfo) -> bool: ...
    def __ne__(self, left: FlowerSproutInfo, right: FlowerSproutInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: FlowerSproutInfo) -> bool:...
        @typing.overload
...
class FlowerSproutObject(GridObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    @property
...
class FlowerSproutRewards(RewardCategory):
    def __init__(self) -> None: ...
    Destroy : ObjectDestroyedReward
    MakeFlowerSproutGrow : MakeFlowerSproutGrowReward
    name : str
    @property
...
class MakeFlowerSproutGrowReward(Reward):
