...
class MakeTreeSproutGrowReward(Reward):
...
class TreeSproutInfo(ObjectInfo, IEquatable_1[TreeSproutInfo]):
    ...
    def __eq__(self, left: TreeSproutInfo, right: TreeSproutInfo) -> bool: ...
    def __ne__(self, left: TreeSproutInfo, right: TreeSproutInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: TreeSproutInfo) -> bool:...
        @typing.overload
...
class TreeSproutObject(GridObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    @property
...
class TreeSproutRewards(RewardCategory):
    def __init__(self) -> None: ...
    Destroy : ObjectDestroyedReward
    MakeTreeSproutGrow : MakeTreeSproutGrowReward
    name : str
    @property
