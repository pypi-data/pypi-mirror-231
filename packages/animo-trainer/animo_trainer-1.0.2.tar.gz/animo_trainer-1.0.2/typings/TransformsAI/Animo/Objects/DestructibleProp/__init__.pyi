...
class DestructiblePropInfo(ObjectInfo, IEquatable_1[DestructiblePropInfo]):
    ...
    def __eq__(self, left: DestructiblePropInfo, right: DestructiblePropInfo) -> bool: ...
    def __ne__(self, left: DestructiblePropInfo, right: DestructiblePropInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: DestructiblePropInfo) -> bool:...
        @typing.overload
...
class DestructiblePropObject(GridObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    @property
...
class DestructiblePropRewards(RewardCategory):
    def __init__(self) -> None: ...
