...
from TransformsAI.Animo.Rewards import Reward, RewardTarget
...
class CollectCrystalIntent(Intent):
    def __init__(self) -> None: ...
    Causers : HashSet_1[GridObject]
    Collector : GridObject
    id : int
    @property
    ...
    @property
    def Source(self) -> CrystalObject: ...
    @property
    def Source(self) -> GridObject: ...


class CollectCrystalReward(Reward):
...
class CrystalInfo(ObjectInfo, IEquatable_1[CrystalInfo]):
    def __init__(self) -> None: ...
    @property
    ...
    def __eq__(self, left: CrystalInfo, right: CrystalInfo) -> bool: ...
    def __ne__(self, left: CrystalInfo, right: CrystalInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: CrystalInfo) -> bool:...
        @typing.overload
...
class CrystalObject(GridObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    @property
...
class CrystalRewards(RewardCategory):
    def __init__(self) -> None: ...
    Collect : CollectCrystalReward
    name : str
    @property
