...
from TransformsAI.Animo.Objects.SmallSnowball import SmallSnowballObject
...
class GrabSnowballIntent(UseIntent):
    ...
    @property
    def GrabbedSnowball(self) -> SmallSnowballObject: ...
    @GrabbedSnowball.setter
    def GrabbedSnowball(self, value: SmallSnowballObject) -> SmallSnowballObject: ...
    @property
...
class GrabSnowballReward(Reward):
...
class SnowballHeapInfo(ObjectInfo, IEquatable_1[SnowballHeapInfo]):
    def __init__(self) -> None: ...
    @property
    ...
    def __eq__(self, left: SnowballHeapInfo, right: SnowballHeapInfo) -> bool: ...
    def __ne__(self, left: SnowballHeapInfo, right: SnowballHeapInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: SnowballHeapInfo) -> bool:...
        @typing.overload
...
class SnowballHeapObject(GridObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    @property
...
class SnowballHeapRewards(RewardCategory):
    def __init__(self) -> None: ...
    Destroy : ObjectDestroyedReward
    GrabSnowball : GrabSnowballReward
    name : str
    @property
