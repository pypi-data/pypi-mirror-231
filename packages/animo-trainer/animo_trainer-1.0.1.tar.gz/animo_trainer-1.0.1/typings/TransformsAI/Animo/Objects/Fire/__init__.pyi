...
class BurnIntent(Intent):
    ...
    @property
    def Source(self) -> FireObject: ...
    @property
    def Source(self) -> GridObject: ...


class FireInfo(ObjectInfo, IEquatable_1[FireInfo]):
    def __init__(self) -> None: ...
    @property
    ...
    def __eq__(self, left: FireInfo, right: FireInfo) -> bool: ...
    def __ne__(self, left: FireInfo, right: FireInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: FireInfo) -> bool:...
        @typing.overload
...
class FireObject(GridObject):
    ...
    @property
    def NormalizedIntensity(self) -> float: ...
    @property
...
class FireRewards(RewardCategory):
    def __init__(self) -> None: ...
    Extinguished : ObjectDestroyedReward
    name : str
    @property
