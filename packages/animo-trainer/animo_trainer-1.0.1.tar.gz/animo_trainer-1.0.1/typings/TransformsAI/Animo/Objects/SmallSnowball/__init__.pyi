...
class HitTargetReward(TargetedReward):
    def __init__(self, categoryId: str, rewardId: str) -> None: ...
    @property
...
class SmallSnowballInfo(ObjectInfo, IEquatable_1[SmallSnowballInfo]):
    ...
    def __eq__(self, left: SmallSnowballInfo, right: SmallSnowballInfo) -> bool: ...
    def __ne__(self, left: SmallSnowballInfo, right: SmallSnowballInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: SmallSnowballInfo) -> bool:...
        @typing.overload
...
class SmallSnowballObject(HoldableObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    @property
...
class SmallSnowballRewards(RewardCategory):
    def __init__(self) -> None: ...
    GettingHit : GettingHitReward
    HitTarget : HitTargetReward
    name : str
...
class ThrowSmallSnowballIntent(HeldUseIntent):
    def __init__(self) -> None: ...
    Causers : HashSet_1[GridObject]
    id : int
    SnowballArc : ArcLaunchIntent
    SnowballBounceArc : Array_1[int]
    SnowballThrowArcHeights : Array_1[int]
    @property
