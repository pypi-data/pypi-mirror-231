...
from TransformsAI.Animo.Rewards import ObjectDestroyedReward, Reward
from TransformsAI.Animo.Tools import ReadOnlyArray_1

class BluePaintInfo(ObjectInfo, IEquatable_1[BluePaintInfo]):
    ...
    def __eq__(self, left: BluePaintInfo, right: BluePaintInfo) -> bool: ...
    def __ne__(self, left: BluePaintInfo, right: BluePaintInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: BluePaintInfo) -> bool:...
        @typing.overload
...
class BluePaintObject(PaintObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    @property
...
class BluePaintRewards(RewardCategory):
    def __init__(self) -> None: ...
    name : str
...
class RedPaintInfo(ObjectInfo, IEquatable_1[RedPaintInfo]):
    def __init__(self) -> None: ...
    @property
    def CanStepOnObjects(self) -> bool: ...
    @property
    ...
    def CreateObject(self) -> GridObject: ...
    def GetHashCode(self) -> int: ...
    def __eq__(self, left: RedPaintInfo, right: RedPaintInfo) -> bool: ...
    def __ne__(self, left: RedPaintInfo, right: RedPaintInfo) -> bool: ...
    def ToString(self) -> str: ...
    # Skipped Equals due to it being static, abstract and generic.
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: RedPaintInfo) -> bool:...
        @typing.overload
        def __call__(self, other: ObjectInfo) -> bool:...
        @typing.overload
        def __call__(self, obj: typing.Any) -> bool:...
...
class RedPaintObject(PaintObject):
    def __init__(self) -> None: ...
    Info : ObjectInfo
    @property
    def BurnAmount(self) -> int: ...
...
class RedPaintRewards(RewardCategory):
    def __init__(self) -> None: ...
    name : str
    ObjectDestroyed : ObjectDestroyedReward
    @property
