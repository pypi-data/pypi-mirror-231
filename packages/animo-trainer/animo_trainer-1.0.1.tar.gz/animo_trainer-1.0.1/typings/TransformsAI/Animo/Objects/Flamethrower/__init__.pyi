...
class FlamethrowerInfo(ObjectInfo, IEquatable_1[FlamethrowerInfo]):
    ...
    def __eq__(self, left: FlamethrowerInfo, right: FlamethrowerInfo) -> bool: ...
    def __ne__(self, left: FlamethrowerInfo, right: FlamethrowerInfo) -> bool: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: FlamethrowerInfo) -> bool:...
        @typing.overload
...
class FlamethrowerObject(HoldableObject):
    def __init__(self) -> None: ...
...
class FlamethrowerRewards(RewardCategory):
    def __init__(self) -> None: ...
    name : str
    ObjectDestroyed : ObjectDestroyedReward
    SprayFire : SprayFireOnReward
    @property
...
class SprayFireIntent(HeldUseIntent):
    def __init__(self) -> None: ...
    ...
    @property
    def CreatedFire(self) -> FireObject: ...
    @CreatedFire.setter
    def CreatedFire(self, value: FireObject) -> FireObject: ...
    @property
    ...
    @property
    def Source(self) -> FlamethrowerObject: ...
    @property
...
class SprayFireOnReward(TargetedReward):
