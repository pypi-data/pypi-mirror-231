...
class ExternalId(RoboticsBaseModel):
    ...
    external_id: str = Field(..., alias='externalId', max_length=255, min_length=1, regex='^[a-zA-Z0-9]([a-zA-Z0-9_-]{0,253}[a-zA-Z0-9])?$')
...
class CreateAction(RoboticsBaseModel):
    ...
    data_postprocessing_input: Optional[str] = Field(
        'null', alias='dataPostprocessingInput', description='Input to configure postprocessing'
    )
    ...
    asset_ids: Optional[List[int]] = Field(
        None, alias='assetIds', description='Deprecated: Use asset_external_ids instead', example=[123456, 654321]
    )
    asset_external_ids: Optional[List[str]] = Field(None, alias='assetExternalIds', example=['asset1', 'asset2'])
...
class RecurrenceRule(RoboticsBaseModel):
    ...
    freq: Optional[RecurrenceFrequency] = Field(None, description='Recurrence rule frequency', example='DAILY')
    interval: Optional[int] = Field(None, description='Recurrence rule interval', example=1)
    until: Optional[datetime] = Field(None, description='Recurrence rule until date', example='2023-08-01T12:00:00Z')
    by_day: Optional[List[RecurrenceWeekday]] = Field(None, alias='byDay', description='Recurrence rule by_day', example=['MO'])
...
class CreateSchedule(RoboticsBaseModel):
    ...
    mission_external_id: str = Field(
        ..., alias='missionExternalId', description='The external id of the scheduled mission.', example='inspectionMission1'
    )
    robot_data_set_id: int = Field(
        ..., alias='robotDataSetId', description='The robot to that is assigned to perform the mission', example=2975365566518130
    )
    summary: Optional[str] = Field(
        None, description='Short description of the schedule', example='Daily inspection round', max_length=255, min_length=1
    )
    ...
    status: Optional[ScheduleStatus] = Field(None, description='Schedule status', example='CONFIRMED')
    rrule: Optional[RecurrenceRule] = Field(
        None,
        description='Recurrence rule, following the iCalendar RFC5545 standard',
        example={'byDay': ['MO'], 'freq': 'DAILY', 'interval': 2, 'until': '2023-12-01T12:00:00Z'},
    )
    time_zone_id: Optional[str] = Field(
        None, alias='timeZoneId', description='Time zone following the IANA identifiers', example='Europe/Oslo'
    )
...
class UpdateSchedule(RoboticsBaseModel):
    ...
    mission_external_id: Optional[ValueUpdateForString] = Field(
        None, alias='missionExternalId', description="Update the schedule's mission.", example='inspectionMission1'
    )
    robot_data_set_id: Optional[ValueUpdateForInt64] = Field(
        None, alias='robotDataSetId', description='Assign another robot to the schedule.', example=2975365566518130
    )
    summary: Optional[ValueUpdateForString] = Field(None, description="Update the schedule's summary.", example='Daily inspection round')
    date_time_start: Optional[ValueUpdateForDateTime] = Field(
        None, alias='dateTimeStart', description="Update the schedule's start time.", example='2023-08-01T12:00:00Z'
    )
    date_time_end: Optional[ValueUpdateForDateTime] = Field(
        None, alias='dateTimeEnd', description="Update the schedule's end time.", example='2023-08-01T12:00:00Z'
    )
    status: Optional[ValueUpdateForScheduleStatus] = Field(None, description="Update the schedule's status.", example='CONFIRMED')
    ...
    time_zone_id: Optional[ValueUpdateForString] = Field(
        None, alias='timeZoneId', description="Update the schedule's time zone, IANA.", example='Europe/Oslo'
    )
...
class ItemsForResourceUpdateForUpdateSchedule(RoboticsBaseModel):
    ...
    items: List[ResourceUpdateForUpdateSchedule] = Field(..., max_items=10000, min_items=1)
