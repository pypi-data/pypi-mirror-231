...
class HttpMetastoreDatabase(ArraylakeHttpClient, MetastoreDatabase):
    ...
    async def _get_docs(
        ...
        params = {"session_id": session_id, "commit_id": str(commit_id) if commit_id else None}
    ...
    async def getsize(
        ...
        *,
        ...
        response = await self._request(
            ...
            params={"prefix": prefix, "session_id": session_id, "commit_id": str(commit_id) if commit_id else None},
        )
        handle_response(response)
