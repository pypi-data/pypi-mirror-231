...
class RouteTask(BaseModel):
    ...
    departure_time: Optional[datetime] = Field(None, description="Departure date and time according to the [ISO 8601](https://tools.ietf.org/html/rfc3339#section-5.6).")
