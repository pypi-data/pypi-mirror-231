...
class App(customtkinter.CTk):
    ...
    def _build_settings(self):
        ...
        # 寻车配置
        self._build_common(row=4, key="寻车", add_event_position=True)
        # 传奇寻车配置
    ...
    def _build_mode(self):
        ...
        self.mode_buttons = customtkinter.CTkSegmentedButton(
            ...
            values=["多人一", "多人二", "多人三", "寻车", "传奇寻车", "野兽年"],
        )
    ...
    def _build_navi_box(self, frame, key):
        ...
        if self.settings_data and key in self.settings_data and "自动选路" in self.settings_data[key]:
    ...
    def _build_common(self, row=6, key="多人三", add_event_position=False, add_reset_type=False):
        """多人和寻车配置"""
        ...
        if add_event_position:
            ...
            if self.settings_data and key in self.settings_data and "位置" in self.settings_data[key]:
        ...
        if add_reset_type:
            ...
            if self.settings_data and key in self.settings_data and "复位" in self.settings_data[key]:
        ...
        self._build_car_position(
            frame,
            self.setting_modules[key],
            self.settings_data[key] if self.settings_data and key in self.settings_data else {},
            base_row,
        )
        return frame
