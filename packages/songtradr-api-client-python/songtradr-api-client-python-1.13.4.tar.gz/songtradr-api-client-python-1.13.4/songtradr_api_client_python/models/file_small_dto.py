...
class FileSmallDTO(BaseModel):
    """
    Reduced details on a file that has been uploaded for auto-tagging or audio-recognition purposes.  # noqa: E501
    """
    ...
    __properties = ["name", "id", "extension", "error_message", "folder", "objectKey", "uploadStartTime", "uploadEndTime", "fingerprintStartTime", "fingerprintEndTime", "inferenceStatus", "inferenceStartTime", "inferenceEndTime", "error_time", "fingerprintStatus"]
