...
class RecordingLargeDTO(BaseModel):
    """
    Recording with a large field set.  # noqa: E501
    """
    ...
    __properties = ["duration", "isrc", "genres", "languageOfPerformance", "titles", "tracks", "musicalFeatures", "parties", "tags", "spotifyId", "genrePredictions", "pline"]
