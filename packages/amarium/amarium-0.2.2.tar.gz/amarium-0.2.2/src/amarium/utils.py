...
def delete_empty_dir(dir_name: str) -> None:
    ...
    if dir_name is None:
        ...
        raise RuntimeError("Directory does not exist. You must specify a valid directory.")
        exit()
...
def copy_file(file_name:str, destination:str, overwrite:bool = False)->None: 
    ...
    :param: destination: str: specify the destination file name (not directory)
    :param: overwrite: bool: Defaults to false. 
