...
class TestOutcomesApiSchema(object):
    ...
    def __init__(self, component_tool=None, pipeline_key=None, component_integrations=None, external_url=None, run_name=None, event_timestamp=None, stream_key=None, pipeline_name=None, server_name=None, task_key=None, server_key=None, metadata=None, task_name=None, dataset_key=None, dataset_name=None, run_key=None, stream_name=None, test_outcomes=None):  # noqa: E501
