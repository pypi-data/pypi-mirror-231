...
class TestOutcomesApiSchema(object):
    ...
    def __init__(self, stream_key=None, pipeline_key=None, external_url=None, dataset_key=None, event_timestamp=None, server_key=None, server_name=None, task_name=None, component_tool=None, dataset_name=None, pipeline_name=None, run_key=None, task_key=None, component_integrations=None, run_name=None, stream_name=None, metadata=None, test_outcomes=None):  # noqa: E501
