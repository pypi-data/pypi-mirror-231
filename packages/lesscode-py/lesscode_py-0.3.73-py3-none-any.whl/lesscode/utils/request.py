...
async def common_request(method, path, params=None, data=None, json=None, base_url=options.data_server,
    ...
    async with aiohttp.ClientSession() as session:
        ...
        async with _method(base_url + path, params=params, json=json, data=data, **kwargs) as resp:
            if result_type == "json":
...
def sync_common_request(method, path, params=None, data=None, json=None, base_url=None, result_type="json",
    ...
    try:
        _method = getattr(s, method.lower())
        res = _method(base_url + path, params=params, data=data, json=json, **kwargs)
