...
class RimeTestMetric(object):
    ...
    def __init__(self, metric=None, category=None, int_value=None, float_value=None, empty=None, str_value=None, int_list=None, float_list=None, str_list=None):  # noqa: E501
