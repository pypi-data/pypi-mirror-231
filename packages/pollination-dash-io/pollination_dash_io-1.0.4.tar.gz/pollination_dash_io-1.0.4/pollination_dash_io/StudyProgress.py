...
Use this component to keep track of a study and get its results
...
- showResult (boolean; optional):
    ...
    _type = 'StudyProgress'
    @_explicitize_args
    def __init__(self, projectOwner=Component.REQUIRED, projectName=Component.REQUIRED, run=Component.REQUIRED, isLocal=Component.UNDEFINED, showResult=Component.UNDEFINED, showOutput=Component.UNDEFINED, refreshInterval=Component.UNDEFINED, accessToken=Component.UNDEFINED, apiKey=Component.UNDEFINED, basePath=Component.UNDEFINED, id=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'accessToken', 'apiKey', 'basePath', 'isLocal', 'projectName', 'projectOwner', 'refreshInterval', 'run', 'showOutput', 'showResult']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'accessToken', 'apiKey', 'basePath', 'isLocal', 'projectName', 'projectOwner', 'refreshInterval', 'run', 'showOutput', 'showResult']
        ...
        for k in ['projectName', 'projectOwner', 'run']:
            if k not in args:
                raise TypeError(
