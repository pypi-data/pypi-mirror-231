...
class GenericCRUD:
    ...
    def select(self, table_name: str, select_clause_value: str = "*", id_column_name: str = None, id_column_value: Any = None,
        ...
        try:
            ...
            result = self._select_by_where(table_name, select_clause_value, where, limit)
            return result
        except Exception as e:
    ...
    def select_one_by_id(self, table_name: str, select_clause_value: str = "*", id_column_name: str = None, id_column_value: Any = None) -> tuple:
        """Selects one row from the table by ID and returns it as a tuple."""
        where = f"{id_column_name}={id_column_value}"
        return self._select_by_where(table_name, select_clause_value, where, limit=1)[0]

    def select_one_by_where(self, table_name: str, select_clause_value: str = "*", where: str = None) -> list:
        """Selects one row from the table based on a WHERE clause and returns it as a tuple."""
        print("table_name", table_name)
        print("select_clause_value", select_clause_value)
        print("where", where)
        return self._select_by_where(table_name, select_clause_value, where=where, limit=1)[0]

    def select_multi_by_id(self, table_name: str, select_clause_value: str = "*", id_column_name: str = None, id_column_value: Any = None, limit: int = 100) -> list:
        """Selects multiple rows from the table by ID and returns them as a list of tuples."""
        where = f"{id_column_name}={id_column_value}"
        return self._select_by_where(table_name, select_clause_value, where, limit)

    def select_multi_by_where(self, table_name: str, select_clause_value: str = "*", where: str = None, limit: int = 100) -> list:
