...
class Translator:
    def __init__(
        ...
        openai_key=None,
        deepl_key=None,
        aws_data: Tuple[str, str, str] | None = None,
    ):
        ...
        if "aws" in self.engine_list:
            if aws_data is None:
                ...
                self.awstranslator = boto3.client(
                    ...
                    use_ssl=True,
                    region_name=aws_data[0],
                    aws_access_key_id=aws_data[1],
    ...
    def translate(
        ...
        try:
            ...
            if engine == "deepl":
                ...
                r = self.gtranslator.translate(
                    text, src=input_lang, dest=output_lang
                ).text
            elif engine == "aws":
