...
from strengths.rdnetwork import RDNetwork, rdnetwork_from_dict, rdnetwork_to_dict
...
def rdsystem_from_dict(d):
    ...
    if type(state) == dict : 
        state = unitarray_from_dict(state)
...
def rdsystem_to_dict(rds):
    ...
    d = {
        ...
        "chstt_map" : array_to_list(rds.chstt_map)
        }
