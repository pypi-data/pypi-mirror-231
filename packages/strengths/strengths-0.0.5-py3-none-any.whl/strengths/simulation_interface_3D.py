...
def simulate_3D(system, t_sample, time_step, engine_reference, seed, units_system, print_progress) :
    ...
    res = engine.initialize_3D(
            ...
            boundary_conditions_x = system.space.get_boundary_conditions()["x"],
            boundary_conditions_y = system.space.get_boundary_conditions()["y"],
            boundary_conditions_z = system.space.get_boundary_conditions()["z"],
