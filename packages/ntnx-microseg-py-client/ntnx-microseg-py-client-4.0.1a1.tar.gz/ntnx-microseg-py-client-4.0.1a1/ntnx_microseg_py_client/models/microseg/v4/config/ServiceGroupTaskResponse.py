...
from ntnx_microseg_py_client.models.OneOfmicroseg.v4.config.ServiceGroupTaskResponsedata import ServiceGroupTaskResponsedata  # noqa: F401,E501
from ntnx_microseg_py_client.models.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501

class ServiceGroupTaskResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfmicroseg.v4.config.ServiceGroupTaskResponsedata',
    ...
    def _initialize_object_type(self):
        return 'microseg.v4.config.ServiceGroupTaskResponse'

    def _initialize_fq_object_type(self):
        return 'microseg.v4.r0.a1.config.ServiceGroupTaskResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ServiceGroupTaskResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServiceGroupTaskResponse):
            return False
