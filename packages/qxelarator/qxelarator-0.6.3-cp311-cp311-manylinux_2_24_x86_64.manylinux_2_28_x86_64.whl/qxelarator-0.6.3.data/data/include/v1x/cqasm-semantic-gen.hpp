 ...
 *   Annotated [ label="Annotated" URL="\ref cqasm::v1x::semantic::Annotated", style=dotted];
 *   AnnotationData [ label="AnnotationData" URL="\ref cqasm::v1x::semantic::AnnotationData"];
 *   Block [ label="Block" URL="\ref cqasm::v1x::semantic::Block"];
 *   BreakStatement [ label="BreakStatement" URL="\ref cqasm::v1x::semantic::BreakStatement"];
 *   Bundle [ label="Bundle" URL="\ref cqasm::v1x::semantic::Bundle"];
 *   BundleExt [ label="BundleExt" URL="\ref cqasm::v1x::semantic::BundleExt"];
 *   ContinueStatement [ label="ContinueStatement" URL="\ref cqasm::v1x::semantic::ContinueStatement"];
 *   ErrorModel [ label="ErrorModel" URL="\ref cqasm::v1x::semantic::ErrorModel"];
 *   ForLoop [ label="ForLoop" URL="\ref cqasm::v1x::semantic::ForLoop"];
 *   ForeachLoop [ label="ForeachLoop" URL="\ref cqasm::v1x::semantic::ForeachLoop"];
 *   GotoInstruction [ label="GotoInstruction" URL="\ref cqasm::v1x::semantic::GotoInstruction"];
 *   IfElse [ label="IfElse" URL="\ref cqasm::v1x::semantic::IfElse"];
 *   IfElseBranch [ label="IfElseBranch" URL="\ref cqasm::v1x::semantic::IfElseBranch"];
 *   Instruction [ label="Instruction" URL="\ref cqasm::v1x::semantic::Instruction"];
 *   InstructionBase [ label="InstructionBase" URL="\ref cqasm::v1x::semantic::InstructionBase", style=dotted];
 *   Mapping [ label="Mapping" URL="\ref cqasm::v1x::semantic::Mapping"];
 *   Program [ label="Program" URL="\ref cqasm::v1x::semantic::Program"];
 *   RepeatUntilLoop [ label="RepeatUntilLoop" URL="\ref cqasm::v1x::semantic::RepeatUntilLoop"];
 *   SetInstruction [ label="SetInstruction" URL="\ref cqasm::v1x::semantic::SetInstruction"];
 *   Statement [ label="Statement" URL="\ref cqasm::v1x::semantic::Statement", style=dotted];
 *   Structured [ label="Structured" URL="\ref cqasm::v1x::semantic::Structured", style=dotted];
 *   Subcircuit [ label="Subcircuit" URL="\ref cqasm::v1x::semantic::Subcircuit"];
 *   Variable [ label="Variable" URL="\ref cqasm::v1x::semantic::Variable"];
 *   Version [ label="Version" URL="\ref cqasm::v1x::semantic::Version"];
 *   WhileLoop [ label="WhileLoop" URL="\ref cqasm::v1x::semantic::WhileLoop"];
 ...
 *   prim3 [ label="error_model::ErrorModelRef" URL="\ref cqasm::v1x::error_model::ErrorModelRef"];
 *   ErrorModel -> prim3 [ label="model", arrowhead=normal, style=solid, fontname=Helvetica, fontsize=10];
 *   prim4 [ label="primitives::Str" URL="\ref cqasm::v1x::primitives::Str"];
 *   ErrorModel -> prim4 [ label="name", arrowhead=normal, style=solid, fontname=Helvetica, fontsize=10];
 *   prim5 [ label="values::Node" URL="\ref cqasm::v1x::values::Node"];
 ...
 *   prim6 [ label="values::Node" URL="\ref cqasm::v1x::values::Node"];
 ...
 *   prim10 [ label="values::Node" URL="\ref cqasm::v1x::values::Node"];
 ...
 *   prim17 [ label="primitives::Int" URL="\ref cqasm::v1x::primitives::Int"];
 ...
 *   prim18 [ label="primitives::Version" URL="\ref cqasm::v1x::primitives::Version"];
...
public:
     ...
     */
    cqasm::v1x::primitives::Str interface;
     ...
     */
    cqasm::v1x::primitives::Str operation;

    /**
     * Any operands attached to the annotation.
     */
    Any<cqasm::v1x::values::Node> operands;

    /**
     * Constructor.
     */
    AnnotationData(const cqasm::v1x::primitives::Str &interface = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Str>(), const cqasm::v1x::primitives::Str &operation = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Str>(), const Any<cqasm::v1x::values::Node> &operands = cqasm::v1x::primitives::initialize<Any<cqasm::v1x::values::Node>>());
...
public:
     ...
     */
    cqasm::v1x::error_model::ErrorModelRef model;

    /**
     * Name as it appears in the cQASM file.
     */
    cqasm::v1x::primitives::Str name;

    /**
     * Error model parameters.
     */
    Any<cqasm::v1x::values::Node> parameters;

    /**
     * Constructor.
     */
    ErrorModel(const cqasm::v1x::error_model::ErrorModelRef &model = cqasm::v1x::primitives::initialize<cqasm::v1x::error_model::ErrorModelRef>(), const cqasm::v1x::primitives::Str &name = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Str>(), const Any<cqasm::v1x::values::Node> &parameters = cqasm::v1x::primitives::initialize<Any<cqasm::v1x::values::Node>>(), const Any<AnnotationData> &annotations = Any<AnnotationData>());
...
public:
     ...
     */
    One<cqasm::v1x::values::Node> condition;
     ...
     * Constructor.
     */
    ForLoop(const Maybe<SetInstruction> &initialize = Maybe<SetInstruction>(), const One<cqasm::v1x::values::Node> &condition = cqasm::v1x::primitives::initialize<One<cqasm::v1x::values::Node>>(), const Maybe<SetInstruction> &update = Maybe<SetInstruction>(), const One<Block> &body = One<Block>(), const Any<AnnotationData> &annotations = Any<AnnotationData>());
...
public:
     ...
     */
    One<cqasm::v1x::values::Node> lhs;

    /**
     * The first value.
     */
    cqasm::v1x::primitives::Int frm;

    /**
     * The last value.
     */
    cqasm::v1x::primitives::Int to;
     ...
     * Constructor.
     */
    ForeachLoop(const One<cqasm::v1x::values::Node> &lhs = cqasm::v1x::primitives::initialize<One<cqasm::v1x::values::Node>>(), const cqasm::v1x::primitives::Int &frm = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Int>(), const cqasm::v1x::primitives::Int &to = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Int>(), const One<Block> &body = One<Block>(), const Any<AnnotationData> &annotations = Any<AnnotationData>());
...
public:
     ...
     * Constructor.
     */
    InstructionBase(const One<cqasm::v1x::values::Node> &condition = cqasm::v1x::primitives::initialize<One<cqasm::v1x::values::Node>>(), const Any<AnnotationData> &annotations = Any<AnnotationData>());
...
public:
     ...
     * Constructor.
     */
    GotoInstruction(const Link<Subcircuit> &target = Link<Subcircuit>(), const One<cqasm::v1x::values::Node> &condition = cqasm::v1x::primitives::initialize<One<cqasm::v1x::values::Node>>(), const Any<AnnotationData> &annotations = Any<AnnotationData>());
...
public:
     ...
     * Constructor.
     */
    IfElseBranch(const One<cqasm::v1x::values::Node> &condition = cqasm::v1x::primitives::initialize<One<cqasm::v1x::values::Node>>(), const One<Block> &body = One<Block>());
...
public:
     ...
     */
    cqasm::v1x::instruction::InstructionRef instruction;
     ...
     * Constructor.
     */
    Instruction(const cqasm::v1x::instruction::InstructionRef &instruction = cqasm::v1x::primitives::initialize<cqasm::v1x::instruction::InstructionRef>(), const cqasm::v1x::primitives::Str &name = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Str>(), const One<cqasm::v1x::values::Node> &condition = cqasm::v1x::primitives::initialize<One<cqasm::v1x::values::Node>>(), const Any<cqasm::v1x::values::Node> &operands = cqasm::v1x::primitives::initialize<Any<cqasm::v1x::values::Node>>(), const Any<AnnotationData> &annotations = Any<AnnotationData>());
...
public:
     ...
     */
    One<cqasm::v1x::values::Node> value;

    /**
     * Constructor.
     */
    Mapping(const cqasm::v1x::primitives::Str &name = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Str>(), const One<cqasm::v1x::values::Node> &value = cqasm::v1x::primitives::initialize<One<cqasm::v1x::values::Node>>(), const Any<AnnotationData> &annotations = Any<AnnotationData>());
...
public:
     ...
     */
    cqasm::v1x::primitives::Int num_qubits;
     ...
     * the version.
     */
    cqasm::v1x::primitives::Version api_version;

    /**
     * Constructor.
     */
    Program(const One<Version> &version = One<Version>(), const cqasm::v1x::primitives::Int &num_qubits = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Int>(), const Maybe<ErrorModel> &error_model = Maybe<ErrorModel>(), const Any<Subcircuit> &subcircuits = Any<Subcircuit>(), const Any<Mapping> &mappings = Any<Mapping>(), const Any<Variable> &variables = Any<Variable>(), const cqasm::v1x::primitives::Version &api_version = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Version>());
...
public:
     ...
     * Constructor.
     */
    RepeatUntilLoop(const One<Block> &body = One<Block>(), const One<cqasm::v1x::values::Node> &condition = cqasm::v1x::primitives::initialize<One<cqasm::v1x::values::Node>>(), const Any<AnnotationData> &annotations = Any<AnnotationData>());
...
public:
     ...
     * The value to assign.
     */
    One<cqasm::v1x::values::Node> rhs;

    /**
     * Constructor.
     */
    SetInstruction(const One<cqasm::v1x::values::Node> &lhs = cqasm::v1x::primitives::initialize<One<cqasm::v1x::values::Node>>(), const One<cqasm::v1x::values::Node> &rhs = cqasm::v1x::primitives::initialize<One<cqasm::v1x::values::Node>>(), const One<cqasm::v1x::values::Node> &condition = cqasm::v1x::primitives::initialize<One<cqasm::v1x::values::Node>>(), const Any<AnnotationData> &annotations = Any<AnnotationData>());
...
public:
     ...
     */
    cqasm::v1x::primitives::Int iterations;
     ...
     * Constructor.
     */
    Subcircuit(const cqasm::v1x::primitives::Str &name = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Str>(), const cqasm::v1x::primitives::Int &iterations = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Int>(), const Any<Bundle> &bundles = Any<Bundle>(), const Any<AnnotationData> &annotations = Any<AnnotationData>(), const Maybe<Block> &body = Maybe<Block>());
...
public:
     ...
     */
    One<cqasm::v1x::types::Node> typ;

    /**
     * Constructor.
     */
    Variable(const cqasm::v1x::primitives::Str &name = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Str>(), const One<cqasm::v1x::types::Node> &typ = cqasm::v1x::primitives::initialize<One<cqasm::v1x::types::Node>>(), const Any<AnnotationData> &annotations = Any<AnnotationData>());
...
public:
     ...
     */
    cqasm::v1x::primitives::Version items;

    /**
     * Constructor.
     */
    Version(const cqasm::v1x::primitives::Version &items = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Version>());
...
public:
     ...
     * Constructor.
     */
    WhileLoop(const One<cqasm::v1x::values::Node> &condition = cqasm::v1x::primitives::initialize<One<cqasm::v1x::values::Node>>(), const One<Block> &body = One<Block>(), const Any<AnnotationData> &annotations = Any<AnnotationData>());
