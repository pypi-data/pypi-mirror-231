 ...
 *   Axis [ label="Axis" URL="\ref cqasm::v1x::types::Axis"];
 *   Bool [ label="Bool" URL="\ref cqasm::v1x::types::Bool"];
 *   Complex [ label="Complex" URL="\ref cqasm::v1x::types::Complex"];
 *   ComplexMatrix [ label="ComplexMatrix" URL="\ref cqasm::v1x::types::ComplexMatrix"];
 *   Int [ label="Int" URL="\ref cqasm::v1x::types::Int"];
 *   Json [ label="Json" URL="\ref cqasm::v1x::types::Json"];
 *   Qubit [ label="Qubit" URL="\ref cqasm::v1x::types::Qubit"];
 *   Real [ label="Real" URL="\ref cqasm::v1x::types::Real"];
 *   RealMatrix [ label="RealMatrix" URL="\ref cqasm::v1x::types::RealMatrix"];
 *   String [ label="String" URL="\ref cqasm::v1x::types::String"];
 *   TypeBase [ label="TypeBase" URL="\ref cqasm::v1x::types::TypeBase", style=dotted];
...
public:
     ...
     * (more or less).
     */
    cqasm::v1x::primitives::Bool assignable;

    /**
     * Constructor.
     */
    TypeBase(const cqasm::v1x::primitives::Bool &assignable = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Axis(const cqasm::v1x::primitives::Bool &assignable = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Bool(const cqasm::v1x::primitives::Bool &assignable = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Complex(const cqasm::v1x::primitives::Bool &assignable = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Bool>());
...
public:
     ...
     */
    cqasm::v1x::primitives::Int num_rows;

    /**
     * Number of columns. Negative indicates that the value is unconstrained.
     * Can be zero, unlike num_rows.
     */
    cqasm::v1x::primitives::Int num_cols;

    /**
     * Constructor.
     */
    ComplexMatrix(const cqasm::v1x::primitives::Int &num_rows = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Int>(), const cqasm::v1x::primitives::Int &num_cols = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Int>(), const cqasm::v1x::primitives::Bool &assignable = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Int(const cqasm::v1x::primitives::Bool &assignable = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Json(const cqasm::v1x::primitives::Bool &assignable = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Qubit(const cqasm::v1x::primitives::Bool &assignable = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    Real(const cqasm::v1x::primitives::Bool &assignable = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    RealMatrix(const cqasm::v1x::primitives::Int &num_rows = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Int>(), const cqasm::v1x::primitives::Int &num_cols = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Int>(), const cqasm::v1x::primitives::Bool &assignable = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Bool>());
...
public:
     ...
     * Constructor.
     */
    String(const cqasm::v1x::primitives::Bool &assignable = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Bool>());
