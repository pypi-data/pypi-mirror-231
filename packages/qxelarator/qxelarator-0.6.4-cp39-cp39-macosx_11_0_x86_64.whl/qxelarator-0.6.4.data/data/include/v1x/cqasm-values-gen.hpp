 ...
 *   BitRefs [ label="BitRefs" URL="\ref cqasm::v1x::values::BitRefs"];
 *   ConstAxis [ label="ConstAxis" URL="\ref cqasm::v1x::values::ConstAxis"];
 *   ConstBool [ label="ConstBool" URL="\ref cqasm::v1x::values::ConstBool"];
 *   ConstComplex [ label="ConstComplex" URL="\ref cqasm::v1x::values::ConstComplex"];
 *   ConstComplexMatrix [ label="ConstComplexMatrix" URL="\ref cqasm::v1x::values::ConstComplexMatrix"];
 *   ConstInt [ label="ConstInt" URL="\ref cqasm::v1x::values::ConstInt"];
 *   ConstJson [ label="ConstJson" URL="\ref cqasm::v1x::values::ConstJson"];
 *   ConstReal [ label="ConstReal" URL="\ref cqasm::v1x::values::ConstReal"];
 *   ConstRealMatrix [ label="ConstRealMatrix" URL="\ref cqasm::v1x::values::ConstRealMatrix"];
 *   ConstString [ label="ConstString" URL="\ref cqasm::v1x::values::ConstString"];
 *   Constant [ label="Constant" URL="\ref cqasm::v1x::values::Constant", style=dotted];
 *   Function [ label="Function" URL="\ref cqasm::v1x::values::Function"];
 *   QubitRefs [ label="QubitRefs" URL="\ref cqasm::v1x::values::QubitRefs"];
 *   Reference [ label="Reference" URL="\ref cqasm::v1x::values::Reference", style=dotted];
 *   VariableRef [ label="VariableRef" URL="\ref cqasm::v1x::values::VariableRef"];
 ...
 *   prim11 [ label="types::Node" URL="\ref cqasm::v1x::types::Node"];
 ...
 *   prim12 [ label="semantic::Variable" URL="\ref cqasm::v1x::semantic::Variable"];
...
public:
     ...
     * The contained value.
     */
    cqasm::v1x::primitives::Axis value;

    /**
     * Constructor.
     */
    ConstAxis(const cqasm::v1x::primitives::Axis &value = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Axis>());
...
public:
     ...
     * The contained value.
     */
    cqasm::v1x::primitives::Bool value;

    /**
     * Constructor.
     */
    ConstBool(const cqasm::v1x::primitives::Bool &value = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Bool>());
...
public:
     ...
     * The contained value.
     */
    cqasm::v1x::primitives::Complex value;

    /**
     * Constructor.
     */
    ConstComplex(const cqasm::v1x::primitives::Complex &value = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Complex>());
...
public:
     ...
     * The contained value.
     */
    cqasm::v1x::primitives::CMatrix value;

    /**
     * Constructor.
     */
    ConstComplexMatrix(const cqasm::v1x::primitives::CMatrix &value = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::CMatrix>());
...
public:
     ...
     * The contained value.
     */
    cqasm::v1x::primitives::Int value;

    /**
     * Constructor.
     */
    ConstInt(const cqasm::v1x::primitives::Int &value = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Int>());
...
public:
     ...
     * The contained value.
     */
    cqasm::v1x::primitives::Str value;

    /**
     * Constructor.
     */
    ConstJson(const cqasm::v1x::primitives::Str &value = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Str>());
...
public:
     ...
     * The contained value.
     */
    cqasm::v1x::primitives::Real value;

    /**
     * Constructor.
     */
    ConstReal(const cqasm::v1x::primitives::Real &value = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Real>());
...
public:
     ...
     * The contained value.
     */
    cqasm::v1x::primitives::RMatrix value;

    /**
     * Constructor.
     */
    ConstRealMatrix(const cqasm::v1x::primitives::RMatrix &value = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::RMatrix>());
...
public:
     ...
     * Constructor.
     */
    ConstString(const cqasm::v1x::primitives::Str &value = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Str>());
...
public:
     ...
     * Operands for the function.
     */
    One<cqasm::v1x::types::Node> return_type;

    /**
     * Constructor.
     */
    Function(const cqasm::v1x::primitives::Str &name = cqasm::v1x::primitives::initialize<cqasm::v1x::primitives::Str>(), const Any<cqasm::v1x::values::Node> &operands = cqasm::v1x::primitives::initialize<Any<cqasm::v1x::values::Node>>(), const One<cqasm::v1x::types::Node> &return_type = cqasm::v1x::primitives::initialize<One<cqasm::v1x::types::Node>>());
...
public:
     ...
     */
    Link<cqasm::v1x::semantic::Variable> variable;

    /**
     * Constructor.
     */
    VariableRef(const Link<cqasm::v1x::semantic::Variable> &variable = cqasm::v1x::primitives::initialize<Link<cqasm::v1x::semantic::Variable>>());
