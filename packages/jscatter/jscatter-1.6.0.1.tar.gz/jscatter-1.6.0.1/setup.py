        ...
        for ext in allextensions:
            if hasattr(ext, 'isCmakeExtension'):
                try:
                    ...
                    UserWarning('compilation of fscatter failed. Fortran cannot be used. '
                                'Check if f2py and Forran compiler are present.  ')
            else:
...
EXTENSIONS.append(CMakeExtension(name='jscatter.fscatter', sourcedir='src/jscatter/source'))
