...
def main(
    ...
    if mode == Mode.PAST:
        from tgtg_msg.past import forward_job  # pylint: disable=import-outside-toplevel

        asyncio.run(forward_job())
    else:
        from tgtg_msg.live import start_sync  # pylint: disable=import-outside-toplevel
