...
from tgtg_msg import config, const
from tgtg_msg import storage as st
from tgtg_msg.bot import get_events
from tgtg_msg.config import CONFIG, get_SESSION
...
async def start_sync() -> None:
    ...
    client = TelegramClient(SESSION, CONFIG.login.API_ID, CONFIG.login.API_HASH,
                            proxy=parse_tuple(os.getenv('MY_PROXY')))
