...
from tgtg_msg import config
from tgtg_msg import storage as st
from tgtg_msg.config import CONFIG, get_SESSION, write_config
from tgtg_msg.plugins import apply_plugins
from tgtg_msg.utils import clean_session_files, send_message
...
async def forward_job() -> None:
    ...
    async with TelegramClient(
            SESSION, CONFIG.login.API_ID, CONFIG.login.API_HASH, proxy=parse_tuple(os.getenv('MY_PROXY'))
    ) as client:
