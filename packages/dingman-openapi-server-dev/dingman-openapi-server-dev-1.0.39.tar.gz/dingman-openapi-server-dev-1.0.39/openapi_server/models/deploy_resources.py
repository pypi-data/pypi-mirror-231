...
class DeployResources(Model):
    ...
    def __init__(self, demo=None, demo2=None, workloads=None, services=None, configs=None, secrets=None, persistent_volume_claims=None, ingress=None, service_monitors=None, roles=None, role_bindings=None, service_accounts=None, custom_manifests=None):  # noqa: E501
