...
class TestYhClientTrader(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls._user = sctrader.use("yh_client")
    ...
    def test_invalid_buy(self):
        ...
        with self.assertRaises(sctrader.exceptions.TradeError):
...
class TestHTClientTrader(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls._user = sctrader.use("ht_client")
        cls._user.prepare(
...
class TestHTZQClientTrader(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls._user = sctrader.use("htzq_client")
