...
from sctrader.utils.captcha import captcha_recognize
from sctrader.utils.win_gui import SetForegroundWindow, ShowWindow, win32defines

if TYPE_CHECKING:
    # pylint: disable=unused-import
    from sctrader import clienttrader
