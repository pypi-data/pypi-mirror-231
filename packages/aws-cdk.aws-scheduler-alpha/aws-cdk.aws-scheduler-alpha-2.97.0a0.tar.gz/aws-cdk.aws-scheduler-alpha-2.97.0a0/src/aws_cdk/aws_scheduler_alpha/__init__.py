...
class Schedule(
    ...
    def __init__(
        ...
        *,
        ...
        :param group: (experimental) The schedule's group.
...
class ScheduleExpression(
    ...
    def cron(
        ...
        *,
        ...
        :stability: experimental
        '''
        options = _aws_cdk_ceddda9d.CronOptions(
            day=day,
            hour=hour,
            minute=minute,
            month=month,
...
class _ScheduleExpressionProxy(
    ScheduleExpression,
    jsii.proxy_for(_aws_cdk_ceddda9d.Schedule), # type: ignore[misc]
):
    pass
