...
class SlackConnect:
    ...
    def send_ephemeral_dm_or_channel_message(self, channel_or_slack_id, userId, message):
        """
        Send an ephemeral message to the given channel or user (by Slack ID) through Direct Message.
        Message will only be seen by the user
        """
