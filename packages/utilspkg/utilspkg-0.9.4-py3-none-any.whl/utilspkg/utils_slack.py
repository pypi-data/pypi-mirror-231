...
def get_multi_static_select_block(blockId: str, actionId: str, placeholder: str, options: list, maxOptions: int or None = None):
    """
...
def get_checkbox_block(label: str, actionId: str, options: list):
    block = {
			"label": {
				"type": "plain_text",
				"text": label,
...
def get_button_block(text: str, value: str, actionId: str):
    return {
        "type": "button",
        "text": {
            "type": "plain_text",
