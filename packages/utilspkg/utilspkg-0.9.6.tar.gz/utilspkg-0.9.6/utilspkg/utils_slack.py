...
def get_multi_static_select_block(blockId: str, actionId: str, placeholder: str, options: list, maxOptions: int or None = None, confirm: any = None):
    """
...
def get_checkbox_block(label: str, actionId: str, options: list, confirmation: any = None):
    block = {
			"label": {
				"type": "plain_text",
				"text": label,
