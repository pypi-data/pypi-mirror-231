...
class CuSum_:
    ...
    def preprocess(self, spacing=10, scaling='dB', t_srs=4326, allow_RES_OSV=True, polarizations='all',
                   ...
                   window_size='7x7', merge=False, interp=False, remove_temp_files=False):
        """ preprocess
                        ...
                        speckleFilter: str
                            ...
                            - 'Lee Sigma'
                        window_size : str
                            Window size for speckle filter. Default is 7x7
                        merge : bool
        ...
        for filename in tqdm(zip_files, desc=f"Pre-processing zip files"):
            geocode(os.path.join(self.out_dl, filename), self.out_pre, t_srs, spacing=spacing,
                    ...
                    speckleFilter=speckleFilter, window_size=window_size, terrainFlattening=True, export_extra=None, groupsize=8,
                    cleanup=True,
