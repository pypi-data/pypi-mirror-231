...
class KYCApi(object):
    ...
    def create_user_invitation(self, body, bank_id, **kwargs):  # noqa: E501
        ...
        <p>Create User Invitation.</p><p>This endpoint will send an invitation email to the developers, then they can use the link to create the obp user.</p><p>purpose filed only support:List(DEVELOPER, CUSTOMER).</p><p>You can customise the email details use the following webui props:</p><p>when purpose == DEVELOPER<br />webui_developer_user_invitation_email_subject<br />webui_developer_user_invitation_email_from<br />webui_developer_user_invitation_email_text<br />webui_developer_user_invitation_email_html_text</p><p>when purpose = == CUSTOMER<br />webui_customer_user_invitation_email_subject<br />webui_customer_user_invitation_email_from<br />webui_customer_user_invitation_email_text<br />webui_customer_user_invitation_email_html_text</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def create_user_invitation_with_http_info(self, body, bank_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/obp/v5.1.0/banks/{BANK_ID}/user-invitation', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_user_invitation_anonymous_with_http_info(self, body, bank_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/obp/v5.1.0/banks/{BANK_ID}/user-invitations', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
