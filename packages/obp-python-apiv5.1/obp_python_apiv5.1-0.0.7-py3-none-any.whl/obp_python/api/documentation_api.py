...
class DocumentationApi(object):
    ...
    def get_api_glossary(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_api_glossary(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_api_glossary_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_api_glossary_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_api_glossary_with_http_info(self, **kwargs):  # noqa: E501
        """Get Glossary of the API  # noqa: E501

        <p>Get API Glossary</p><p>Returns the glossary of the API</p><p>Authentication is Optional</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_api_glossary_with_http_info(async_req=True)
        >>> result = thread.get()
