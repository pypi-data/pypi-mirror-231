...
class FBGraphHandler():
    ...
    def Config(self, client_id : str, client_secret : str, version='14.0'):
        """_summary_
    ...
    def GenerateAuthURL(self, redirect_uri : str, scopes : Union[list[str], str]):
        """_summary_
    ...
    def ExchangeCodewithToken(self, code : str):
        """_summary_
    ...
    def GetUserDetails(self, access_token=''):
        """_summary_
    ...
    def GetProfileImage(self, id : str, access_token=''):
        """_summary_
    ...
    def GetLongLivedToken(self, access_token : str):
        """_summary_
    ...
    def PostTextFeed(self, text : str, id : str, access_token : str, accountType='page'):
        """_summary_
    ...
    def PostVideoFeed(self, text : str, id : str, access_token : str, video_url : str, title='', accountType='page'):
        """_summary_
    ...
    @staticmethod
    def post_video_facebook(text, video_url, token, page_id, version, url, title):
        """
    ...
    def PostToFacebook(self, text : str, media_urls : Union[list[str], str], access_token : str, id : str, isVideo : bool, title=''):
        """_summary_
    ...
    @staticmethod
    def facebook_upload(img, token, id, version, photouploadUrl):
    ...
    @staticmethod
    def post_facebook(text, media, token, page_id, facebook_request_url):
        """
