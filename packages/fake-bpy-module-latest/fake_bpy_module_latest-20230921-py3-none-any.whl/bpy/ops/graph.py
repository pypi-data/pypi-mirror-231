...
def scale_average(
        ...
        *,
        factor=1.0):
    ''' Increase or decrease the value of selected keys in relationship to their average :arg factor: Scale Factor, The scale factor applied to the curve segments :type factor: float in [-inf, inf], (optional)
...
def shear(override_context: typing.Optional[
        typing.Union[typing.Dict, 'bpy.types.Context']] = None,
          ...
          *,
          factor=0.0,
          direction='FROM_LEFT'):
    ''' Affects the value of the keys linearly keeping the same relationship between them using either the left or the right key as reference :arg factor: Shear Factor, The amount of shear to apply :type factor: float in [-inf, inf], (optional) :arg direction: Direction, Which end of the segment to use as a reference to shear from * ``FROM_LEFT`` From Left -- foo. * ``FROM_RIGHT`` From Right -- foo. :type direction: enum in ['FROM_LEFT', 'FROM_RIGHT'], (optional)
