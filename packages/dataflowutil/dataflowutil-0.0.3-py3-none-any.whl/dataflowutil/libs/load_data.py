...
class LoadData:
    def __init__(self,connection,spreadsheets):
        ...
        self.data = spreadsheets.load_spreadsheets(self.cn.id_load_bucket,extra_v.NAME_SHEET)

        if extra_v.ACTIVATE_DATA_LOCAL:
            self.data_compare = spreadsheets.load_spreadsheets(self.cn.id_compare_data,extra_v.NAME_SHEET)
