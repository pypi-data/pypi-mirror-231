...
def select_api_url(api_type):
    ...
    while True:
        ...
        try:
            selection = int(input("Enter the number corresponding with the public customer you are assisting: "))
...
def select_resource():
    while True:
        ...
        try:
            selection = int(input(
                "Enter the number corresponding with the parent type of the resource you need to revert soft delete on: "))
