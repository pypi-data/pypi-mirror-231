...
class Publisher(object):
    ...
    def get_channel_list(self, with_update=True):
        return build_channel_list(with_update)

    def get_channel_data(self, channel):
        return get_data_from_channel(channel)

    def get_procedure_list(self, with_update=True):
        return build_procedure_list(with_update)
    ...
    def workon_procedure(self, proc_code, update_channels=True):
        self.check_unstaged_changes()
        change_procedure(proc_code, update_channels)
