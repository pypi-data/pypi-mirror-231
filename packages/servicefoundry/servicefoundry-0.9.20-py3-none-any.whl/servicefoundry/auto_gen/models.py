...
#   timestamp: 2023-09-09T14:02:14+00:00
...
class NATSInputConfig(BaseModel):
    ...
    nats_url: str = Field(..., description="+label=NATS URL\n+usage=Input NATS URL")
...
class WorkerConfig(BaseModel):
    input_config: Union[SQSInputConfig, NATSInputConfig] = Field(
        ..., description="+label=Input Config\n+usage=Input Config"
    )
    output_config: Union[SQSOutputConfig, NATSOutputConfig] = Field(
        ..., description="+label=Output Config\n+usage=Output Config"
    )


class AsyncServiceAutoscaling(BaseAutoscaling):
    metrics: Union[SQSQueueMetricConfig, NATSMetricConfig] = Field(
        ...,
        description="+label=Autoscaling metrics\n+usage=Metrics to use for the autoscaler\n+sort=4",
    )
