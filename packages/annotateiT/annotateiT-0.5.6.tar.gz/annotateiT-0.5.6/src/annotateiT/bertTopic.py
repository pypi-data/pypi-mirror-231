...
class Analyzer:
    def __init__(self, data_file=None, text_column="text", output_folder="output", num_topics=10):
        ...
        self.docs = self.data[self.text_column].dropna().apply(self.preprocess).tolist()
    ...
    def visualize_topics(self):
        ...
        fig_hierarchy_labels = topic_model.visualize_hierarchy(hierarchical_topics=hierarchical_topics, top_n_topics=self.num_topics, custom_labels=True)
        fig_hierarchy_labels.write_html(os.path.join(self.output_folder, "topic_word_hierarchy_labels.html"))
