...
variable_substitution = h.child_theory.i.variable_substitution.infer_statement(p=implication,
    phi=(o1, o2, o3))
modus_ponens = h.child_theory.i.modus_ponens.infer_statement(p_implies_q=variable_substitution,
    p=conjunction_introduction)

# Prove hypothesis inconsistency
h_inconsistency = t1.i.inconsistency_introduction_1.infer_statement(p=h.child_statement,
...
proposition_of_interest = t1.i.proof_by_refutation_1.infer_statement(p_hypothesis=h,
