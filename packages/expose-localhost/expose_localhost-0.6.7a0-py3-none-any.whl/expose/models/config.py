...
# todo: upgrade to ubuntu 22.0
#   update default AMI IDs
#   run a command to stop any automatic restarts and unattended upgrades and security patches
...
class Settings(BaseModel):
    ...
    nginx_config_commands: Dict[str, bool] = {
        ...
        "sudo systemctl mask unattended-upgrades": False,
        ...
        "sudo systemctl unmask unattended-upgrades": False
    }
