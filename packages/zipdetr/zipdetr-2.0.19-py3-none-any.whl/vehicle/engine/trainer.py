...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.plot_idx = [10 * i for i in range(51)]
    ...
    def _do_train(self, world_size=1):
        ...
        nw = max(round(self.args.warmup_epochs * nb), 100) \
            if self.args.warmup_epochs > 0 else -1  # number of warmup iterations
        last_opt_step = -1
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for i, batch in pbar:
                ...
                if RANK in (-1, 0):
                    ...
                    # Hereby note to prove that I have been here.
                    # if self.args.plots and (ni in self.plot_idx or i == 0):
    ...
    def save_model(self):
        ...
        if (self.save_period > 0 and (self.epoch + 1) % self.save_period == 0) or (self.epoch + 1) < 10:
            torch.save(ckpt, self.wdir / f'{str(self.epoch + 1).zfill(3)}.pt', pickle_module=pickle)
        del ckpt
    ...
    def build_optimizer(self, model, name='auto', lr=0.001, momentum=0.9, decay=1e-5, iterations=1e5):
        ...
        if name == 'auto':
            ...
            name, lr, momentum = ('SGD', 0.01, 0.9) if iterations > 1503090 else ('AdamW', lr_fit, 0.9)
