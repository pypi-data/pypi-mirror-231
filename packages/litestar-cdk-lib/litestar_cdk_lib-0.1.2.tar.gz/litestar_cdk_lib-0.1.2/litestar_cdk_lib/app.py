...
class EndpointType(Enum, apigw.EndpointType):
    EDGE = apigw.EndpointType.EDGE
    REGIONAL = apigw.EndpointType.REGIONAL
    PRIVATE = apigw.EndpointType.PRIVATE
...
class LitestarApp(Construct):
    def __init__(self, scope: Construct, construct_id: str, path: PathLike, handler: str | None = "app.app",
                 ...
                 auth: Auth = None, endpoint_type: EndpointType | None = EndpointType.EDGE,
                 open_api_path: PathLike | None = None):
        ...
        if self.open_api_path:
            ...
            self.api = apigw.LambdaRestApi(
                ...
                endpoint_types=[self.endpoint_type.value],
            )
