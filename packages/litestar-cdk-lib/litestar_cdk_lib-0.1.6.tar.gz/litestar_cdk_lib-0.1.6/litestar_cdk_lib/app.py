...
class LitestarApp(Construct):
    def __init__(self, scope: Construct, construct_id: str, path: PathLike, handler: str | None = "app.app",
                 ...
                 auth: Auth = None, endpoint_type: apigw.EndpointType | None = apigw.EndpointType.EDGE,
                 binary_media_types: list[str] | None = None, open_api_path: PathLike | None = None):
        ...
        self.binary_media_types = binary_media_types or []
        ...
        if self.open_api_path:
            ...
            if self.binary_media_types:
                api_kwargs["binary_media_types"] = self.binary_media_types
            self.api = apigw.LambdaRestApi(
                self,
                f"{construct_id}Api",
                handler=self.function,
                default_method_options=method_opts,
                endpoint_types=[self.endpoint_type],
                **api_kwargs,
            )
