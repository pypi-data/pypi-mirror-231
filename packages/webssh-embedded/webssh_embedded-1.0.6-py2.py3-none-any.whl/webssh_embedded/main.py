...
from webssh_embedded import handler
#import your handlers here. Handlers are used to deal with web requests.
from webssh_embedded.handler import IndexHandler, WsockHandler, NotFoundHandler,Websocksql
from webssh_embedded.settings import (
