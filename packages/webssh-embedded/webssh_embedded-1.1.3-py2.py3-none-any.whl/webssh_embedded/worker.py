...
class Worker(object):
    ...
    def send_command(self,command_execution_status,execution_time):
           try:
                data={"session_id":self.id,"Command":self.input_command[0],"Command_Execution_Status":command_execution_status
                      ,"Execution_Time":execution_time,"Timestamp":str(self.entry_timestamp[0])}
        ...
        try:
            ...
            try:
                ...
                if(command_execution_status and execution_time and len(self.input_command)!=0):
                    logging.info("Command:"+self.input_command[0]+",Command Status:"+
