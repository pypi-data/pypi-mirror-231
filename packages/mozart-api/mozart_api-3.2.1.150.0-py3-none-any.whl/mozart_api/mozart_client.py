...
NOTIFICATION_TYPES: set[str] = (
    ...
    "beolink_join_result",
    "button",
    "classics_adapter_active_adapter",
    "classics_adapter_connected_adapters",
    "curtains",
...
class MozartClient(MozartApi):
    ...
    def __init__(
        ...
        self._on_classics_adapter_active_adapter_notification = None
        self._on_classics_adapter_connected_adapters_notification = None
    ...
    def _on_message(self, notification) -> None:
        ...
        # Handle specific notifications if defined
        {
            ...
            "WebSocketEventClassicsAdapterActiveAdapter": lambda notification: self._on_classics_adapter_active_adapter_notification(
                notification
            )
            if self._on_classics_adapter_active_adapter_notification
            else None,
            "WebSocketEventClassicsAdapterConnectedAdapters": lambda notification: self._on_classics_adapter_connected_adapters_notification(
                notification
            )
            if self._on_classics_adapter_connected_adapters_notification
            else None,
    ...
    def get_classics_adapter_active_adapter_notifications(
        self, on_classics_adapter_active_adapter_notification
    ) -> None:
        """Callback for WebSocketEventClassicsAdapterActiveAdapter notifications."""
        self._on_classics_adapter_active_adapter_notification = (
            on_classics_adapter_active_adapter_notification
        )

    def get_classics_adapter_connected_adapters_notifications(
        self, on_classics_adapter_connected_adapters_notification
    ) -> None:
        """Callback for WebSocketEventClassicsAdapterConnectedAdapters notifications."""
        self._on_classics_adapter_connected_adapters_notification = (
            on_classics_adapter_connected_adapters_notification
        )
