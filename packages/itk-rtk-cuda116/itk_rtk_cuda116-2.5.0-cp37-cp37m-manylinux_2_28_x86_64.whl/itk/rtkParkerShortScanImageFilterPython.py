...
class rtkParkerShortScanImageFilterCIF3(itk.itkInPlaceImageFilterRTKPython.itkInPlaceImageFilterCIF3):
    ...
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_rtkParkerShortScanImageFilterPython.rtkParkerShortScanImageFilterCIF3___New_orig__)
    Clone = _swig_new_instance_method(_rtkParkerShortScanImageFilterPython.rtkParkerShortScanImageFilterCIF3_Clone)
    GetModifiableGeometry = _swig_new_instance_method(_rtkParkerShortScanImageFilterPython.rtkParkerShortScanImageFilterCIF3_GetModifiableGeometry)
    GetGeometry = _swig_new_instance_method(_rtkParkerShortScanImageFilterPython.rtkParkerShortScanImageFilterCIF3_GetGeometry)
    SetGeometry = _swig_new_instance_method(_rtkParkerShortScanImageFilterPython.rtkParkerShortScanImageFilterCIF3_SetGeometry)
    GetAngularGapThreshold = _swig_new_instance_method(_rtkParkerShortScanImageFilterPython.rtkParkerShortScanImageFilterCIF3_GetAngularGapThreshold)
    SetAngularGapThreshold = _swig_new_instance_method(_rtkParkerShortScanImageFilterPython.rtkParkerShortScanImageFilterCIF3_SetAngularGapThreshold)
    __swig_destroy__ = _rtkParkerShortScanImageFilterPython.delete_rtkParkerShortScanImageFilterCIF3
    cast = _swig_new_static_method(_rtkParkerShortScanImageFilterPython.rtkParkerShortScanImageFilterCIF3_cast)
...
rtkParkerShortScanImageFilterCIF3___New_orig__ = _rtkParkerShortScanImageFilterPython.rtkParkerShortScanImageFilterCIF3___New_orig__
rtkParkerShortScanImageFilterCIF3_cast = _rtkParkerShortScanImageFilterPython.rtkParkerShortScanImageFilterCIF3_cast
