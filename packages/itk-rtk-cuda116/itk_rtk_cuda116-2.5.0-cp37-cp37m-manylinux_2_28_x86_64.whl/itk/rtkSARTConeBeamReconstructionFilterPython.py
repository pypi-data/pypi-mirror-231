...
def sart_cone_beam_reconstruction_filter(*args: itkt.ImageLike,  geometry=..., number_of_iterations: int=..., number_of_projections_per_subset: int=..., enforce_positivity: bool=..., gating_weights: Sequence[float]=..., disable_displaced_detector_filter: bool=..., division_threshold: float=..., forward_projection_filter=..., back_projection_filter=..., attenuation_map=..., inferior_clip_image: itkt.Image=..., superior_clip_image: itkt.Image=..., sigma_zero: float=..., alpha_psf: float=...,**kwargs)-> itkt.ImageSourceReturn:
