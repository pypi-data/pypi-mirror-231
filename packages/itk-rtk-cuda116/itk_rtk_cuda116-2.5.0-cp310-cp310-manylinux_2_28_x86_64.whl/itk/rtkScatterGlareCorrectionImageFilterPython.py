...
class rtkScatterGlareCorrectionImageFilterCIF3CIF3F(itk.rtkFFTProjectionsConvolutionImageFilterPython.rtkFFTProjectionsConvolutionImageFilterCIF3CIF3F):
    ...
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_rtkScatterGlareCorrectionImageFilterPython.rtkScatterGlareCorrectionImageFilterCIF3CIF3F___New_orig__)
    Clone = _swig_new_instance_method(_rtkScatterGlareCorrectionImageFilterPython.rtkScatterGlareCorrectionImageFilterCIF3CIF3F_Clone)
    GetCoefficients = _swig_new_instance_method(_rtkScatterGlareCorrectionImageFilterPython.rtkScatterGlareCorrectionImageFilterCIF3CIF3F_GetCoefficients)
    SetCoefficients = _swig_new_instance_method(_rtkScatterGlareCorrectionImageFilterPython.rtkScatterGlareCorrectionImageFilterCIF3CIF3F_SetCoefficients)
    __swig_destroy__ = _rtkScatterGlareCorrectionImageFilterPython.delete_rtkScatterGlareCorrectionImageFilterCIF3CIF3F
    cast = _swig_new_static_method(_rtkScatterGlareCorrectionImageFilterPython.rtkScatterGlareCorrectionImageFilterCIF3CIF3F_cast)
...
rtkScatterGlareCorrectionImageFilterCIF3CIF3F___New_orig__ = _rtkScatterGlareCorrectionImageFilterPython.rtkScatterGlareCorrectionImageFilterCIF3CIF3F___New_orig__
rtkScatterGlareCorrectionImageFilterCIF3CIF3F_cast = _rtkScatterGlareCorrectionImageFilterPython.rtkScatterGlareCorrectionImageFilterCIF3CIF3F_cast
