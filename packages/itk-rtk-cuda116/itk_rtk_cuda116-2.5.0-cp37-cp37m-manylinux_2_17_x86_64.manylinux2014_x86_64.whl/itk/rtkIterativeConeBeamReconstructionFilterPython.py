...
def iterative_cone_beam_reconstruction_filter(*args: itkt.ImageLike,  forward_projection_filter=..., back_projection_filter=..., attenuation_map=..., inferior_clip_image: itkt.Image=..., superior_clip_image: itkt.Image=..., sigma_zero: float=..., alpha_psf: float=...,**kwargs)-> itkt.ImageSourceReturn:
