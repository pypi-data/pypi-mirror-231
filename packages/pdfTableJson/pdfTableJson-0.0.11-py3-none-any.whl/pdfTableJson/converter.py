...
from . import parser # package # parser # pypi

# import util  # package # utf-8 # local
# import parser  # package # parser # local

'''
python converter.py -i "C:/Users/aria1/OneDrive/바탕 화면/프로젝트/pdf처리/자료/등기부등본모음/집합건물_등기부등본.pdf"
'''
...
def main(input_path):
    ...
    data = parser.refineHeader(total_data_list)
    data = parser.recoverType1(data)
    data = parser.recoverType2(data)
    #data = recoverType3(data)
    total_data_list = parser.refineData(data)
    ...
    f_make_json_file(json_data_combined, out_path, pdf_name) # Json 파일 생성 처리
