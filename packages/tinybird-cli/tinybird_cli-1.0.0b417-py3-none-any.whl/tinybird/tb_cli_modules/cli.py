...
async def push(
    ...
    if prefix:
        click.echo(FeedbackManager.warning_deprecated(warning="The `--prefix` flag is deprecated. You should use different workspaces instead, see `tb workspace create --help` for more info."))
...
async def drop_prefix(
    ...
    if prefix:
        click.echo(FeedbackManager.warning_deprecated(warning="This command is deprecated. You should use different workspaces instead, see `tb workspace create --help` for more info."))
