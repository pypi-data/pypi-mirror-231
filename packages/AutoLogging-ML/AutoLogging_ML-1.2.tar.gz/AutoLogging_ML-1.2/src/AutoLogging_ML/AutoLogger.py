...
def get_classification_report(dat,subset):
                if subset=='training':
                    for i,j in zip(dat['training-classification report'],dat['model']):
                        a=len(dat['training-classification report'])
                        b=1
                        print(j)
                        print(i)
                        b=b+1
                    ...
                    for i,j in zip(dat['validation-classification report'],dat['model']):
                        a=len(dat['validation-classification report'])
                        b=1
                        print(j)
                        print(i)
                        b=b+1
def train_and_log_regression(x_train,x_test,y_train,y_test):
                ...
                for i in model:
                    if i=='linear regression':
                        ...
                        msle_lr_t=mean_squared_log_error(y_train,lr.predict(x_train))
                        ...
                        msle_lr_v=mean_squared_log_error(y_test,lr.predict(x_test))
                        ...
                        msle_lr_t=mean_squared_log_error(y_train,sgd.predict(x_train))
                        ...
                        msle_lr_v=mean_squared_log_error(y_test,sgd.predict(x_test))
                        ...
                        msle_lr_t=mean_squared_log_error(y_train,rr.predict(x_train))
                        ...
                        msle_lr_v=mean_squared_log_error(y_test,rr.predict(x_test))
                        ...
                        msle_lr_t=mean_squared_log_error(y_train,en.predict(x_train))
                        ...
                        msle_lr_v=mean_squared_log_error(y_test,en.predict(x_test))
                        ...
                        msle_lr_t=mean_squared_log_error(y_train,dtr.predict(x_train))
                        ...
                        msle_lr_v=mean_squared_log_error(y_test,dtr.predict(x_test))
                        ...
                        msle_lr_t=mean_squared_log_error(y_train,rfr.predict(x_train))
                        ...
                        msle_lr_v=mean_squared_log_error(y_test,rfr.predict(x_test))
                        ...
                        msle_lr_t=mean_squared_log_error(y_train,adar.predict(x_train))
                        ...
                        msle_lr_v=mean_squared_log_error(y_test,adar.predict(x_test))
                        ...
                        msle_lr_t=mean_squared_log_error(y_train,gbr.predict(x_train))
                        ...
                        msle_lr_v=mean_squared_log_error(y_test,gbr.predict(x_test))
                        ...
                        msle_lr_t=mean_squared_log_error(y_train,xgbr.predict(x_train))
                        ...
                        msle_lr_v=mean_squared_log_error(y_test,xgbr.predict(x_test))
                        ...
                        msle_lr_t=mean_squared_log_error(y_train,br.predict(x_train))
                        ...
                        msle_lr_v=mean_squared_log_error(y_test,br.predict(x_test))
                        ...
                        msle_lr_t=mean_squared_log_error(y_train,hgbr.predict(x_train))
                        ...
                        mape_lr_v=mean_absolute_percentage_error(y_test,hgbr.predict(x_test))
                        msle_lr_v=mean_squared_log_error(y_test,hgbr.predict(x_test))
                        ...
                        msle_lr_t=mean_squared_log_error(y_train,etr.predict(x_train))
                        ...
                        msle_lr_v=mean_squared_log_error(y_test,etr.predict(x_test))
                        ...
                        msle_lr_t=mean_squared_log_error(y_train,cbr.predict(x_train))
                        ...
                        msle_lr_v=mean_squared_log_error(y_test,cbr.predict(x_test))
