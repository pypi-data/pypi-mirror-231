...
class Orden(BaseModel):
    ...
    op_topologia: types.TopologiaOrdenPago = types.TopologiaOrdenPago.notify_on_payment_settlement  # noqa: E501
    op_usu_clave: str
    ...
    def build_xml(self):
        ...
        elements = self.dict(
            exclude_none=True,
            exclude={'categoria', 'op_ord_clave'},
        )
    ...
    def parse_xml(cls, mensaje):
        ordenpago = mensaje.find('ordenpago')

        orden_data = {
            'id': ordenpago.attrib['Id'],
            'categoria': mensaje.attrib['categoria'],
        }
