...
@pytest.fixture()
def valid_datafile(datadir, valid_data):
    file_name = os.path.join(datadir, "valid.json")
...
@pytest.fixture()
def empty_datafile(datadir):
    file_name = os.path.join(datadir, "empty.json")
...
class TestItems:
    ...
    def test_save__nothing_scraped_non_exiting_datafile(
        ...
        filename = os.path.join(datadir, test_name + ".json")
    ...
    def test_save__scraped_non_exiting_datafile(
        self, items_collection_with_scraped_data, expected_with_scraped_urls, datadir
    ):
        """
