...
cpu = 12
num_iterations = 1000
mgl_directory = /home/<user>/MGLTools-<version>
...
# 6. Adjust the parameters in the 'config.txt' file as needed. Make sure to correctly set the MGLTools installation directory and docking parameters in this file.
