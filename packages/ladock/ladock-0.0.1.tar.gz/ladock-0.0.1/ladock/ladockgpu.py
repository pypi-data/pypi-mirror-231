...
def process_ligand_link(prepare_gpf, ligand_url, ligand_dir, ligand_tmp_dir, lig_name, num_iterations, max_workers, csv_path, prepare_receptor, receptor_name, prepare_ligand, directory, ensamble, output_model_dir, counter, nrun):
    retry_count = 0
    max_retries = 10
                        ...
                        for line in lines:
                            if line.strip():
                                if not line.startswith("#"):
                                    ...
                                    process_ligand_link(prepare_gpf, ligand_url, ligand_dir, ligand_tmp_dir, lig_name, num_iterations, max_workers, csv_path, prepare_receptor, receptor_name, prepare_ligand, directory, ensamble, output_model_dir, counter, nrun)
