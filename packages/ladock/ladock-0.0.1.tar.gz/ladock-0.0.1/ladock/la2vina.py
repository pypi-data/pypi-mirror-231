...
def main():  
    ...
    LADOCK is an innovative application designed for molecular docking simulations, harnessing the capabilities of AutoDock Vina to predict ligand-receptor interactions. This tool offers essential insights for drug discovery efforts by automating the entire simulation process – from ligand preparation and receptor setup to docking execution and result analysis. Its adaptability shines through as it effectively handles diverse ligand types, including single molecules, multiple molecules, and online-sourced ligands.
    """
    developer_contact = """
    Developer Contact:
