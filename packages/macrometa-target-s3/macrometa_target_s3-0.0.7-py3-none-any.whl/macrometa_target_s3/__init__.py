    ...
    def config(self) -> list[ConfigProperty]:
        ...
        return [
            ...
            ConfigProperty(
                ...
                "If disabled, an object will be created per batch as defined by "
                "`batch_flush_interval`.",
                default_value="true",
            ),
            ConfigProperty(
                ...
                False,
                False,
                description="When `hard_delete` option is true, then DeleteObjects command will be performed "
                "in S3 to delete the objects. Calculation of Metrics such as `exported_bytes`,"
