...
The `drb-topic-sentinel5p` is a DRB plugin declaring topics about
[Sentinel-5](https://sentinels.copernicus.eu/web/sentinel/missions/sentinel-5)
EO satellite.

## Installation
```bash
pip install drb-topic-sentinel5p
```

## Sentinel-5 topics
This section references topics defined in the `drb-topic-sentinel5p` DRB plugin.
