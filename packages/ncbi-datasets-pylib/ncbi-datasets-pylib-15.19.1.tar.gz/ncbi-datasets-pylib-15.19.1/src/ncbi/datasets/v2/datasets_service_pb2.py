...
_TAXONOMYDATASET = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_protobuf_dot_wrappers__pb2._BYTESVALUE,
    serialized_options=b'\302\360\031\301\004\n\236\002\010\001\022%/v2alpha/taxonomy/taxon/{taxon}/image*5Retrieve image associated with a taxonomic identifier2pUsing an NCBI Taxonomy ID or a name (common or scientific) at any rank, get the image associated with the taxon.:\016taxonomy_imageB\010Taxonomyr\nimage/jpegr\timage/pngr\nimage/tiffr\rimage/svg+xml\n\235\002\010\002\022\027/v2alpha/taxonomy/image*=Retrieve image associated with a taxonomic identifier by post2pUsing an NCBI Taxonomy ID or a name (common or scientific) at any rank, get the image associated with the taxon.:\023taxonomy_image_postB\010Taxonomyr\nimage/jpegr\timage/pngr\nimage/tiffr\rimage/svg+xml',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\302\360\031\311\004\n\242\002\010\001\"./v2alpha/taxonomy/taxon/{taxon}/image/metadata*>Retrieve image metadata associated with a taxonomic identifier2yUsing an NCBI Taxonomy ID or a name (common or scientific) at any rank, get the image metadata associated with the taxon.:\027taxonomy_image_metadataB\010Taxonomyr\020application/json\n\241\002\010\002\" /v2alpha/taxonomy/image/metadata*FRetrieve image metadata associated with a taxonomic identifier by post2yUsing an NCBI Taxonomy ID or a name (common or scientific) at any rank, get the image metadata associated with the taxon.:\034taxonomy_image_metadata_postB\010Taxonomyr\020application/json',
    create_key=_descriptor._internal_create_key,
  ),
])
