    ...
    def GetCameraStreams(self, cameraId:str=None) -> XPRCollection:
        ...
        try:
            ...
            with self._fLock:
                ...
                reqheaders:list[str] = {
                    # TEST TODO:
                    #"Authorization": "Bearer {0}".format("eyJhbGciOiJSUzI1NiIsImtpZCI6IjI1N0ExNjRDQTVCQzA4MjU2RjQ4OTBBRDZEMDJGMDNFIiwidHlwIjoiSldUIn0..rVZM8VBUHBIrliJnt2JMfFwmV2trEJx2gd2wJgYJiP3ul1gM6tFpf0acnZU4QTW9dOqWQ_jUyyXCgBGyBf7etPeFualfJwOhM3_a9Cec5BhWycZtpzpcZpTIPM8EEAbd2UrL3DwacvPSx1L4mtSDI-n1kXh4vsPHSsdWG-gAqkjBV9al7z63m5M08dOlBCjbPOpCQdzSgXDgjODeEOCQRJ1h7JVa0zm7VJDA1O86-KYvfTtLnFFDCvqJHA2h5tGzMj_7Zb8628If4xO8LZyx1Bn9gJzKGjKbTFTZmFB0-NFEL13shlMc6RhpvcuY1xulgcn2991SvaXMh1x_JuoV-Q"),
                    "Authorization": "Bearer {0}".format(self._fLoginInfo.Token),
                    "Accept": "*/*",
                    "Accept-Encoding": "gzip, deflate, br",
                    "Connection": "keep-alive",
