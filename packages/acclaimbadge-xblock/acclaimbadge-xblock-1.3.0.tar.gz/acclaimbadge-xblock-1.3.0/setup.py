...
setup(
    ...
    version='1.3.0',
    description='XBlock used to retrieve badges from acclaim',  
    ...
    entry_points={
        'xblock.v1': [
            'acclaimbadge = acclaimbadge:AcclaimBadgeXBlock',
        ]
    },
    package_data=package_data("acclaimbadge", ["static", "public"]),
)
