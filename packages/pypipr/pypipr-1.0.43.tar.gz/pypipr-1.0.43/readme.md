...
Output:
```py
<generator object batchmaker at 0x70ebc14ee0>
...
Output:
```py
<generator object chunck_array at 0x70eb398b40>
...
Output:
```py
2023-09-20 00:28:10.215166+07:00
2023-09-19 17:28:10.216712+00:00
2023-09-19 10:28:10.221808-07:00
```
...
Output:
```py
<generator object filter_empty at 0x70ebbee7a0>
```
...
Output:
```py
<generator object get_class_method at 0x70ebbee980>
```
...
(['Home', 'Emas 1 Gram', 'History', 'Trend', 'Perak 1 Gram', 'Pluang'],
 [['Harga Emas Hari Ini - Rabu, 20 September 2023'],
  ['Spot Emas USD↑1.931,78 (+0,30) / oz',
   'Kurs IDR15.140,00 / USD',
   'Emas IDR↑940.318 (+146) / gr'],
  ['LM Antam (Jual)↑1.081.000 (+6.000) / gr',
   'LM Antam (Beli)↑961.000 (+6.000) / gr']],
 [['Harga Emas Hari Ini'],
  ...
  ['0.5',
   ...
   '1.208.000 (+8.000)',
   '604.000 (+4.000)'],
  ['Update harga LM Antam :19 September 2023, pukul 07:57Harga pembelian '
   'kembali :Rp. 961.000/gram (+6.000)',
   'Update harga LM Pegadaian :31 Agustus 2023']],
 [['Spot Harga Emas Hari Ini (Market Open)'],
  ['Satuan', 'USD', 'Kurs\xa0Dollar', 'IDR'],
  ['Ounce\xa0(oz)', '1.931,78 (+0,30)', '15.140,00', '29.247.149'],
  ['Gram\xa0(gr)', '62,11', '15.140,00', '940.318 (+146)'],
  ['Kilogram\xa0(kg)', '62.108,17', '15.140,00', '940.317.683'],
  ['Update harga emas :20 September 2023, pukul 00:27Update kurs :13 Febuari '
   '2023, pukul 09:10']],
 [['Gram', 'UBS Gold 99.99%'],
  ['Jual', 'Beli'],
  ['/ Batang', '/ Gram', '/ Batang', '/ Gram'],
  ['100', '102.311.300', '1.023.113', '96.685.000', '966.850'],
  ['50', '51.194.400', '1.023.888', '48.395.000', '967.900'],
  ['25', '25.636.500', '1.025.460', '24.300.000', '972.000'],
  ['10', '10.304.800', '1.030.480', '9.770.000', '977.000'],
  ['5', '5.179.700', '1.035.940', '4.937.000', '987.400'],
  ['1', '1.080.800', '1.080.800', '1.020.000', '1.020.000'],
  ['', 'Update :19 September 2023, pukul 11:25']],
 [['Konversi Satuan'],
 ...
 [['Pergerakan Harga Emas Dunia'],
  ...
  ['oz', '1.931,48', '+0,30+0,02%', '29.242.607', '+4.542+0,02%'],
  ['gr', '62,10', '+0,01+0,02%', '940.172', '+146+0,02%'],
  ['30 Hari', 'Kurs', '', '', '15.731', '-591-3,76%'],
  ['oz', '1.823,86', '+107,92+5,92%', '28.691.142', '+556.008+1,94%'],
  ['gr', '58,64', '+3,47+5,92%', '922.442', '+17.876+1,94%'],
  ...
  ['oz', '1.823,86', '+107,92+5,92%', '28.691.142', '+556.008+1,94%'],
  ['gr', '58,64', '+3,47+5,92%', '922.442', '+17.876+1,94%'],
  ['1 Tahun', 'Kurs', '', '', '14.980', '+160+1,07%'],
  ['oz', '1.664,08', '+267,70+16,09%', '24.927.918', '+4.319.231+17,33%'],
  ['gr', '53,50', '+8,61+16,09%', '801.451', '+138.866+17,33%'],
  ['2 Tahun', 'Kurs', '', '', '14.233', '+907+6,37%'],
  ['oz', '1.761,91', '+169,87+9,64%', '25.077.283', '+4.169.867+16,63%'],
  ['gr', '56,65', '+5,46+9,64%', '806.253', '+134.064+16,63%'],
  ['3 Tahun', 'Kurs', '', '', '14.768', '+372+2,52%'],
  ['oz', '1.950,39', '-18,61-0,95%', '28.803.360', '+443.790+1,54%'],
  ['gr', '62,71', '-0,60-0,95%', '926.050', '+14.268+1,54%'],
  ['5 Tahun', 'Kurs', '', '', '14.824', '+316+2,13%'],
  ['oz', '1.197,04', '+734,74+61,38%', '17.744.921', '+11.502.228+64,82%'],
  ['gr', '38,49', '+23,62+61,38%', '570.512', '+369.805+64,82%']])
(['Home', 'Emas 1 Gram', 'History', 'Trend', 'Perak 1 Gram', 'Pluang'],
 [[''],
  ['Emas 24 KaratHarga Emas 1 Gram', ''],
  ['USD', '62,11↑', '+0,01+0,02%'],
  ['KURS', '15.386,30↓', '-0,45-0,00%'],
  ['IDR', '955.614,92↑', '+120,46+0,01%'],
  ['Rabu, 20 September 2023 00:27']],
 [[''],
 ...
 [['Pergerakkan Harga Emas 1 Gram'],
  ...
  ['USD', '62,10', '62,10 - 62,11', '62,11'],
  ['KURS', '15.386,75', '15.386,30 - 15.386,75', '15.386,53'],
  ['IDR', '955.494,46', '955.494,46 - 955.614,92', '955.554,69'],
  [''],
  ['', 'Awal Tahun', 'Pergerakkan YTD', '+/- YTD'],
  ['USD', '58,64', '58,23 - 65,97', '+3,47 (5,92%)'],
  ['KURS', '15.538,50', '14.669,40 - 15.629,15', '-152,20(-0,98%)'],
  ['IDR', '911.153,72', '888.842,84 - 982.694,10', '+44.461,20 (4,88%)'],
  [''],
  ['', 'Tahun Lalu / 52 Minggu', 'Pergerakkan 52 Minggu', '+/- 52 Minggu'],
  ['USD', '53,71', '52,31 - 65,97', '+8,40 (15,64%)'],
  ['KURS', '14.993,65', '14.669,40 - 15.785,40', '+392,65 (2,62%)'],
  ['IDR', '805.372,70', '795.009,21 - 982.694,10', '+150.242,22 (18,65%)']])
```
...
8
['mana', 'aja']
[<Element a at 0x70eb3a7660>, <Element a at 0x70eb4072a0>, <Element a at 0x70eb407340>, <Element a at 0x70eb407390>, <Element a at 0x70eb4073e0>, <Element a at 0x70eb407430>, <Element a at 0x70eb407480>, <Element a at 0x70eb4074d0>, <Element a at 0x70eb407520>, <Element a at 0x70eb407570>, <Element a at 0x70eb4075c0>, <Element a at 0x70eb407610>, <Element a at 0x70eb407660>, <Element a at 0x70eb4076b0>, <Element a at 0x70eb407700>, <Element a at 0x70eb407750>, <Element a at 0x70eb4077a0>, <Element a at 0x70eb4077f0>]
False
```
...
Output:
```py
<generator object irange at 0x70ebcd3ab0>
<generator object irange at 0x70ebcd3ab0>
['a', 'k', 'u']
[1, 2, 3, 4, 5, 6, 7]
[10, 9, 8, 7, 6, 5]
...
Output:
```py
<generator object iscandir at 0x70eb399740>
    ...
    __subclasshook__ : NotImplemented
      _cached_cparts : ['https:', 'www.google.com']
             _cparts : ['https:', 'www.google.com']
                _drv : 
            _flavour : <pathlib._PosixFlavour object at 0x70ee00fc50>
               _hash : -494015894429577560
     ...
     is_block_device : False
      is_char_device : False
         ...
         is_reserved : False
           is_socket : False
          is_symlink : False
             iterdir : <generator object Path.iterdir at 0x70ebb38ba0>
...
Output:
```py
<Timer(Thread-2, started 484955897088)>
...
Output:
```py
<generator object sets_ordered at 0x70ebc0bac0>
...
Output:
```py
{'a': <generator object ExampleComparePerformance.a.<locals>.<genexpr> at 0x70ebc0a5a0>,
