...
Output:
```py
<generator object batchmaker at 0x714667cca0>
...
Output:
```py
<generator object chunck_array at 0x7145e10b40>
...
Output:
```py
2023-09-19 08:35:10.420212+07:00
2023-09-19 01:35:10.421746+00:00
2023-09-18 18:35:10.425573-07:00
```
...
Output:
```py
<generator object filter_empty at 0x71466567a0>
```
...
Output:
```py
<generator object get_class_method at 0x7146656980>
```
...
(['Home', 'Emas 1 Gram', 'History', 'Trend', 'Perak 1 Gram', 'Pluang'],
 [['Harga Emas Hari Ini - Selasa, 19 September 2023'],
  ['Spot Emas USD↑1.932,65 (+1,69) / oz',
   'Kurs IDR15.140,00 / USD',
   'Emas IDR↑940.741 (+823) / gr'],
 ...
 [['Spot Harga Emas Hari Ini (Market Open)'],
  ...
  ['Ounce\xa0(oz)', '1.932,65 (+1,69)', '15.140,00', '29.260.321'],
  ['Gram\xa0(gr)', '62,14', '15.140,00', '940.741 (+823)'],
  ['Kilogram\xa0(kg)', '62.136,14', '15.140,00', '940.741.166'],
  ['Update harga emas :19 September 2023, pukul 08:34Update kurs :13 Febuari '
   '2023, pukul 09:10']],
 [['Gram', 'UBS Gold 99.99%'],
  ['Jual', 'Beli'],
  ['/ Batang', '/ Gram', '/ Batang', '/ Gram'],
  ['100', '101.711.300', '1.017.113', '96.085.000', '960.850'],
  ['50', '50.894.400', '1.017.888', '48.095.000', '961.900'],
  ['25', '25.486.500', '1.019.460', '24.150.000', '966.000'],
  ['10', '10.244.800', '1.024.480', '9.710.000', '971.000'],
  ['5', '5.149.700', '1.029.940', '4.907.000', '981.400'],
  ['1', '1.074.800', '1.074.800', '1.014.000', '1.014.000'],
 ...
 [['Pergerakan Harga Emas Dunia'],
  ...
  ['oz', '1.930,96', '+1,69+0,09%', '29.234.734', '+25.587+0,09%'],
  ['gr', '62,08', '+0,05+0,09%', '939.919', '+823+0,09%'],
  ['30 Hari', 'Kurs', '', '', '15.731', '-591-3,76%'],
  ['oz', '1.823,86', '+108,79+5,96%', '28.691.142', '+569.179+1,98%'],
  ['gr', '58,64', '+3,50+5,96%', '922.442', '+18.300+1,98%'],
  ...
  ['oz', '1.823,86', '+108,79+5,96%', '28.691.142', '+569.179+1,98%'],
  ['gr', '58,64', '+3,50+5,96%', '922.442', '+18.300+1,98%'],
  ['1 Tahun', 'Kurs', '', '', '14.939', '+201+1,35%'],
  ['oz', '1.670,70', '+261,95+15,68%', '24.958.587', '+4.301.734+17,24%'],
  ['gr', '53,71', '+8,42+15,68%', '802.437', '+138.304+17,24%'],
  ['2 Tahun', 'Kurs', '', '', '14.238', '+902+6,34%'],
  ['oz', '1.754,86', '+177,79+10,13%', '24.985.697', '+4.274.624+17,11%'],
  ['gr', '56,42', '+5,72+10,13%', '803.309', '+137.432+17,11%'],
  ['3 Tahun', 'Kurs', '', '', '14.768', '+372+2,52%'],
  ['oz', '1.950,39', '-17,74-0,91%', '28.803.360', '+456.961+1,59%'],
  ['gr', '62,71', '-0,57-0,91%', '926.050', '+14.692+1,59%'],
  ['5 Tahun', 'Kurs', '', '', '14.839', '+301+2,03%'],
  ['oz', '1.205,51', '+727,14+60,32%', '17.888.563', '+11.371.758+63,57%'],
  ['gr', '38,76', '+23,38+60,32%', '575.131', '+365.611+63,57%']])
(['Home', 'Emas 1 Gram', 'History', 'Trend', 'Perak 1 Gram', 'Pluang'],
 [[''],
  ['Emas 24 KaratHarga Emas 1 Gram', ''],
  ['USD', '62,13↑', '+0,05+0,08%'],
  ['KURS', '15.376,30↑', '+0,20+0,00%'],
  ['IDR', '955.369,56↑', '+793,51+0,08%'],
  ['Selasa, 19 September 2023 08:35']],
 [[''],
 ...
 [['Pergerakkan Harga Emas 1 Gram'],
  ...
  ['USD', '62,08', '62,08 - 62,13', '62,11'],
  ['KURS', '15.376,10', '15.376,10 - 15.376,30', '15.376,20'],
  ['IDR', '954.576,05', '954.576,05 - 955.369,56', '954.972,81'],
  [''],
  ['', 'Awal Tahun', 'Pergerakkan YTD', '+/- YTD'],
  ['USD', '58,64', '58,23 - 65,97', '+3,49 (5,95%)'],
  ['KURS', '15.538,50', '14.669,40 - 15.629,15', '-162,20(-1,04%)'],
  ['IDR', '911.153,72', '888.842,84 - 982.694,10', '+44.215,84 (4,85%)'],
  [''],
  ['', 'Tahun Lalu / 52 Minggu', 'Pergerakkan 52 Minggu', '+/- 52 Minggu'],
  ['USD', '53,86', '52,31 - 65,97', '+8,27 (15,35%)'],
  ['KURS', '14.999,20', '14.669,40 - 15.785,40', '+377,10 (2,51%)'],
  ['IDR', '807.855,34', '795.009,21 - 982.694,10', '+147.514,22 (18,26%)']])
```
...
8
['mana', 'aja']
[<Element a at 0x7145e1f660>, <Element a at 0x7145e7f2f0>, <Element a at 0x7145e7f390>, <Element a at 0x7145e7f3e0>, <Element a at 0x7145e7f430>, <Element a at 0x7145e7f480>, <Element a at 0x7145e7f4d0>, <Element a at 0x7145e7f520>, <Element a at 0x7145e7f570>, <Element a at 0x7145e7f5c0>, <Element a at 0x7145e7f610>, <Element a at 0x7145e7f660>, <Element a at 0x7145e7f6b0>, <Element a at 0x7145e7f700>, <Element a at 0x7145e7f750>, <Element a at 0x7145e7f7a0>, <Element a at 0x7145e7f7f0>, <Element a at 0x7145e7f840>]
False
```
...
Output:
```py
<generator object irange at 0x714673bab0>
<generator object irange at 0x714673bab0>
['a', 'k', 'u']
[1, 2, 3, 4, 5, 6, 7]
[10, 9, 8, 7, 6, 5]
...
Output:
```py
<generator object iscandir at 0x7145e11740>
    ...
    __subclasshook__ : NotImplemented
      _cached_cparts : ['https:', 'www.google.com']
             _cparts : ['https:', 'www.google.com']
                _drv : 
            _flavour : <pathlib._PosixFlavour object at 0x7148a0fd50>
               _hash : 5621380185199163425
     ...
     is_block_device : False
      is_char_device : False
         ...
         is_reserved : False
           is_socket : False
          is_symlink : False
             iterdir : <generator object Path.iterdir at 0x71465a4ba0>
...
Output:
```py
<Timer(Thread-2, started 486476332288)>
...
Output:
```py
<generator object sets_ordered at 0x7146673ac0>
...
Output:
```py
{'a': <generator object ExampleComparePerformance.a.<locals>.<genexpr> at 0x71466725a0>,
