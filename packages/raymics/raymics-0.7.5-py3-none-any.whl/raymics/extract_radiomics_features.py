...
from dicom2nifti.convert_dicom import logger as dcdlogger
from dicom2nifti.convert_generic import logger as dcglogger

rlogger.setLevel(logging.ERROR)
ilogger.setLevel(logging.ERROR)
dcdlogger.setLevel(logging.ERROR)
dcglogger.setLevel(logging.ERROR)
