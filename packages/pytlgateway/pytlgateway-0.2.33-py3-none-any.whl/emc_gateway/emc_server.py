...
from .utils import (decode_gf_status, side_to_target_type, decode_exchange_id, encode_emc_side,
...
class GfServer(MongoClientTradeGateway):
    ...
    def on_trade_msg(self, record):
        ...
        target_type = encode_emc_side(record['bsflag'])
        ...
        side = encode_emc_side(record['bsflag'])
