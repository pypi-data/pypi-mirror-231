...
class Fce(KaitaiStruct):
    ...
    class Polygon(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.smoothing = self._io.read_u4le()
            self.u = []
            for i in range(3):
    ...
    class Dummy(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.breakable = self._io.read_u1()
            self.flashing = self._io.read_u1()
            self.intensity = self._io.read_u1()
            self.time_on = self._io.read_u1()
            self.time_off = self._io.read_u1()
