...
from propan.annotations import Logger, ContextRepo
...
broker = RabbitBroker(os.environ.get("BOVINE_AMQP"))
app = PropanApp(broker)
"""Propan app can be run using 

.. code-block:: bash

    propan run bovine_propan/__init__:app"""
...
@broker.handle(inbox_queue, exch)
...
@broker.handle(outbox_queue, exch)
...
@broker.handle(to_send_queue, exch)
