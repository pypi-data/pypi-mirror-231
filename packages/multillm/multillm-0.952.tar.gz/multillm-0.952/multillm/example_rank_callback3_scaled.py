...
def rank_CB_no_code(responses, config=None):
    ...
    messages = [
            {"role": "system", "content":"Given the following LLMs and their responses in rank the answer for  {}. Respond only with the answer name and explanation in bullet points. Return the response in markdown format".format(str(LLM))}
