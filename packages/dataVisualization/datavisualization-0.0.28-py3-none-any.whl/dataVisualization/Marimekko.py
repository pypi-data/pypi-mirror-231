...
file = "/Users/ethan/Library/CloudStorage/GoogleDrive-ethan@susmon.com/.shortcut-targets-by-id/1yv5Tb8aODBZ75uclq_x7pfAUuSR3Ijlb/SusMon/1 Research Reports/Chart Development/Marimekkos (Quantiles)/working data/Quantiles Generation Q2 2023.xlsx"
dataframe: dict[str, pd.DataFrame] = pd.read_excel(file, sheet_name="1")
