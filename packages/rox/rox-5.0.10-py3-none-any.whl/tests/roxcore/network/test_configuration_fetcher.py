...
class ConfigurationFetcherTests(unittest.TestCase):
    ...
    def test_will_return_cdn_data_when_successful(self):
        ...
        conf_fetcher = ConfigurationFetcher(self.device_props, request, self.conf_fetch_invoker, self.error_reporter, self.buid, self.environment)
    ...
    def test_prepare_configurations_props(self):
        ...
        conf_fetcher = ConfigurationFetcher(device_props, None, self.conf_fetch_invoker, self.error_reporter, buid, self.environment)
