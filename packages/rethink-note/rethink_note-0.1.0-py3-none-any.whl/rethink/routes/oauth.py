...
from rethink.controllers import (user as cu)
...
@router.get(path="/callback/github", response_model=cu.UserLoginResponse)
@measure_time_spend
async def callback_github(request: Request) -> cu.UserLoginResponse:
