...
def token2uid(token: str = Header(...)) -> UidCode:
    uid = ""
    err = ""
    ...
    try:
        ...
        if code != const.Code.OK:
            ...
            return UidCode(code=code, language=language)
        uid = u["id"]
        language = u["language"]
    ...
    return UidCode(code=code, uid=uid, language=language)
