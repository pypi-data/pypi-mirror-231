...
class LocalModelsTest(unittest.TestCase):
    ...
    def test_user(self):
        ...
        code = models.user.update(uid=_id, email="a@a.com", hashed="1", nickname="2", avatar="3")
        self.assertEqual(const.Code.OK, code)
    ...
    def test_node(self):
        ...
        code = models.node.to_bin(uid=self.uid, nid=node["id"])
        self.assertEqual(const.Code.OK, code)
...
"""
    ...
    def test_cursor_text(self):
        ...
        code = models.node.cursor_node_selected(self.uid, n1["id"], n2["id"])
        self.assertEqual(const.Code.OK, code)
    ...
    def test_to_bin(self):
        ...
        code = models.node.to_bin(self.uid, n1["id"])
        self.assertEqual(const.Code.OK, code)

        ns = models.node.get_nodes_in_bin(self.uid, 0, 10)
        ...
        code = models.node.restore_from_bin(self.uid, n1["id"])
        self.assertEqual(const.Code.OK, code)
