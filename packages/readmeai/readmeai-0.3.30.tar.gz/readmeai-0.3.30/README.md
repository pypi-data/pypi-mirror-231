...
To customize the README file generation process, you can modify the [configuration file]([./readmeai/conf/conf.toml](https://github.com/eli64s/readme-ai/blob/main/readmeai/conf/conf.toml)). The file contains the following sections:
