...
class ThreadingQueue:
    ...
    def __init__(self, num_of_threads: int, worker, log_dir: str = "", worker_params_builder=None, worker_params: dict = None, on_close_thread=None):
        ...
        self.threads = self.create_threads(worker, num_of_threads, loop, thread_log_dir=thread_log_dir,
    ...
    def create_threads(
            self, handler, num_of_threads, loop, thread_log_dir: str = "", worker_params_builder=None, on_close_thread=None, **kwargs
    ) -> List:
        # Create new threads
        ...
        for tid in range(num_of_threads):
            ...
            thread = WorkerThread(tid, self.is_expired, self.work_queue, self.queue_lock, handler, loop, logger,
