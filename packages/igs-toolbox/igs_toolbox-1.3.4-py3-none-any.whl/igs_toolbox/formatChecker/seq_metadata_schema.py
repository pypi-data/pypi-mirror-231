seqMetadata = {
    ...
    "properties": {
        ...
        "SPECIES": {"type": "string", "pattern": "[A-z,0-9,-,_]*"},
        "LAB_SEQUENCE_ID": {"type": "string", "pattern": "[A-z,0-9,-,_]*"},
        "DEMIS_NOTIFICATION_ID": {"type": "string"},
        "STATUS": {"type": "string"},
        "IGS_ID": {"type": "string", "pattern": "IGS-[0-9]{5}-[A-Z]{4}-[A-z,0-9,-,_]*"},
        "DATE_OF_SAMPLING": {"$ref": "#/$defs/date"},
        "DATE_OF_SEQUENCING": {"$ref": "#/$defs/date"},
        "DATE_OF_SUBMISSION": {"$ref": "#/$defs/date"},
        ...
        "ADAPTER": {"type": "string", "pattern": "[a-z,A-Z,0-9,_,-,' ',',']*"},
        "SEQUENCING_STRATEGY": {
            "enum": [
                "WGS",
                "WGA",
        ...
        "HOST": {"enum": ["Homo sapiens"]},
        "SEQUENCING_REASON": {"enum": ["random", "requested", "other"]},
        "GEOGRAPHIC_LOCATION": {"type": "string", "pattern": "[0-9]{3}"},
        "ISOLATE": {"type": "string", "pattern": "[a-z,A-Z,0-9,_,-,' ',',']*"},
        "AUTHOR": {"type": "string", "pattern": "[a-z,A-Z,0-9,_,-,' ',',']*"},
        "NAME_AMP_PROTOCOL": {"type": "string", "pattern": "[a-z,A-Z,0-9,_,-,' ',',']*"},
        "PRIME_DIAGNOSTIC_LAB.DEMIS_LAB_ID": {"type": "string", "pattern": "[0-9]{5}"},
        "PRIME_DIAGNOSTIC_LAB.NAME": {"type": "string", "pattern": "[a-z,A-Z,0-9,_,-,' ',',']*"},
        "PRIME_DIAGNOSTIC_LAB.ADDRESS": {"type": "string", "pattern": "[a-z,A-Z,0-9,_,-,' ',',']*"},
        "PRIME_DIAGNOSTIC_LAB.POSTAL_CODE": {"type": "string", "pattern": "[0-9]{5}"},
        "PRIME_DIAGNOSTIC_LAB.FEDERAL_STATE": {"$ref": "#/$defs/federalStates"},
        "PRIMER_SCHEME": {"type": "string", "pattern": "[a-z,A-Z,0-9,_,-,' ',',']*"},
        "SEQUENCING_LAB.DEMIS_LAB_ID": {"type": "string", "pattern": "[0-9]{5}"},
        "SEQUENCING_LAB.NAME": {"type": "string", "pattern": "[a-z,A-Z,0-9,_,-,' ',',']*"},
        "SEQUENCING_LAB.ADDRESS": {"type": "string", "pattern": "[a-z,A-Z,0-9,_,-,' ',',']*"},
        "SEQUENCING_LAB.POSTAL_CODE": {"type": "string", "pattern": "[0-9]{5}"},
        "SEQUENCING_LAB.FEDERAL_STATE": {"$ref": "#/$defs/federalStates"},
        "Uploads": {
            "type": "array",
            "items": {
                "type": "object",
                "properties": {
                    "REPOSITORY_NAME": {"enum": ["GISAID", "ENA", "SRA", "PubMLST", "GenBank", "Other"]},
                    "REPOSITORY_LINK": {"type": "string"},  # TODO do we need to add regex for hyperlink here?
                    "REPOSITORY_ID": {"type": "string"},
                    "UPLOAD_DATE": {"$ref": "#/$defs/date"},
                    "UPLOAD_STATUS": {"enum": ["Accepted", "Planned", "Denied", "Other"]},
                    "UPLOAD_SUBMITTER": {"type": "string"},
                },
        ...
        "Files": {
            ...
            "items": {
                "type": "object",
                "properties": {
                    "FILE_NAME": {"type": "string", "pattern": "_R[1|2]_[0-9]{1,3}.fastq.gz$"},
                    "FILE_SHA256SUM": {"type": "string", "pattern": "[A-Fa-f0-9]{64}"},
                },
    ...
    "$defs": {
        "date": {
            "type": "string",
            "format": "date",
            "pattern": "(((19|20)([2468][048]|[13579][26]|0[48])|2000)[/-]02[/-]29|((19|20)[0-9]{2}[/-](0[469]|11)[/-](0[1-9]|[12][0-9]|30)|(19|20)[0-9]{2}[/-](0[13578]|1[02])[/-](0[1-9]|[12][0-9]|3[01])|(19|20)[0-9]{2}[/-]02[/-](0[1-9]|1[0-9]|2[0-8]{1})))",
            "minLength": 10,
            "maxLength": 10,
        },
        "federalStates": {
