...
class Task(irisml.core.TaskBase):
    ...
    class Config:
        ...
        domain_id: typing.Optional[uuid.UUID] = None
        task_type: typing.Optional[typing.Literal['classification_multiclass', 'classification_multilabel', 'object_detection']] = None
