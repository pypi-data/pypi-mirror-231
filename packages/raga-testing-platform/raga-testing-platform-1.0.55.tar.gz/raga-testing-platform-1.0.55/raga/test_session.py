...
class TestSession():
    ...
    def __init__(self, project_name: str, run_name: str, u_test=False, host=None, config_data=None, access_key=None, secret_key=None, aws_raga_secret_key=None, aws_raga_access_key=None, aws_raga_role_arn=None):
