...
def image_url(x):
    return f"https://raga-testing-storage.s3.ap-south-1.amazonaws.com/1/satsure_rgb/{x}"

def mask_url(x):
    return f"https://raga-testing-storage.s3.ap-south-1.amazonaws.com/1/satsure_lulc/{x}"
...
test_ds = Dataset(test_session=test_session, name="satsure-full-dataset-v1", data=data_frame, schema=schema)
