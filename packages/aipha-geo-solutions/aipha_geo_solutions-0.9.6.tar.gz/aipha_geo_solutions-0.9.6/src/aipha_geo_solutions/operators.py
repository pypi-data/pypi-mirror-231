...
'''
   ...
   def execute_each_file_in_folder_folder(client,
     user_id='',
     user_token='',
     command='',
     parameters_dictionary_str='{}',
     ...
     parameters='file1,file2',
     extensions='.laz,.laz',
     worker_worker_instance_type='T4',
     skip_existing_files='False',
     worker_instance_type='small',
     manager_instance_type="small",
     extension_folders=".laz",
     skip_existing_files = False):
      '''
    | 
    | execute_each_file_in_folder_folder(client,
    |      user_id='',
    |      user_token='',
    |      command='',
    |      parameters_dictionary_str='{}',
    ...
    |      worker_instance_type='small',
    |      manager_instance_type="small",
    |      extension_folders=".folder1,folder2",
    |      skip_existing_files = False )
...
:param worker_instance_type: worker instance type
:param skip_existing_files:  ignore existing files
:param folder_folders: adjustable names
:param worker_instance_type: cloud instance type of worker nodes
:param manager_instance_type: cloud instance type of manager node
:param extension_folders: File extension of files in folder for folder_folders
:param skip_existing_files: skip files that already exist in the output folder
'''
      ...
      del all_parameters['folder_folders']
      del all_parameters['extension_folders']

      cmd_str = json.dumps(all_parameters)
      parameters = "folders"
      folders = folder_folders
      extensions = extension_folders
      each_file_params = {
        "user_id": client.get_username(),
        "user_token": client.get_token(),
        "command": "'" + "execute each file in folder" + "'",
        "parameters_dictionary_str": "'" + cmd_str + "'",
        "server_address": client.get_server_address(),
        "verify_ssl": client.get_verify_ssl(),
        "folders": folders,
