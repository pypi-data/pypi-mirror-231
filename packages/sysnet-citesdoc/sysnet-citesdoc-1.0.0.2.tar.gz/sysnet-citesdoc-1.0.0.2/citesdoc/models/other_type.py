...
class OtherType(object):
    ...
    attribute_map = {
        'certtificate_type': 'certtificate_type',
        'customs': 'customs',
        'documents_to_authority': 'documents_to_authority',
        'documents_to_customs': 'documents_to_customs'
    }

    def __init__(self, certtificate_type=None, customs=None, documents_to_authority=None, documents_to_customs=None):  # noqa: E501
        """OtherType - a model defined in Swagger"""  # noqa: E501
        self._certtificate_type = None
        self._customs = None
        self._documents_to_authority = None
        self._documents_to_customs = None
        self.discriminator = None
        if certtificate_type is not None:
            self.certtificate_type = certtificate_type
    ...
    @property
    def certtificate_type(self):
        """Gets the certtificate_type of this OtherType.  # noqa: E501
        ...
        :return: The certtificate_type of this OtherType.  # noqa: E501
        :rtype: str
        """
        return self._certtificate_type

    @certtificate_type.setter
    def certtificate_type(self, certtificate_type):
        """Sets the certtificate_type of this OtherType.

        Typ potvrzení podle číselníku:   * LEG - Potvrzení o zákonném získání   * COM - Potvrzení pro obchodní činnosti   * MOV - Potvrzení pro přemístění živých exemplářů   # noqa: E501

        :param certtificate_type: The certtificate_type of this OtherType.  # noqa: E501
        :type: str
        """

        self._certtificate_type = certtificate_type
