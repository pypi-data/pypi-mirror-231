...
class EauView(metaclass=EauViewMeta):
  ...
  @classmethod
  def __init_subclass__(cls, /, *bgpaths, player_sprite: str, **kwargs):
    ...
    cls.background = scpup.load_image(*bgpaths)[0] if bgpaths else None
  ...
  def init_texts(self) -> scpup.EauTextsGroup | None:
