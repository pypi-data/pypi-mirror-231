...
from ...core.john_transform_bilinear import john_transform_bilinear, john_transform_adjoint_bilinear
...
class SAXSProjectorBilinear(Projector):
    ...
    def _adjoint_subset(self,
        ...
        self._john_transform_adjoint(
            field, projections[indices], *self._get_john_transform_parameters(indices))
