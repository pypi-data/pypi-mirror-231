        ...
        match filepath.suffix:
            ...
            case ".docx":
                ...
                try:
                    ...
                    code = e.args[0]
                    if code == -2147352567:
                        print("File is already open, please close it")
...
class ComparisonReport:
    ...
    def generate_report(self, output_path_folder):
        ...
        diff_report = open(
            f"{output_path_folder}\\{self.file1name + '-' + self.file2name}.html",
            "w",
        )
...
class CompareFiles:
    def __init__(self):
        self.output_path_folder = None
        self.reference_file = None
        self.files_to_be_compared_folder = None

    def input_files(
        self,
        files_to_be_compared_folder: str,
        reference_file: str,
        output_path_folder: str,
    ):
        self.files_to_be_compared_folder = files_to_be_compared_folder
        self.reference_file = reference_file
        self.output_path_folder = output_path_folder

    def compare(self):
        comparison_files_folder = Path(self.files_to_be_compared_folder)
        reference_file = Path(self.reference_file)
        ...
        for filepath in filepaths:
            ...
            instance.generate_report(self.output_path_folder)
