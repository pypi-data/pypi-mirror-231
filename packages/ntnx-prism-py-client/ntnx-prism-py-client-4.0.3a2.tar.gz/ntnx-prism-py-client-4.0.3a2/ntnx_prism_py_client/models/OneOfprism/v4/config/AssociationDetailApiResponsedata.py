...
class AssociationDetailApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<prism.v4.config.AssociationDetail>': 'list[prism.v4.config.AssociationDetail]',
        'prism.v4.error.ErrorResponse': 'prism.v4.error.ErrorResponse',
        'List<prism.v4.config.AssociationDetailProjection>': 'list[prism.v4.config.AssociationDetailProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.AssociationDetailApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in AssociationDetailApiResponsedata.discriminator_value_class_map.values():
            return list(AssociationDetailApiResponsedata.discriminator_value_class_map.keys())[list(AssociationDetailApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AssociationDetailApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociationDetailApiResponsedata):
            return False
