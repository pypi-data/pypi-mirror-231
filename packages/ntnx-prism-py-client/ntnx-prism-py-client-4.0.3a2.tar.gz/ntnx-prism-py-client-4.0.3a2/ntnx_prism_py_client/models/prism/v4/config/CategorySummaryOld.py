...
class CategorySummaryOld(ExternalizableAbstractModel):
    ...
    :type fq_name: 
    :param name: (:attr:`name`) The short name of this category. It may not be unique for each category.<br> It is a mandatory field which must be specified inside the post/put request body.<br> This field is immutable. 
    :type name: required
    ...
    :type associations: 
    :param child_categories: (:attr:`child_categories`) 
    ...
    def _initialize_fq_object_type(self):
        return 'prism.v4.r0.a2.config.CategorySummaryOld'
    ...
    def name(self):
        """
        The short name of this category. It may not be unique for each category.<br> It is a mandatory field which must be specified inside the post/put request body.<br> This field is immutable. 
