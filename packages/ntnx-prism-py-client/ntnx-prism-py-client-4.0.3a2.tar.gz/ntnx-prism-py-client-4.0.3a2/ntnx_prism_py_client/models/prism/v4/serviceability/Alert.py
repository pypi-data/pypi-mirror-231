...
from ntnx_prism_py_client.models.prism.v4.common.AlertEntityReference import AlertEntityReference  # noqa: F401,E501
from ntnx_prism_py_client.models.prism.v4.common.EntityReference import EntityReference  # noqa: F401,E501
from ntnx_prism_py_client.models.prism.v4.common.ImpactType import ImpactType  # noqa: F401,E501
from ntnx_prism_py_client.models.prism.v4.common.MetricDetail import MetricDetail  # noqa: F401,E501
from ntnx_prism_py_client.models.prism.v4.common.Parameter import Parameter  # noqa: F401,E501
from ntnx_prism_py_client.models.prism.v4.common.Severity import Severity  # noqa: F401,E501
from ntnx_prism_py_client.models.prism.v4.serviceability.RootCauseAnalysis import RootCauseAnalysis  # noqa: F401,E501
from ntnx_prism_py_client.models.prism.v4.serviceability.SeverityTrail import SeverityTrail  # noqa: F401,E501

class Alert(ExternalizableAbstractModel):

    """

    :param is_acknowledged: (:attr:`is_acknowledged`) Field specifies if the alert is acknowledged or not. (**Default** False)
    ...
    :param is_auto_resolved: (:attr:`is_auto_resolved`) Field specifies if the alert is auto resolved or not. (**Default** False)
    :type is_auto_resolved: 
    :param is_resolved: (:attr:`is_resolved`) Field specifies if the alert is resolved or not. (**Default** False)
    :type is_resolved: 
    ...
    :type source_entity: 
    :param affected_entities: (:attr:`affected_entities`) List of all entities that are affected by the alert.
    ...
    :type creation_time: 
    :param impact_types: (:attr:`impact_types`) The impact this alert/event will have on the system. For example, availability, performance, capacity and so on.
    :type impact_types: 
    ...
    :param parameters: (:attr:`parameters`) Additional parameters associated with the alert. These parameters can be used to indicate custom key-value pairs for a given alert instance. For example, Service down in Prism Central alert can have the service name as a parameter.
    :type parameters: 
    :param service_name: (:attr:`service_name`) The service that raised the alert. For internal Nutanix services, this value is set to \"Nutanix\".
    :type service_name: 
    ...
    swagger_types = {
        ...
        'severity_trails': 'list[prism.v4.serviceability.SeverityTrail]',
        ...
        'service_name': 'str',
        'root_cause_analysis': 'list[prism.v4.serviceability.RootCauseAnalysis]',
        'ext_id': 'str',
    ...
    def source_entity(self):
        ...
        :type:
            :class:`~ntnx_prism_py_client.models.prism.v4.common.AlertEntityReference`
        """  # noqa: E501
    ...
    def affected_entities(self):
        ...
        :type:
             list[ :class:`~ntnx_prism_py_client.models.prism.v4.common.EntityReference` ]
        """  # noqa: E501
    ...
    def severity_trails(self):
        ...
        :type:
             list[ :class:`~ntnx_prism_py_client.models.prism.v4.serviceability.SeverityTrail` ]
        """  # noqa: E501
    ...
    def metric_details(self):
        ...
        :type:
             list[ :class:`~ntnx_prism_py_client.models.prism.v4.common.MetricDetail` ]
        """  # noqa: E501
    ...
    def severity(self):
        ...
        :type:
            :class:`~ntnx_prism_py_client.models.prism.v4.common.Severity`
        """  # noqa: E501
    ...
    def parameters(self):
        ...
        :type:
             list[ :class:`~ntnx_prism_py_client.models.prism.v4.common.Parameter` ]
        """  # noqa: E501
    ...
    def root_cause_analysis(self):
        ...
        :type:
             list[ :class:`~ntnx_prism_py_client.models.prism.v4.serviceability.RootCauseAnalysis` ]
        """  # noqa: E501
