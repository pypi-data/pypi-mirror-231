...
class OperationType(object):
    ...
    Allowed enum values:
        ...
        - ON
        - OFF
        - JOINED: Indicates that an entity - a cluster, for example - has joined a domain.
        - UNJOINED: Indicates that an entity - a cluster, for example - has unjoined from a domain.
        - PROTECTED: Indicates that an entity is protected/being protected in a Protection Domain.
        - UNPROTECTED: Indicates that an entity is now unprotected.
        - QUARENTINED: Indicates that an entity is quarantined.
        - UNQUARENTINED: Indicates that an entity is unquarantined.
        ...
        - IMAGEIMPORT: Indicates a CRUD operation on images.
        ...
        - TEMPLATEGUESTUPDATEINITIATE: Indicates that guest changes were initiated for a VM template.
        - TEMPLATEGUESTUPDATECANCEL: Indicates that guest changes were cancelled for a VM template.
        - TEMPLATEGUESTUPDATECOMPLETE: Indicates that guest changes were completed for a VM template.
    ...
    FLOWCLUSTERMIGRATE = "FLOWCLUSTERMIGRATE"
    ...
    def _initialize_object_type(self):
        return 'prism.v4.common.OperationType'

    def _initialize_fq_object_type(self):
        return 'prism.v4.r0.a2.common.OperationType'
