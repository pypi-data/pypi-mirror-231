...
class CategoryAssociationSummaryOld(object):
    ...
    """This attribute contains the list of entities which have been assigned the given category.<br> These entities are grouped by entity types (like VM or HOST).<br> Each associated object contains the total entities belonging to the given entity type, and category extId. 
    ...
    :type resource_group: 
    :param count: (:attr:`count`) Denotes the type of a category.  There are three category types: SYSTEM, INTERNAL, USER      This field is immutable. 
    :type count: 
    ...
    def _initialize_fq_object_type(self):
        return 'prism.v4.r0.a2.config.CategoryAssociationSummaryOld'
    ...
    def count(self):
        """
        Denotes the type of a category.  There are three category types: SYSTEM, INTERNAL, USER      This field is immutable. 
