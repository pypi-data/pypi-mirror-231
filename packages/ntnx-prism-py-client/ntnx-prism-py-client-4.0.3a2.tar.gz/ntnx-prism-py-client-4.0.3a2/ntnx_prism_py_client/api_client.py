...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        'prism.v4.config.CategoryDeleteApiResponse' : 'CategoryDeleteApiResponse',
        'prism.v4.config.CategoryProjection' : 'CategoryProjection',
        'OneOfprism.v4.serviceability.UserDefinedPolicyfilters' : 'UserDefinedPolicyfilters',
        'prism.v4.config.TaskReferenceInternal' : 'TaskReferenceInternal',
        'OneOfprism.v4.serviceability.DeleteUdaPolicyApiResponsedata' : 'DeleteUdaPolicyApiResponsedata',
        'prism.v4.serviceability.EmailConfigurationRule' : 'EmailConfigurationRule',
        'prism.v4.serviceability.CreateUdaPolicyApiResponse' : 'CreateUdaPolicyApiResponse',
        'OneOfprism.v4.serviceability.GetUdaPolicyApiResponsedata' : 'GetUdaPolicyApiResponsedata',
        'common.v1.config.IPv4Address' : 'IPv4Address',
        'prism.v4.config.AssociationDetail' : 'AssociationDetail',
        'prism.v4.serviceability.ListConflictingUdaPoliciesApiResponse' : 'ListConflictingUdaPoliciesApiResponse',
        'common.v1.config.FQDN' : 'FQDN',
        'common.v1.config.IPv6Address' : 'IPv6Address',
        'OneOfprism.v4.common.MetricDetailthreshold_value' : 'MetricDetailthreshold_value',
        'OneOfprism.v4.serviceability.UpdateUdaPolicyApiResponsedata' : 'UpdateUdaPolicyApiResponsedata',
        'common.v1.config.Flag' : 'Flag',
        'prism.v4.serviceability.AutoResolve' : 'AutoResolve',
        'OneOfprism.v4.serviceability.Conditionthreshold_value' : 'Conditionthreshold_value',
        'prism.v4.serviceability.UserDefinedPolicy' : 'UserDefinedPolicy',
        'prism.v4.serviceability.AuditListApiResponse' : 'AuditListApiResponse',
        'prism.v4.common.Severity' : 'Severity',
        'prism.v4.error.SchemaValidationErrorMessage' : 'SchemaValidationErrorMessage',
        'prism.v4.serviceability.ProxyType' : 'ProxyType',
        'prism.v4.serviceability.RemoteTunnelDetails' : 'RemoteTunnelDetails',
        'prism.v4.config.TaskReference' : 'TaskReference',
        'prism.v4.common.ConditionType' : 'ConditionType',
        'prism.v4.config.AssociationSummaryProjection' : 'AssociationSummaryProjection',
        'OneOfprism.v4.serviceability.CreateUdaPolicyApiResponsedata' : 'CreateUdaPolicyApiResponsedata',
        'prism.v4.common.EntityReference' : 'CommonEntityReference',
        'prism.v4.common.BoolValue' : 'BoolValue',
        'prism.v4.serviceability.ListSdaPoliciesApiResponse' : 'ListSdaPoliciesApiResponse',
        'prism.v4.config.CategoryListApiResponse' : 'CategoryListApiResponse',
        'prism.v4.serviceability.GetUdaPolicyApiResponse' : 'GetUdaPolicyApiResponse',
        'prism.v4.serviceability.ServiceCenter' : 'ServiceCenter',
        'prism.v4.serviceability.TriggerCondition' : 'TriggerCondition',
        'prism.v4.config.ResourceType' : 'ResourceType',
        'prism.v4.config.AssociationDetailOld' : 'AssociationDetailOld',
        'prism.v4.serviceability.DeleteUdaPolicyApiResponse' : 'DeleteUdaPolicyApiResponse',
        'prism.v4.config.AssociationDetailOldProjection' : 'AssociationDetailOldProjection',
        'OneOfprism.v4.common.Parameterparam_value' : 'Parameterparam_value',
        'prism.v4.error.ErrorResponse' : 'ErrorResponse',
        'OneOfprism.v4.config.CategoryPutResponsedata' : 'CategoryPutResponsedata',
        'OneOfprism.v4.config.CategoryCreateApiResponsedata' : 'CategoryCreateApiResponsedata',
        'prism.v4.config.Reference' : 'Reference',
        'OneOfprism.v4.config.TaskCancelResponsedata' : 'TaskCancelResponsedata',
        'OneOfprism.v4.serviceability.AlertApiResponsedata' : 'AlertApiResponsedata',
        'prism.v4.common.DoubleValue' : 'DoubleValue',
        'prism.v4.config.TaskGetResponse' : 'TaskGetResponse',
        'prism.v4.serviceability.EmailTemplate' : 'EmailTemplate',
        'prism.v4.config.CategorySummaryOld' : 'CategorySummaryOld',
        'common.v1.config.IPAddressOrFQDN' : 'IPAddressOrFQDN',
        'prism.v4.serviceability.Condition' : 'Condition',
        'prism.v4.serviceability.Audit' : 'Audit',
        'prism.v4.serviceability.AlertApiResponse' : 'AlertApiResponse',
        'prism.v4.serviceability.Event' : 'Event',
        'prism.v4.serviceability.HttpProxy' : 'HttpProxy',
        'prism.v4.serviceability.EventListApiResponse' : 'EventListApiResponse',
        'OneOfprism.v4.serviceability.ListUdaPoliciesApiResponsedata' : 'ListUdaPoliciesApiResponsedata',
        'common.v1.response.ApiResponseMetadata' : 'ApiResponseMetadata',
        'prism.v4.serviceability.CommunicationStatus' : 'CommunicationStatus',
        'prism.v4.serviceability.RootCauseAnalysisProjection' : 'RootCauseAnalysisProjection',
        'OneOfprism.v4.serviceability.ListSdaPoliciesApiResponsedata' : 'ListSdaPoliciesApiResponsedata',
        'prism.v4.serviceability.GroupEntityType' : 'GroupEntityType',
        'prism.v4.config.OwnerReference' : 'OwnerReference',
        'prism.v4.config.TaskStep' : 'TaskStep',
        'prism.v4.serviceability.AuditDbProjection' : 'AuditDbProjection',
        'prism.v4.common.ImpactType' : 'ImpactType',
        'prism.v4.serviceability.SystemDefinedPolicy' : 'SystemDefinedPolicy',
        'prism.v4.serviceability.ActionType' : 'ActionType',
        'prism.v4.serviceability.AlertDb' : 'AlertDb',
        'prism.v4.serviceability.AlertEmailConfigurationApiResponse' : 'AlertEmailConfigurationApiResponse',
        'prism.v4.serviceability.AuditDb' : 'AuditDb',
        'prism.v4.serviceability.RootCauseAnalysis' : 'RootCauseAnalysis',
        'common.v1.response.ExternalizableAbstractModel' : 'ExternalizableAbstractModel',
        'prism.v4.common.AlertEntityReference' : 'AlertEntityReference',
        'prism.v4.config.CategoryType' : 'CategoryType',
        'prism.v4.common.StringValue' : 'StringValue',
        'prism.v4.config.CategoryAssociationSummaryOld' : 'CategoryAssociationSummaryOld',
        'OneOfprism.v4.config.TaskGetResponsedata' : 'TaskGetResponsedata',
        'prism.v4.config.EntityReference' : 'ConfigEntityReference',
        'common.v1.config.Message' : 'Message',
        'OneOfprism.v4.serviceability.AuditApiResponsedata' : 'AuditApiResponsedata',
        'prism.v4.common.CauseAndResolution' : 'CauseAndResolution',
        'prism.v4.common.OperationType' : 'OperationType',
        'prism.v4.serviceability.GetSdaPolicyApiResponse' : 'GetSdaPolicyApiResponse',
        'prism.v4.config.TaskListResponse' : 'TaskListResponse',
        'prism.v4.serviceability.AlertActionSpec' : 'AlertActionSpec',
        'prism.v4.config.CategoryPutResponse' : 'CategoryPutResponse',
        'prism.v4.serviceability.ConflictingPolicy' : 'ConflictingPolicy',
        'OneOfcommon.v1.config.KVPairvalue' : 'KVPairvalue',
        'OneOfprism.v4.config.CategoryGetApiResponsedata' : 'CategoryGetApiResponsedata',
        ...
        'prism.v4.serviceability.RelatedPolicy' : 'RelatedPolicy',
        'prism.v4.serviceability.Status' : 'Status',
        'common.v1.config.MessageSeverity' : 'MessageSeverity',
        'OneOfprism.v4.serviceability.ManageAlertTaskApiResponsedata' : 'ManageAlertTaskApiResponsedata',
        'prism.v4.common.IntValue' : 'IntValue',
        'OneOfprism.v4.common.MetricDetailmetric_value' : 'MetricDetailmetric_value',
        'prism.v4.serviceability.EventApiResponse' : 'EventApiResponse',
        'OneOfprism.v4.serviceability.AlertListApiResponsedata' : 'AlertListApiResponsedata',
        'prism.v4.serviceability.EntityFilter' : 'EntityFilter',
        'prism.v4.serviceability.GroupFilter' : 'GroupFilter',
        'OneOfprism.v4.config.TaskListResponsedata' : 'TaskListResponsedata',
        'prism.v4.config.CategoryGetApiResponse' : 'CategoryGetApiResponse',
        'prism.v4.common.MetricDetail' : 'MetricDetail',
        'prism.v4.config.AssociationSummary' : 'AssociationSummary',
        'OneOfprism.v4.serviceability.ListConflictingUdaPoliciesApiResponsedata' : 'ListConflictingUdaPoliciesApiResponsedata',
        'OneOfprism.v4.serviceability.AuditListApiResponsedata' : 'AuditListApiResponsedata',
        'prism.v4.serviceability.ConnectionStatus' : 'ConnectionStatus',
        'common.v1.response.ApiLink' : 'ApiLink',
        'OneOfprism.v4.config.CategoryListApiResponsedata' : 'CategoryListApiResponsedata',
        'prism.v4.config.ResourceGroup' : 'ResourceGroup',
        'prism.v4.serviceability.EventDbProjection' : 'EventDbProjection',
        'prism.v4.serviceability.SeverityThresholdInfo' : 'SeverityThresholdInfo',
        'prism.v4.serviceability.UserReference' : 'UserReference',
        'prism.v4.config.CategoryOld' : 'CategoryOld',
        'prism.v4.serviceability.AlertConfigExceptionGroup' : 'AlertConfigExceptionGroup',
        'prism.v4.serviceability.ManageAlertsBulk' : 'ManageAlertsBulk',
        ...
        'prism.v4.serviceability.ListUdaPoliciesApiResponse' : 'ListUdaPoliciesApiResponse',
        'prism.v4.config.Task' : 'Task',
        'prism.v4.config.CategoryCreateApiResponse' : 'CategoryCreateApiResponse',
        'prism.v4.common.ComparisonOperator' : 'ComparisonOperator',
        'prism.v4.serviceability.SeverityTrail' : 'SeverityTrail',
        'OneOfprism.v4.serviceability.EventApiResponsedata' : 'EventApiResponsedata',
        'prism.v4.config.Category' : 'Category',
        'OneOfprism.v4.serviceability.AlertEmailConfigurationApiResponsedata' : 'AlertEmailConfigurationApiResponsedata',
        'OneOfprism.v4.serviceability.GetSdaPolicyApiResponsedata' : 'GetSdaPolicyApiResponsedata',
        'OneOfprism.v4.serviceability.UpdateSdaPolicyApiResponsedata' : 'UpdateSdaPolicyApiResponsedata',
        'prism.v4.serviceability.AuditEntityReference' : 'AuditEntityReference',
        'OneOfprism.v4.config.CategoryDeleteApiResponsedata' : 'CategoryDeleteApiResponsedata',
        'OneOfprism.v4.config.AssociationDetailApiResponsedata' : 'AssociationDetailApiResponsedata',
        'prism.v4.serviceability.AlertDbProjection' : 'AlertDbProjection',
        'prism.v4.serviceability.AlertEmailConfiguration' : 'AlertEmailConfiguration',
        'prism.v4.serviceability.AuditApiResponse' : 'AuditApiResponse',
        'prism.v4.serviceability.EventDb' : 'EventDb',
        'prism.v4.serviceability.ParameterizedMessage' : 'ParameterizedMessage',
        'prism.v4.common.Parameter' : 'Parameter',
        'prism.v4.serviceability.UpdateUdaPolicyApiResponse' : 'UpdateUdaPolicyApiResponse',
        'prism.v4.serviceability.AlertListApiResponse' : 'AlertListApiResponse',
        'prism.v4.serviceability.ManageAlertTaskApiResponse' : 'ManageAlertTaskApiResponse',
        'prism.v4.serviceability.Alert' : 'Alert',
        'OneOfprism.v4.serviceability.EventListApiResponsedata' : 'EventListApiResponsedata',
        'prism.v4.common.DataType' : 'DataType',
        'prism.v4.config.CategorySummaryOldProjection' : 'CategorySummaryOldProjection',
        'prism.v4.serviceability.UpdateSdaPolicyApiResponse' : 'UpdateSdaPolicyApiResponse',
        'common.v1.config.TenantAwareModel' : 'TenantAwareModel',
        'prism.v4.error.SchemaValidationError' : 'SchemaValidationError',
        'prism.v4.config.AssociationDetailApiResponse' : 'AssociationDetailApiResponse',
        'prism.v4.config.CategoryOldProjection' : 'CategoryOldProjection',
        'prism.v4.config.TaskCancelResponse' : 'TaskCancelResponse',
