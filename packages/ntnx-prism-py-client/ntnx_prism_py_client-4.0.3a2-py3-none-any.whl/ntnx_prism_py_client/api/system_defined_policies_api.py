...
class SystemDefinedPoliciesApi(object):
    ...
    def get_sda_policies(self, _page=None, _limit=None, _filter=None, _orderby=None, **kwargs):  # noqa: E501
        """Get a list of all system defined alert policies.

        >>> response = api.get_sda_policies((optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby)
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_prism_py_client.models.prism.v4.serviceability.ListSdaPoliciesApiResponse`.
        ...
        if kwargs.get('async_req'):
            return self.api_client._call_api(
                '/api/prism/v4.0.a2/serviceability/alerts/system-defined-policies', 'GET',
                path_params,
                query_params,
                header_params,
                body=body_params,
                ...
                response_type='prism.v4.serviceability.ListSdaPoliciesApiResponse',  # noqa: E501
    ...
    def get_sda_policy_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        :param extId: UID of the system defined alert policy.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_prism_py_client.models.prism.v4.serviceability.GetSdaPolicyApiResponse`.
        ...
        if kwargs.get('async_req'):
            return self.api_client._call_api(
                '/api/prism/v4.0.a2/serviceability/alerts/system-defined-policies/{extId}', 'GET',
                path_params,
                query_params,
                header_params,
                body=body_params,
                post_params=form_params,
                files=local_var_files,
                response_type='prism.v4.serviceability.GetSdaPolicyApiResponse',  # noqa: E501
                auth_settings=auth_settings,
                async_req=params.get('async_req'),
                _return_http_data_only=params.get('_return_http_data_only'),
                _preload_content=params.get('_preload_content', True),
    ...
    def update_sda_policy(self, extId, body, **kwargs):  # noqa: E501
        """Update a system defined alert policy.

        >>> response = api.update_sda_policy(extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_sda_policy(extId, body, async_req=True)
        >>> result = thread.get()

        :param extId: UID of the system defined alert policy.
        :type extId:
            :class:`str`, required
        :param body: System defined alert policy sent for the update.
        :type body:
            :class:`~ntnx_prism_py_client.models.prism.v4.serviceability.SystemDefinedPolicy`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_prism_py_client.models.prism.v4.serviceability.UpdateSdaPolicyApiResponse`.
        ...
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `update_sda_policy`")  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.api_client._call_api(
                '/api/prism/v4.0.a2/serviceability/alerts/system-defined-policies/{extId}', 'PUT',
                path_params,
                query_params,
                header_params,
                body=body_params,
                post_params=form_params,
                files=local_var_files,
                response_type='prism.v4.serviceability.UpdateSdaPolicyApiResponse',  # noqa: E501
                auth_settings=auth_settings,
                async_req=params.get('async_req'),
                _return_http_data_only=params.get('_return_http_data_only'),
                _preload_content=params.get('_preload_content', True),
