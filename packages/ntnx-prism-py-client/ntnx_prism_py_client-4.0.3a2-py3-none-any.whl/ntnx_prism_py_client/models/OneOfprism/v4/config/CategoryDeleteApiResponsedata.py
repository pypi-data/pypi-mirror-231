...
class CategoryDeleteApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.CategoryDeleteApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CategoryDeleteApiResponsedata.discriminator_value_class_map.values():
            return list(CategoryDeleteApiResponsedata.discriminator_value_class_map.keys())[list(CategoryDeleteApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CategoryDeleteApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CategoryDeleteApiResponsedata):
            return False
