...
class TaskListResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.TaskListResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in TaskListResponsedata.discriminator_value_class_map.values():
            return list(TaskListResponsedata.discriminator_value_class_map.keys())[list(TaskListResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(TaskListResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskListResponsedata):
            return False
