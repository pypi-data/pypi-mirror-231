...
class ManageAlertTaskApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.serviceability.ManageAlertTaskApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ManageAlertTaskApiResponsedata.discriminator_value_class_map.values():
            return list(ManageAlertTaskApiResponsedata.discriminator_value_class_map.keys())[list(ManageAlertTaskApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ManageAlertTaskApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ManageAlertTaskApiResponsedata):
            return False
