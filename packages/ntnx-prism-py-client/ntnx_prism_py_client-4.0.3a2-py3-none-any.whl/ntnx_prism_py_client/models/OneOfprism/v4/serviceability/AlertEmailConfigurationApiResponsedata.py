...
class AlertEmailConfigurationApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.serviceability.AlertEmailConfiguration': 'prism.v4.serviceability.AlertEmailConfiguration',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.serviceability.AlertEmailConfigurationApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in AlertEmailConfigurationApiResponsedata.discriminator_value_class_map.values():
            return list(AlertEmailConfigurationApiResponsedata.discriminator_value_class_map.keys())[list(AlertEmailConfigurationApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AlertEmailConfigurationApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlertEmailConfigurationApiResponsedata):
            return False
