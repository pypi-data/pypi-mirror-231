...
class AssociationDetail(object):
    ...
    :param category_id: (:attr:`category_id`) External identifier for the given category, used across all v4 apis/entities/resources where categories are referenced. The field has UUID format. A type 4 UUID is generated during category creation. 
    :type category_id: 
    ...
    :type count: 
    :param resource_id_list: (:attr:`resource_id_list`) List of entity or policy UUIDs associated with the particular category. 
    :type resource_id_list: 
    ...
    def __init__(self, category_id=None, resource_type=None, resource_group=None, count=None, resource_id_list=None, *args, **kwargs):  # noqa: E501
        self.__category_id = None
        self.__resource_type = None
        self.__resource_group = None
        self.__count = None
        self.__resource_id_list = None
        ...
        if resource_id_list is not None:
            self.__resource_id_list = resource_id_list
    ...
    def _initialize_fq_object_type(self):
        return 'prism.v4.r0.a2.config.AssociationDetail'
    ...
    def resource_id_list(self):
        ...
        :type:
            list[ :class:`~str` ]
        """  # noqa: E501
        return self.__resource_id_list
