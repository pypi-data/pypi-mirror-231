...
from ntnx_prism_py_client.models.prism.v4.serviceability.EmailConfigurationRule import EmailConfigurationRule  # noqa: F401,E501
from ntnx_prism_py_client.models.prism.v4.serviceability.EmailTemplate import EmailTemplate  # noqa: F401,E501
from ntnx_prism_py_client.models.prism.v4.serviceability.RemoteTunnelDetails import RemoteTunnelDetails  # noqa: F401,E501

class AlertEmailConfiguration(ExternalizableAbstractModel):

    """

    :param default_nutanix_email: (:attr:`default_nutanix_email`) The default Nutanix email ID to which alert emails would be sent.
    :type default_nutanix_email: 
    :param is_enabled: (:attr:`is_enabled`) Indicates whether alert emails should be enabled or not. (**Default** False)
    :type is_enabled: 
    :param has_default_nutanix_email: (:attr:`has_default_nutanix_email`) Indicates whether alert emails should be enabled or not on default Nutanix email ID. (**Default** False)
    :type has_default_nutanix_email: 
    :param is_email_digest_enabled: (:attr:`is_email_digest_enabled`) Indicates whether alert email digest should be enabled or not. (**Default** False)
    ...
    :type tunnel_details: 
    :param alert_email_digest_send_time: (:attr:`alert_email_digest_send_time`) Time in HH:mm format when the alert email digest is to be sent daily.
    :type alert_email_digest_send_time: 
    :param alert_email_digest_send_timezone: (:attr:`alert_email_digest_send_timezone`) Timezone for the time at which the alert email digest is to be sent daily.
    ...
    swagger_types = {
        ...
        'email_config_rules': 'list[prism.v4.serviceability.EmailConfigurationRule]',
        'email_contact_list': 'list[str]',
        'email_template': 'prism.v4.serviceability.EmailTemplate',
        'tunnel_details': 'prism.v4.serviceability.RemoteTunnelDetails',
    ...
    def _initialize_object_type(self):
        return 'prism.v4.serviceability.AlertEmailConfiguration'

    def _initialize_fq_object_type(self):
        return 'prism.v4.r0.a2.serviceability.AlertEmailConfiguration'
    ...
    def email_config_rules(self):
        ...
        :type:
             list[ :class:`~ntnx_prism_py_client.models.prism.v4.serviceability.EmailConfigurationRule` ]
        """  # noqa: E501
    ...
    def email_template(self):
        ...
        :type:
            :class:`~ntnx_prism_py_client.models.prism.v4.serviceability.EmailTemplate`
        """  # noqa: E501
    ...
    def tunnel_details(self):
        ...
        :type:
            :class:`~ntnx_prism_py_client.models.prism.v4.serviceability.RemoteTunnelDetails`
        """  # noqa: E501
