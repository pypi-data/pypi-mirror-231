...
# supported versions are 38, 39 or 310
...
if _PYTHON_VERSION in ("38", "39") and _PLATFORM_PROCESSOR in ("x86_64", "AMD64"):
...
extras_require["dicom"] = ["pydicom", "python-gdcm"]  # Update test requirements, too
