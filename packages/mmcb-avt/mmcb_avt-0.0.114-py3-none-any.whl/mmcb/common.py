...
class Packet:
    ...
    * An outbound IV, IT, and return IV
    ...
    def write_json(self, session):
        """
        Write JSON file to mass storage.
        """
        filename = f'{session}_{self.model}_{self.serial_number}_{self.channel}.json'
            ...
            json.dump(
                {
                    ...
                    'outbound_set_voltage': osvo,
                    'return_set_voltage': rsvo,
                    'outbound_measured_current': omcu,
                    'return_measured_current': rmcu,
                    'outbound_measured_voltage': omvo,
                    'return_measured_voltage': rmvo,
                    'outbound_measured_timestamp': omti,
                    'return_measured_timestamp': rmti,
                    'outbound_measured_humidity': omhu,
                    'return_measured_humidity': rmhu,
                    'outbound_measured_temperature': omte,
                    'return_measured_temperature': rmte,

                    'hold_voltage': self.hold_voltage,
                    'hold_current': self.hold_current,
                    'hold_timestamp': self.hold_timestamp,
                    'hold_temperature': self.hold_temperature,
                    'hold_humidity': self.hold_humidity,
                },
                outfile,
            )
