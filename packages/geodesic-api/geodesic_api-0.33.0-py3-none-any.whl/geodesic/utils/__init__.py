...
def deprecated(version: str = None):
    """
    Provides a deprecated message on a function that it will be deprecated in the specified version.
    ...
    def decorator(f):
        ...
        def wrapped(*args, **kwargs):
            ...
            warnings.warn(f"this function/method will be removed in {version}")
