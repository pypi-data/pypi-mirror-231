...
echo. 
echo Running pyduq!
python ..\..\pyduq\pyDUQMain.py -i "SA development application register.csv" --infer -o . -v -p
rem python ..\..\..\pyduq\pyduqmain.py -i "SA development application register.csv" -m "SA development application register.csv" -o . -v -p
pause
