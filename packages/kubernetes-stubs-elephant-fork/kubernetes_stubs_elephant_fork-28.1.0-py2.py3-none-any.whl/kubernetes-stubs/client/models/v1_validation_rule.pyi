...
class V1ValidationRule:
    ...
    def __init__(self, *, field_path: typing.Optional[str] = ..., message: typing.Optional[str] = ..., message_expression: typing.Optional[str] = ..., reason: typing.Optional[str] = ..., rule: str) -> None:
        ...
