...
class V1beta2PriorityLevelConfiguration:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., kind: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes.client.V1ObjectMeta] = ..., spec: typing.Optional[kubernetes.client.V1beta2PriorityLevelConfigurationSpec] = ..., status: typing.Optional[kubernetes.client.V1beta2PriorityLevelConfigurationStatus] = ...) -> None:
        ...
...
class V1beta2PriorityLevelConfigurationDict(typing.TypedDict, total=False):
    ...
    status: typing.Optional[kubernetes.client.V1beta2PriorityLevelConfigurationStatusDict]
