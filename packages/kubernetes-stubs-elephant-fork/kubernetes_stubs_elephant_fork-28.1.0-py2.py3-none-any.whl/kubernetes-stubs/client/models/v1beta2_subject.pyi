...
class V1beta2Subject:
    ...
    def __init__(self, *, group: typing.Optional[kubernetes.client.V1beta2GroupSubject] = ..., kind: str, service_account: typing.Optional[kubernetes.client.V1beta2ServiceAccountSubject] = ..., user: typing.Optional[kubernetes.client.V1beta2UserSubject] = ...) -> None:
        ...
