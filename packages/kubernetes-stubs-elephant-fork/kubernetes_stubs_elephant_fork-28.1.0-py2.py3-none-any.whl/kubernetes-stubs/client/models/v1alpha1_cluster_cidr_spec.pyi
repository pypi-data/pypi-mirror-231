...
class V1alpha1ClusterCIDRSpec:
    ...
    def __init__(self, *, ipv4: typing.Optional[str] = ..., ipv6: typing.Optional[str] = ..., node_selector: typing.Optional[kubernetes.client.V1NodeSelector] = ..., per_node_host_bits: int) -> None:
        ...
