...
class V1beta2LimitedPriorityLevelConfiguration:
    ...
    def __init__(self, *, assured_concurrency_shares: typing.Optional[int] = ..., borrowing_limit_percent: typing.Optional[int] = ..., lendable_percent: typing.Optional[int] = ..., limit_response: typing.Optional[kubernetes.client.V1beta2LimitResponse] = ...) -> None:
        ...
