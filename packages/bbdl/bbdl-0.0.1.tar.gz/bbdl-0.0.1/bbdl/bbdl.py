...
class BBDL:
    ...
    def get_date(self, hari=None, bulan=None, tahun=None):
        ...
        tahun, bulan, hari = self.tukar(tahun, bulan, hari)
    ...
    def tukar(self, tahun, bulan, hari):
        """
        ...
        """
        yr = str(tahun)
        mth = f"0{str(bulan)}" if (int(bulan) < 10) else str(bulan)
        days = f"0{str(hari)}" if (int(hari) < 10) else str(hari)
        return yr, mth, days
