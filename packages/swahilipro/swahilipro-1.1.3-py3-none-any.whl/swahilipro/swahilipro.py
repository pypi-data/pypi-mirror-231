...
class Parser:
  ...
  def statement(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'RUDISHA', 'CONTINUE', 'VUNJA', 'VAR', 'KAMA', 'KWA', 'WAKATI', 'FUN', int, float, identifier, '+', '-', '(', '[' or 'NOT'"
      ))
  ...
  def expr(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'VAR', 'IF', 'FOR', 'WAKATI', 'FUN', int, float, identifier, '+', '-', '(', '[' or 'NOT'"
      ))
  ...
  def atom(self):
    ...
    return res.failure(InvalidSyntaxError(
      ...
      "Expected int, float, identifier, '+', '-', '(', '[', IF', 'FOR', 'WAKATI', 'FUN'"
    ))
