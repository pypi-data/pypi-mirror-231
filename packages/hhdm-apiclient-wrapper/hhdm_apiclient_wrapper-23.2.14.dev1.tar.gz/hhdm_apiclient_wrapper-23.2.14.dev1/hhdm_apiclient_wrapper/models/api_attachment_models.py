...
class ApiPrepareUploadModel(IApiModel):
    def __init__(self, file_name: str, custom_property_attached_file_name: str, if_single_overwrite_existing: bool, auto_download: bool, use_compression: bool) -> None:
        self.file_name = file_name
...
class AddAttachmentResult:
    def __init__(self, add_attachment_status: AddAttachmentStatus, add_attached_file_response: ApiAddAttachedFileResponse, entity_id: str, file_path: str, file_name: str, message: str | None = None) -> None:
