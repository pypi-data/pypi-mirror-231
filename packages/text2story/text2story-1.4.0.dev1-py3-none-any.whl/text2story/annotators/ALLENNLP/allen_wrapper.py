        ...
        if pos != -1:
            ...
            if pos not in tagged_participants:
                ...
                if ner_tag == 'UNDEF' and tok.ent_type_ != '':
                    tagged_participants[pos] = (offset_participant, tok.pos, tok.ent_type_.lower().capitalize())
...
if __name__ == "__main__":
    ...
    with open(os.path.join(os.getcwd(), "log"), "w"):
        print(args.lang, args.action, args.input, args.output)
