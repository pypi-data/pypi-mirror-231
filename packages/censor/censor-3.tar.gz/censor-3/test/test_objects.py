...
from censor.objects import Object, dumps, items, keys, loads, values, write
from censor.objects import read, update
...
class TestObject(unittest.TestCase):
    ...
    def test_module(self):
        self.assertEqual(Object().__module__, "censor.objects")
