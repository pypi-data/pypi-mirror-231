...
if not is_installed():
    error = "\n\n===> Error: required file(s) are missing. Please uninstall and install mesibo again\n";
    raise SystemExit(error);
...
if(MESIBO_RESULT_FAIL == mesibo_init(_mesibo_lib, __mesibo_version__, python_version)):
