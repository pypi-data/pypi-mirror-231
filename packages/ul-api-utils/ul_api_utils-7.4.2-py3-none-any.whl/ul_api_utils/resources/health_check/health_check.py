...
class HealthCheckContext:
    ...
    def check_message_queues_health(
        ...
        Parameters:
            ...
            exclude_queues: List with queue names that you want to exclude from a health-check. F.E. output__old_lk
        """
        self.add_step(
