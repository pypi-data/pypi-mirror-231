...
template_gitlab_ci = "# This template file is generated by Artify. \n" \
                     "# Official documentation here: https://pypi.org/project/artify \n\n" \
                    "variables:\n   GIT_STRATEGY: clone\n\n" \
                    "stages:\n  - updates\n  - build\n  - test\n  - upload\n  - deploy\n  - security\n  - post-deploy\n\n" \
                    ...
                    "security-dast-hclappscan:\n  stage: security\n  script:\n    - echo Perform HCL AppScan Test\n" \
                    "    #- AppScan.exe\n  tags:\n    - <security_runner>\n\n" \
