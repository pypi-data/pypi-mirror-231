...
def run_external_web_sweeper(query_list: list[str], num_results_per_site=10) -> list[Candidate]:
    '''
...
def scrape_linkedin_profile_links(linkedin_profile_links: list[str]) -> list[Candidate]:
    ...
    ----------
    dict
        The Linkedin profile data in JSON format.
    """
...
def scrape_github_links(github_links: list[str]) -> list[Candidate]:
    candidates = []
