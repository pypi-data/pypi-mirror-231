...
class ApplicationList(BaseModel):
    ...
    __properties = ["applications", "next_page_token"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationList:
        """Create an instance of ApplicationList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ApplicationList.parse_obj(obj)

        _obj = ApplicationList.parse_obj({
