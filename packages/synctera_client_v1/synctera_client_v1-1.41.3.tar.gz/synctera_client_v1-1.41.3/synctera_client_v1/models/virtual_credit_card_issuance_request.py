...
class VirtualCreditCardIssuanceRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VirtualCreditCardIssuanceRequest:
        """Create an instance of VirtualCreditCardIssuanceRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VirtualCreditCardIssuanceRequest:
        """Create an instance of VirtualCreditCardIssuanceRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VirtualCreditCardIssuanceRequest.parse_obj(obj)

        _obj = VirtualCreditCardIssuanceRequest.parse_obj({
