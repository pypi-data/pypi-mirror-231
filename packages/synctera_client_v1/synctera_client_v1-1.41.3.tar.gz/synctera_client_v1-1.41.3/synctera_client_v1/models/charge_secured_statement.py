...
class ChargeSecuredStatement(BaseModel):
    """
    A statement for a charge secured account
    """
    credit_summary: CreditSummary = Field(...)
    security_account_summary: SecurityAccountSummary = Field(...)
    ...
    __properties = ["credit_summary", "security_account_summary", "account_id", "end_date", "id", "issue_date", "start_date", "account_summary", "authorized_signers", "closing_balance", "customer_service_details", "disclosure", "joint_account_holders", "opening_balance", "primary_account_holder_business", "primary_account_holder_personal", "statement_type", "total_transactions", "transactions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChargeSecuredStatement:
        """Create an instance of ChargeSecuredStatement from a JSON string"""
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of security_account_summary
        if self.security_account_summary:
            _dict['security_account_summary'] = self.security_account_summary.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChargeSecuredStatement:
        """Create an instance of ChargeSecuredStatement from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ChargeSecuredStatement.parse_obj(obj)

        _obj = ChargeSecuredStatement.parse_obj({
            "credit_summary": CreditSummary.from_dict(obj.get("credit_summary")) if obj.get("credit_summary") is not None else None,
            "security_account_summary": SecurityAccountSummary.from_dict(obj.get("security_account_summary")) if obj.get("security_account_summary") is not None else None,
