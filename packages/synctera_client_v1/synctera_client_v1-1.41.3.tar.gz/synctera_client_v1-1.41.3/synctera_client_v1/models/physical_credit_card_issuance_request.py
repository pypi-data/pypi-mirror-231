...
class PhysicalCreditCardIssuanceRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhysicalCreditCardIssuanceRequest:
        """Create an instance of PhysicalCreditCardIssuanceRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhysicalCreditCardIssuanceRequest:
        """Create an instance of PhysicalCreditCardIssuanceRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PhysicalCreditCardIssuanceRequest.parse_obj(obj)

        _obj = PhysicalCreditCardIssuanceRequest.parse_obj({
