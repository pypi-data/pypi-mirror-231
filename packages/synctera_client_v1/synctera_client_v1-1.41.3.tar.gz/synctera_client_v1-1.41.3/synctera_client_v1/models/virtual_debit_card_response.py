...
class VirtualDebitCardResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VirtualDebitCardResponse:
        """Create an instance of VirtualDebitCardResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VirtualDebitCardResponse:
        """Create an instance of VirtualDebitCardResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VirtualDebitCardResponse.parse_obj(obj)

        _obj = VirtualDebitCardResponse.parse_obj({
