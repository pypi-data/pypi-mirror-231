...
class TransferTypeRequest(str, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransferTypeRequest:
        """Create an instance of TransferTypeRequest from a JSON string"""
        return TransferTypeRequest(json.loads(json_str))
