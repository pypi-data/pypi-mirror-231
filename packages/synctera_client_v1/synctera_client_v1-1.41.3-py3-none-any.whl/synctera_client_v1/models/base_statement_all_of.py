...
class BaseStatementAllOf(BaseModel):
    ...
    __properties = ["account_summary", "authorized_signers", "closing_balance", "customer_service_details", "disclosure", "joint_account_holders", "opening_balance", "primary_account_holder_business", "primary_account_holder_personal", "statement_type", "total_transactions", "transactions"]
