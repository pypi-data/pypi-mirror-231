...
class VirtualDebitCardIssuanceRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VirtualDebitCardIssuanceRequest:
        """Create an instance of VirtualDebitCardIssuanceRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VirtualDebitCardIssuanceRequest:
        """Create an instance of VirtualDebitCardIssuanceRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VirtualDebitCardIssuanceRequest.parse_obj(obj)

        _obj = VirtualDebitCardIssuanceRequest.parse_obj({
