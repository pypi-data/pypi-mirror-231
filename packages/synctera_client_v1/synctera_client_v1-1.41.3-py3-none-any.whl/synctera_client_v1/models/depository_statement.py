...
class DepositoryStatement(BaseModel):
    """
    A statement for a depository account
    """
    saving_summary: SavingSummary = Field(...)
    ...
    __properties = ["saving_summary", "account_id", "end_date", "id", "issue_date", "start_date", "account_summary", "authorized_signers", "closing_balance", "customer_service_details", "disclosure", "joint_account_holders", "opening_balance", "primary_account_holder_business", "primary_account_holder_personal", "statement_type", "total_transactions", "transactions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DepositoryStatement:
        """Create an instance of DepositoryStatement from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of saving_summary
        if self.saving_summary:
            _dict['saving_summary'] = self.saving_summary.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DepositoryStatement:
        """Create an instance of DepositoryStatement from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DepositoryStatement.parse_obj(obj)

        _obj = DepositoryStatement.parse_obj({
            "saving_summary": SavingSummary.from_dict(obj.get("saving_summary")) if obj.get("saving_summary") is not None else None,
