...
class VirtualCreditCardResponse(BaseModel):
    """
    ...
    __properties = ["account_id", "card_product_id", "creation_time", "customer_id", "emboss_name", "expiration_month", "expiration_time", "expiration_year", "id", "is_pin_set", "last_four", "last_updated_time", "metadata", "reissue_reason", "reissued_from_id", "reissued_to_id", "form", "card_status", "memo", "status_reason", "bin", "card_brand"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VirtualCreditCardResponse:
        """Create an instance of VirtualCreditCardResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VirtualCreditCardResponse:
        """Create an instance of VirtualCreditCardResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VirtualCreditCardResponse.parse_obj(obj)

        _obj = VirtualCreditCardResponse.parse_obj({
