...
class CreateTransferType(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateTransferType:
        """Create an instance of CreateTransferType from a JSON string"""
        return CreateTransferType(json.loads(json_str))
