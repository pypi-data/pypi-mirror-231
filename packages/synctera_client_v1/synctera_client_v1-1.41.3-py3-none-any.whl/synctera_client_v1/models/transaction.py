...
class Transaction(BaseModel):
    ...
    decline: Optional[DeclineInfo] = None
    ...
    subtype: StrictStr = Field(..., description="The subtype of the transaction. For the full list of available values, see the spec for `GET /v1/transactions`.")
    ...
    type: StrictStr = Field(..., description="The type of the transaction. For the full list of available values, see the spec for `GET /v1/transactions`.")
    __properties = ["account_id", "amount", "creation_time", "currency", "customer_id", "dc_sign", "decline", "description", "effective_date", "enhanced_transaction", "force_post", "fraud_risk", "group_id", "hold_expiration_time", "id", "internal_account_id", "last_updated_time", "partial_hold", "pending_amount", "posted_amount", "posted_date", "reference_id", "status", "subtype", "system_description", "transaction_time", "type"]
    ...
    def from_dict(cls, obj: dict) -> Transaction:
        ...
        _obj = Transaction.parse_obj({
            ...
            "decline": DeclineInfo.from_dict(obj.get("decline")) if obj.get("decline") is not None else None,
