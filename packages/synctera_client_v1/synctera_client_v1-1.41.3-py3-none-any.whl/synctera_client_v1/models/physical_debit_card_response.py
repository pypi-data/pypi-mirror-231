...
class PhysicalDebitCardResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhysicalDebitCardResponse:
        """Create an instance of PhysicalDebitCardResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhysicalDebitCardResponse:
        """Create an instance of PhysicalDebitCardResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PhysicalDebitCardResponse.parse_obj(obj)

        _obj = PhysicalDebitCardResponse.parse_obj({
