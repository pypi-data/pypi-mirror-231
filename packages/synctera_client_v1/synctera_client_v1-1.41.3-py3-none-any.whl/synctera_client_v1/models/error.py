...
class Error(BaseModel):
    ...
    """
    code: Optional[StrictStr] = Field(None, description="A machine-readable string that identifies the error for programmatic use. ")
    detail: Optional[StrictStr] = Field(None, description="A human-readable string explaining this particular error. ")
    status: Optional[StrictInt] = Field(None, description="HTTP status code for this response")
    __properties = ["code", "detail", "status"]
