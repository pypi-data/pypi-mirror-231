...
class PhysicalCreditCardResponse(BaseModel):
    """
    ...
    status_reason: CardStatusReasonCode = Field(...)
    ...
    physical_card_format: PhysicalCardFormat = Field(...)
    __properties = ["account_id", "card_product_id", "creation_time", "customer_id", "emboss_name", "expiration_month", "expiration_time", "expiration_year", "id", "is_pin_set", "last_four", "last_updated_time", "metadata", "reissue_reason", "reissued_from_id", "reissued_to_id", "form", "card_image_id", "shipping", "card_status", "memo", "status_reason", "card_fulfillment_status", "fulfillment_details", "bin", "card_brand", "physical_card_format"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhysicalCreditCardResponse:
        """Create an instance of PhysicalCreditCardResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhysicalCreditCardResponse:
        """Create an instance of PhysicalCreditCardResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PhysicalCreditCardResponse.parse_obj(obj)

        _obj = PhysicalCreditCardResponse.parse_obj({
