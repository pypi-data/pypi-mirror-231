...
class CashTransaction(BaseModel):
    ...
    cash_transaction: CashTransactionData = Field(...)
    subtype: CashTransactionSubtypes = Field(...)
    __properties = ["account_id", "amount", "creation_time", "currency", "customer_id", "dc_sign", "decline", "description", "effective_date", "enhanced_transaction", "force_post", "fraud_risk", "group_id", "hold_expiration_time", "id", "internal_account_id", "last_updated_time", "metadata", "partial_hold", "pending_amount", "posted_amount", "posted_date", "reference_id", "status", "system_description", "transaction_time", "type", "cash_transaction", "subtype"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CashTransaction:
        """Create an instance of CashTransaction from a JSON string"""
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of cash_transaction
        if self.cash_transaction:
            _dict['cash_transaction'] = self.cash_transaction.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CashTransaction:
        """Create an instance of CashTransaction from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CashTransaction.parse_obj(obj)

        _obj = CashTransaction.parse_obj({
            ...
            "type": obj.get("type"),
            "cash_transaction": CashTransactionData.from_dict(obj.get("cash_transaction")) if obj.get("cash_transaction") is not None else None,
