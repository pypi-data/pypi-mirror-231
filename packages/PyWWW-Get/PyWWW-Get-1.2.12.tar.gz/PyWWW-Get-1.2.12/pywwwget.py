...
'''
    ...
    $FileInfo: pywwwget.py - Last Update: 9/20/2023 Ver. 1.2.12 RC 1 - Author: cooldude2k $
'''
...
__version_info__ = (1, 2, 12, "RC 1", 1);
__version_date_info__ = (2023, 9, 20, "RC 1", 1);
__version_date__ = str(__version_date_info__[0])+"."+str(__version_date_info__[1]).zfill(2)+"."+str(__version_date_info__[2]).zfill(2);
__revision__ = __version_info__[3];
__revision_id__ = "$Id: 054006d476ccc177df0ed80c01b17a7b6e2a4343 $";
