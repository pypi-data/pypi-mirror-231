...
class Canary(
    ...
    def __init__(
        ...
        *,
        ...
        :param cleanup: (experimental) Specify the underlying resources to be cleaned up when the canary is deleted. Using ``Cleanup.LAMBDA`` will create a Custom Resource to achieve this. Default: Cleanup.NOTHING
