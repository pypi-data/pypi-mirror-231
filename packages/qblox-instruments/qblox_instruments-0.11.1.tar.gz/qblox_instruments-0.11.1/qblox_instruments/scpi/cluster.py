...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.6.1 fwBuild=15/09/2023-07:48:13 fwHash=0x1F0F4CCD fwDirty=0 kmodVersion=0.6.1 kmodBuild=15/09/2023-07:48:13 kmodHash=0x1F0F4CCD kmodDirty=0 swVersion=0.6.1 swBuild=15/09/2023-07:48:13 swHash=0x1F0F4CCD swDirty=0 cfgManVersion=0.3.0 cfgManBuild=15/09/2023-07:48:13 cfgManHash=0x1F0F4CCD cfgManDirty=0"
            if build != build_ref:
