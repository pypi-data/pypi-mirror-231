...
class PdfPage(_PdfixBase):
    ...
    def FlattenAnnot(self, _annot: PdfAnnot, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PdfPageFlattenAnnot(self.obj, _annot.obj, _cancel_proc, _cancel_data)
        return ret
...
class PsCommand(_PdfixBase):
    ...
    def RotatePages(self, _page: PdfPage, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandRotatePages(self.obj, _page.obj, _cancel_proc, _cancel_data)
        return ret
