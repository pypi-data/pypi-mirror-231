...
class Chord():
    ...
    def getHarmonicSpectrum(self, numPartialsPerNote: int = 6, amplCallback: typing.Callable[[typing.List[float]], typing.List[float]] = None) -> typing.Tuple[typing.List[float], typing.List[float]]: ...
    ...
    def getSetharesDissonance(self, numPartialsPerNote: int = 6, useMinModel: bool = True, amplCallback: typing.Callable[[typing.List[float]], typing.List[float]] = None, dissCallback: typing.Callable[[typing.List[float]], float] = None) -> float: ...
    def getSetharesDyadsDataFrame(self, numPartialsPerNote: int = 6, useMinModel: bool = True, amplCallback: typing.Callable[[typing.List[float]], typing.List[float]] = None) -> object: ...
