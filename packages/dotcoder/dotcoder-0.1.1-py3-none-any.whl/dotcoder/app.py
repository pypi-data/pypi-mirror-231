...
from dotcoder.parsers.block_parser import BlockParser
from dotcoder.parsers.file_edit import FileEdit

from .code_context import CodeContext
from .code_file import parse_intervals
from .code_file_manager import CodeFileManager
from .config_manager import ConfigManager, dotcoder_dir_path
...
def run(
    ...
    dotcoder_dir_path.mkdir(parents=True, exist_ok=True)
    setup_logging()
