...
dotcoder_dir_path = Path.home() / ".dotcoder"
...
config_file_name = ".dotcoder_config.json"
user_config_path = dotcoder_dir_path / config_file_name
        ...
        if user_config_path.exists():
            with open(user_config_path) as config_file:
                try:
                    ...
                    cprint(
                        "Warning: User .dotcoder_config.json contains invalid"
        ...
        if project_config_path.exists():
            with open(project_config_path) as config_file:
                try:
                    ...
                    cprint(
                        "Warning: Git project .dotcoder_config.json contains invalid"
