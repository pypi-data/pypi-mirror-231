...
from .config_manager import dotcoder_dir_path
...
class DotcoderCompleter(Completer):
...
class DotcoderPromptSession(PromptSession[str]):
    def __init__(self, code_context: CodeContext, *args: Any, **kwargs: Any):
        self.code_context = code_context

        self._setup_bindings()
        super().__init__(
            completer=DotcoderCompleter(self.code_context),
            history=FilteredFileHistory(str(dotcoder_dir_path / "history")),
