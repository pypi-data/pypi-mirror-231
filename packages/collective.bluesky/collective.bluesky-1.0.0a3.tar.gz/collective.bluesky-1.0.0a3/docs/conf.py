...
# collective.bluesky documentation build configuration file
...
#
# Note that collective.bluesky documentation imports documentation from
...
# the entire collective.bluesky documentation is built.
intersphinx_mapping = {}
...
ogp_site_url = "https://collectivebluesky.readthedocs.io/"
ogp_description_length = 200
ogp_image = "https://collectivebluesky.readthedocs.io/_static/images/icon.png"
ogp_site_name = "collective.bluesky documentation"
ogp_type = "website"
...
html_use_opensearch = "https://collectivebluesky.readthedocs.io/"

html_theme_options = {
    "path_to_docs": "docs",
    "repository_url": "https://github.com/collective/collective.bluesky",
...
html_baseurl = "https://collectivebluesky.readthedocs.io/"

# -- Options for HTML help output -------------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = "ContentRulesBlueskyDoc"
...
latex_documents = [
    (
        "index",
        "ContentRulesBlueskyDoc.tex",
        "collective.bluesky documentation",
        "Pendect GmbH",
        "manual",
    ),
]
