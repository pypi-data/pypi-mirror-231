...
* [Source code](https://gitlab.inria.fr/jrye/hydronaut)
* [PyPI package](https://pypi.org/project/hydronaut)
* [API documentation](https://jrye.gitlabpages.inria.fr/hydronaut)
...
Once the plugin is updated to use Optuna >= 3.0.0, it will be possible to use [Optuna Dashboard](https://optuna.org/#dashboard) to follow optimization in real time.
