...
def raise_model_not_found_error(model_path : str) -> None:
    """
    Raises a FileNotFoundError with a message indicating that the specified model file was not found.
    
    Args:
    model_path (str): The path to the model file that was not found.
