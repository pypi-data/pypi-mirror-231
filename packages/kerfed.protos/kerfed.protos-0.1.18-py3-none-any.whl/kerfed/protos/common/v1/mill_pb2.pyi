...
class MillSettings(google.protobuf.message.Message):
    ...
    RETURN_TOOLPATH_FIELD_NUMBER: builtins.int
    ...
    return_toolpath: builtins.bool
    """Calculate and return G-code toolpaths."""
    ...
    *before* any toolpathing and will return results that are a subset
    ...
    def preprocess(self) -> global___MillPreprocess:
        ...
        like plug drill holes and pick stock, but if you have existing internal logic
        you can skip our heuristics by passing this explicitly.
        """
    def __init__(
        self,
        *,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["detail", b"detail", "machine", b"machine", "preprocess", b"preprocess", "return_toolpath", b"return_toolpath", "return_volume", b"return_volume", "skip_fixture_collisions", b"skip_fixture_collisions", "skip_prune", b"skip_prune", "tools", b"tools"]) -> None: ...
