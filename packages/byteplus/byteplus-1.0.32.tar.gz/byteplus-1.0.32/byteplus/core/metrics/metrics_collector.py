...
from byteplus.core.metrics.metrics_option import *
from byteplus.core.metrics.constant import *
from byteplus.core.metrics.metrics_reporter import MetricsReporter
from byteplus.core.metrics.protocol import Metric, MetricMessage, MetricLog, MetricLogMessage
...
class MetricsCollector(object):
    ...
    def _do_report_metrics(cls, metrics: List[Metric]):
        url: str = METRICS_URL_FORMAT.format(cls.metrics_cfg.http_schema, cls._get_domain())
    ...
    def do_report_metrics_log(cls, metric_logs: List[MetricLog]):
        url: str = METRICS_LOG_URL_FORMAT.format(cls.metrics_cfg.http_schema, cls._get_domain())
    ...
    def _get_domain(cls) -> str:
        ...
        return cls.host_availabler.get_host()
