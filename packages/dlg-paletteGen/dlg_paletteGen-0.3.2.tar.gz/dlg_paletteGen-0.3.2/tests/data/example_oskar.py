...
class Sky(object):
    ...
    def append_sources(
        ...
        _sky_lib.append_sources(
            self._capsule,
            numpy.radians(ra_deg),
            numpy.radians(dec_deg),
            I,
            Q,
            U,
            V,
    ...
    def filter_by_radius(
        ...
        _sky_lib.filter_by_radius(
            self._capsule,
            math.radians(inner_radius_deg),
            math.radians(outer_radius_deg),
            math.radians(ra0_deg),
            math.radians(dec0_deg),
        )
    ...
    def to_ds9_regions(self, filename, colour="green", width=1):
        ...
        with open(filename, "w") as file:
            file.write(
                "global color=%s dashlist=8 3 width=%d "
