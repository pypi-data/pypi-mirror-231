        ...
        if text_pairs is not None:
            ...
            if isinstance(inputs, list):
                for i in range(len(inputs)):
                    sequences.append(inputs[i] + " " + self.tokenizer.sep_token + " " + text_pairs[i])
            else:
                sequences.append(inputs + " " + self.tokenizer.sep_token + " " + text_pairs)
            masked_predictions = self._predict(sequences, top_k=top_k)
        else:
