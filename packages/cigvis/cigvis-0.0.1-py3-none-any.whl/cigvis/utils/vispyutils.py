...
def valid_kwargs(ktype):
    if ktype == 'mesh':
        ...
        colorbar_kwargs = [
            'size', 'cmap', 'clim', 'discrete', 'disc_ticks', 'dpi_scale', 'label_str',
            'label_color', 'label_size', 'tick_size', 'border_width',
            'border_color', 'savedir', 'visible'
        ]
        ...
        seiscanvas_kwargs = [
            ...
            'colorbar_region_ratio', 'scale_factor', 'center', 'fov',
