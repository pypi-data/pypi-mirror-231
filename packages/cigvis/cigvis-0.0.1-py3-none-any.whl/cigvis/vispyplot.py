...
def create_overlay(bg_volume: np.ndarray,
    ...
    if isinstance(fg_clim[0], (int, float)):
        fg_clim = [fg_clim]
...
def create_colorbar(cmap,
                    ...
                    **kwargs):
    """
    create a colorbar instance. To draw colorbar, spacify `size` params 
    or call `colorbar.update_size(size)` function.
