...
Defined at pw2wannier90.fpp lines 29-92
...
def get_nnb():
    ...
    """
    return _qepy.f90wrap_wannier__get__nnb()

def set_nnb(nnb):
    _qepy.f90wrap_wannier__set__nnb(nnb)
...
def get_array_g_kpb():
    ...
    global g_kpb
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__g_kpb(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        g_kpb = _arrays[array_handle]
    else:
        g_kpb = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__g_kpb)
...
def get_array_ig_():
    ...
    global ig_
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__ig_(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        ig_ = _arrays[array_handle]
    else:
        ig_ = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__ig_)
...
def get_array_lw():
    ...
    global lw
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__lw(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        lw = _arrays[array_handle]
    else:
        lw = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__lw)
...
def get_array_mw():
    ...
    global mw
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__mw(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        mw = _arrays[array_handle]
    else:
        mw = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__mw)
...
def get_array_num_sph():
    ...
    global num_sph
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__num_sph(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        num_sph = _arrays[array_handle]
    else:
        num_sph = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__num_sph)
...
def get_array_excluded_band():
    ...
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__excluded_band(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        excluded_band = _arrays[array_handle]
    else:
        excluded_band = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__excluded_band)
...
def get_iun_nnkp():
    ...
    Defined at pw2wannier90.fpp line 42
    
    """
    return _qepy.f90wrap_wannier__get__iun_nnkp()

def set_iun_nnkp(iun_nnkp):
    _qepy.f90wrap_wannier__set__iun_nnkp(iun_nnkp)
...
def get_iun_mmn():
    ...
    """
    return _qepy.f90wrap_wannier__get__iun_mmn()

def set_iun_mmn(iun_mmn):
    _qepy.f90wrap_wannier__set__iun_mmn(iun_mmn)
...
def get_iun_amn():
    ...
    """
    return _qepy.f90wrap_wannier__get__iun_amn()

def set_iun_amn(iun_amn):
    _qepy.f90wrap_wannier__set__iun_amn(iun_amn)
...
def get_iun_band():
    ...
    """
    return _qepy.f90wrap_wannier__get__iun_band()

def set_iun_band(iun_band):
    _qepy.f90wrap_wannier__set__iun_band(iun_band)
...
def get_iun_spn():
    ...
    """
    return _qepy.f90wrap_wannier__get__iun_spn()

def set_iun_spn(iun_spn):
    _qepy.f90wrap_wannier__set__iun_spn(iun_spn)
...
def get_iun_plot():
    ...
    """
    return _qepy.f90wrap_wannier__get__iun_plot()

def set_iun_plot(iun_plot):
    _qepy.f90wrap_wannier__set__iun_plot(iun_plot)
...
def get_iun_parity():
    ...
    """
    return _qepy.f90wrap_wannier__get__iun_parity()

def set_iun_parity(iun_parity):
    _qepy.f90wrap_wannier__set__iun_parity(iun_parity)
...
def get_nnbx():
    ...
    """
    return _qepy.f90wrap_wannier__get__nnbx()

def set_nnbx(nnbx):
    _qepy.f90wrap_wannier__set__nnbx(nnbx)
...
def get_nexband():
    ...
    """
    return _qepy.f90wrap_wannier__get__nexband()

def set_nexband(nexband):
    _qepy.f90wrap_wannier__set__nexband(nexband)
...
def get_iun_uhu():
    ...
    """
    return _qepy.f90wrap_wannier__get__iun_uhu()

def set_iun_uhu(iun_uhu):
    _qepy.f90wrap_wannier__set__iun_uhu(iun_uhu)
...
def get_iun_uiu():
    ...
    """
    return _qepy.f90wrap_wannier__get__iun_uiu()

def set_iun_uiu(iun_uiu):
    _qepy.f90wrap_wannier__set__iun_uiu(iun_uiu)
...
def get_n_wannier():
    ...
    """
    return _qepy.f90wrap_wannier__get__n_wannier()

def set_n_wannier(n_wannier):
    _qepy.f90wrap_wannier__set__n_wannier(n_wannier)
...
def get_n_proj():
    ...
    """
    return _qepy.f90wrap_wannier__get__n_proj()

def set_n_proj(n_proj):
    _qepy.f90wrap_wannier__set__n_proj(n_proj)
...
def get_array_gf():
    ...
    global gf
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__gf(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        gf = _arrays[array_handle]
    else:
        gf = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__gf)
...
def get_array_gf_spinor():
    ...
    global gf_spinor
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__gf_spinor(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        gf_spinor = _arrays[array_handle]
    else:
        gf_spinor = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__gf_spinor)
...
def get_array_sgf_spinor():
    ...
    global sgf_spinor
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__sgf_spinor(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        sgf_spinor = _arrays[array_handle]
    else:
        sgf_spinor = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__sgf_spinor)
...
def get_ispinw():
    ...
    """
    return _qepy.f90wrap_wannier__get__ispinw()

def set_ispinw(ispinw):
    _qepy.f90wrap_wannier__set__ispinw(ispinw)
...
def get_ikstart():
    ...
    """
    return _qepy.f90wrap_wannier__get__ikstart()

def set_ikstart(ikstart):
    _qepy.f90wrap_wannier__set__ikstart(ikstart)
...
def get_ikstop():
    ...
    """
    return _qepy.f90wrap_wannier__get__ikstop()

def set_ikstop(ikstop):
    _qepy.f90wrap_wannier__set__ikstop(ikstop)
...
def get_iknum():
    ...
    """
    return _qepy.f90wrap_wannier__get__iknum()

def set_iknum(iknum):
    _qepy.f90wrap_wannier__set__iknum(iknum)
...
def get_wan_mode():
    ...
    """
    return _qepy.f90wrap_wannier__get__wan_mode()

def set_wan_mode(wan_mode):
    _qepy.f90wrap_wannier__set__wan_mode(wan_mode)
...
def get_logwann():
    ...
    Defined at pw2wannier90.fpp line 59
    
    """
    return _qepy.f90wrap_wannier__get__logwann()

def set_logwann(logwann):
    _qepy.f90wrap_wannier__set__logwann(logwann)
...
def get_wvfn_formatted():
    ...
    """
    return _qepy.f90wrap_wannier__get__wvfn_formatted()

def set_wvfn_formatted(wvfn_formatted):
    _qepy.f90wrap_wannier__set__wvfn_formatted(wvfn_formatted)
...
def get_write_unk():
    ...
    """
    return _qepy.f90wrap_wannier__get__write_unk()

def set_write_unk(write_unk):
    _qepy.f90wrap_wannier__set__write_unk(write_unk)
...
def get_write_eig():
    ...
    """
    return _qepy.f90wrap_wannier__get__write_eig()

def set_write_eig(write_eig):
    _qepy.f90wrap_wannier__set__write_eig(write_eig)
...
def get_write_amn():
    ...
    """
    return _qepy.f90wrap_wannier__get__write_amn()

def set_write_amn(write_amn):
    _qepy.f90wrap_wannier__set__write_amn(write_amn)
...
def get_write_mmn():
    ...
    """
    return _qepy.f90wrap_wannier__get__write_mmn()

def set_write_mmn(write_mmn):
    _qepy.f90wrap_wannier__set__write_mmn(write_mmn)
...
def get_reduce_unk():
    ...
    """
    return _qepy.f90wrap_wannier__get__reduce_unk()

def set_reduce_unk(reduce_unk):
    _qepy.f90wrap_wannier__set__reduce_unk(reduce_unk)
...
def get_write_spn():
    ...
    """
    return _qepy.f90wrap_wannier__get__write_spn()

def set_write_spn(write_spn):
    _qepy.f90wrap_wannier__set__write_spn(write_spn)
...
def get_write_unkg():
    ...
    """
    return _qepy.f90wrap_wannier__get__write_unkg()

def set_write_unkg(write_unkg):
    _qepy.f90wrap_wannier__set__write_unkg(write_unkg)
...
def get_write_uhu():
    ...
    """
    return _qepy.f90wrap_wannier__get__write_uhu()

def set_write_uhu(write_uhu):
    _qepy.f90wrap_wannier__set__write_uhu(write_uhu)
...
def get_write_dmn():
    ...
    """
    return _qepy.f90wrap_wannier__get__write_dmn()

def set_write_dmn(write_dmn):
    _qepy.f90wrap_wannier__set__write_dmn(write_dmn)
...
def get_read_sym():
    ...
    """
    return _qepy.f90wrap_wannier__get__read_sym()

def set_read_sym(read_sym):
    _qepy.f90wrap_wannier__set__read_sym(read_sym)
...
def get_write_uiu():
    ...
    """
    return _qepy.f90wrap_wannier__get__write_uiu()

def set_write_uiu(write_uiu):
    _qepy.f90wrap_wannier__set__write_uiu(write_uiu)
...
def get_spn_formatted():
    ...
    """
    return _qepy.f90wrap_wannier__get__spn_formatted()

def set_spn_formatted(spn_formatted):
    _qepy.f90wrap_wannier__set__spn_formatted(spn_formatted)
...
def get_uhu_formatted():
    ...
    """
    return _qepy.f90wrap_wannier__get__uhu_formatted()

def set_uhu_formatted(uhu_formatted):
    _qepy.f90wrap_wannier__set__uhu_formatted(uhu_formatted)
...
def get_uiu_formatted():
    ...
    """
    return _qepy.f90wrap_wannier__get__uiu_formatted()

def set_uiu_formatted(uiu_formatted):
    _qepy.f90wrap_wannier__set__uiu_formatted(uiu_formatted)
...
def get_scdm_proj():
    ...
    """
    return _qepy.f90wrap_wannier__get__scdm_proj()

def set_scdm_proj(scdm_proj):
    _qepy.f90wrap_wannier__set__scdm_proj(scdm_proj)
...
def get_scdm_entanglement():
    ...
    Defined at pw2wannier90.fpp line 60
    
    """
    return _qepy.f90wrap_wannier__get__scdm_entanglement()

def set_scdm_entanglement(scdm_entanglement):
    _qepy.f90wrap_wannier__set__scdm_entanglement(scdm_entanglement)
...
def get_scdm_mu():
    ...
    Defined at pw2wannier90.fpp line 61
    
    """
    return _qepy.f90wrap_wannier__get__scdm_mu()

def set_scdm_mu(scdm_mu):
    _qepy.f90wrap_wannier__set__scdm_mu(scdm_mu)
...
def get_scdm_sigma():
    ...
    """
    return _qepy.f90wrap_wannier__get__scdm_sigma()

def set_scdm_sigma(scdm_sigma):
    _qepy.f90wrap_wannier__set__scdm_sigma(scdm_sigma)
...
def get_regular_mesh():
    ...
    """
    return _qepy.f90wrap_wannier__get__regular_mesh()

def set_regular_mesh(regular_mesh):
    _qepy.f90wrap_wannier__set__regular_mesh(regular_mesh)
...
def get_array_center_w():
    ...
    Defined at pw2wannier90.fpp line 66
    
    """
    global center_w
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__center_w(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        center_w = _arrays[array_handle]
    else:
        center_w = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__center_w)
...
def get_array_spin_eig():
    ...
    Defined at pw2wannier90.fpp line 67
    
    """
    global spin_eig
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__spin_eig(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        spin_eig = _arrays[array_handle]
    else:
        spin_eig = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__spin_eig)
...
def get_array_spin_qaxis():
    ...
    global spin_qaxis
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__spin_qaxis(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        spin_qaxis = _arrays[array_handle]
    else:
        spin_qaxis = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__spin_qaxis)
...
def get_array_l_w():
    ...
    Defined at pw2wannier90.fpp line 69
    
    """
    global l_w
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__l_w(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        l_w = _arrays[array_handle]
    else:
        l_w = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__l_w)
...
def get_array_mr_w():
    ...
    global mr_w
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__mr_w(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        mr_w = _arrays[array_handle]
    else:
        mr_w = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__mr_w)
...
def get_array_r_w():
    ...
    global r_w
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__r_w(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        r_w = _arrays[array_handle]
    else:
        r_w = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__r_w)
...
def get_array_xaxis():
    ...
    global xaxis
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__xaxis(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        xaxis = _arrays[array_handle]
    else:
        xaxis = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__xaxis)
...
def get_array_zaxis():
    ...
    global zaxis
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__zaxis(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        zaxis = _arrays[array_handle]
    else:
        zaxis = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__zaxis)
...
def get_array_alpha_w():
    ...
    global alpha_w
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__alpha_w(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        alpha_w = _arrays[array_handle]
    else:
        alpha_w = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__alpha_w)
...
def get_array_csph():
    ...
    global csph
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__csph(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        csph = _arrays[array_handle]
    else:
        csph = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__csph)
...
def get_seedname():
    ...
    """
    return _qepy.f90wrap_wannier__get__seedname()

def set_seedname(seedname):
    _qepy.f90wrap_wannier__set__seedname(seedname)
...
def get_array_mp_grid():
    ...
    Defined at pw2wannier90.fpp line 77
    
    """
    global mp_grid
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__mp_grid(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        mp_grid = _arrays[array_handle]
    else:
        mp_grid = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__mp_grid)
...
def get_array_rlatt():
    ...
    global rlatt
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__rlatt(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        rlatt = _arrays[array_handle]
    else:
        rlatt = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__rlatt)
...
def get_array_glatt():
    ...
    global glatt
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__glatt(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        glatt = _arrays[array_handle]
    else:
        glatt = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__glatt)
...
def get_array_kpt_latt():
    ...
    global kpt_latt
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__kpt_latt(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        kpt_latt = _arrays[array_handle]
    else:
        kpt_latt = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__kpt_latt)
...
def get_array_atcart():
    ...
    Defined at pw2wannier90.fpp line 80
    
    """
    global atcart
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__atcart(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        atcart = _arrays[array_handle]
    else:
        atcart = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__atcart)
...
def get_num_bands():
    ...
    """
    return _qepy.f90wrap_wannier__get__num_bands()

def set_num_bands(num_bands):
    _qepy.f90wrap_wannier__set__num_bands(num_bands)
...
def get_array_atsym():
    ...
    global atsym
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__atsym(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        atsym = _arrays[array_handle]
    else:
        atsym = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__atsym)
...
def get_num_nnmax():
    ...
    """
    return _qepy.f90wrap_wannier__get__num_nnmax()

def set_num_nnmax(num_nnmax):
    _qepy.f90wrap_wannier__set__num_nnmax(num_nnmax)
...
def get_array_m_mat():
    ...
    global m_mat
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__m_mat(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        m_mat = _arrays[array_handle]
    else:
        m_mat = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__m_mat)
...
def get_array_a_mat():
    ...
    global a_mat
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__a_mat(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        a_mat = _arrays[array_handle]
    else:
        a_mat = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__a_mat)
...
def get_array_u_mat():
    ...
    global u_mat
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__u_mat(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        u_mat = _arrays[array_handle]
    else:
        u_mat = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__u_mat)
...
def get_array_u_mat_opt():
    ...
    global u_mat_opt
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__u_mat_opt(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        u_mat_opt = _arrays[array_handle]
    else:
        u_mat_opt = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__u_mat_opt)
...
def get_array_lwindow():
    ...
    global lwindow
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__lwindow(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        lwindow = _arrays[array_handle]
    else:
        lwindow = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__lwindow)
...
def get_array_wann_centers():
    ...
    global wann_centers
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__wann_centers(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        wann_centers = _arrays[array_handle]
    else:
        wann_centers = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__wann_centers)
...
def get_array_wann_spreads():
    ...
    global wann_spreads
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__wann_spreads(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        wann_spreads = _arrays[array_handle]
    else:
        wann_spreads = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__wann_spreads)
...
def get_array_spreads():
    ...
    global spreads
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__spreads(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        spreads = _arrays[array_handle]
    else:
        spreads = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__spreads)
...
def get_array_eigval():
    ...
    global eigval
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__eigval(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        eigval = _arrays[array_handle]
    else:
        eigval = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__eigval)
...
def get_old_spinor_proj():
    ...
    """
    return _qepy.f90wrap_wannier__get__old_spinor_proj()

def set_old_spinor_proj(old_spinor_proj):
    _qepy.f90wrap_wannier__set__old_spinor_proj(old_spinor_proj)
...
def get_array_rir():
    ...
    global rir
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__rir(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        rir = _arrays[array_handle]
    else:
        rir = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__rir)
...
def get_array_zerophase():
    ...
    global zerophase
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_wannier__array__zerophase(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        zerophase = _arrays[array_handle]
    else:
        zerophase = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_wannier__array__zerophase)
