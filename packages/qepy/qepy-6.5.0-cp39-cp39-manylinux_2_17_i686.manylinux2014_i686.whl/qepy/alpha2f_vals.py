...
Defined at alpha2f.fpp lines 18-33
...
def get_nfreq():
    ...
    Defined at alpha2f.fpp line 27
    
    """
    return _qepy.f90wrap_alpha2f_vals__get__nfreq()

def set_nfreq(nfreq):
    _qepy.f90wrap_alpha2f_vals__set__nfreq(nfreq)
...
def get_array_omg():
    ...
    Defined at alpha2f.fpp line 32
    
    """
    global omg
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_alpha2f_vals__array__omg(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        omg = _arrays[array_handle]
    else:
        omg = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_alpha2f_vals__array__omg)
...
def get_array_lam():
    ...
    global lam
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_alpha2f_vals__array__lam(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        lam = _arrays[array_handle]
    else:
        lam = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_alpha2f_vals__array__lam)
...
def get_array_pol():
    ...
    global pol
    array_ndim, array_type, array_shape, array_handle = \
        _qepy.f90wrap_alpha2f_vals__array__pol(f90wrap.runtime.empty_handle)
    if array_handle in _arrays:
        pol = _arrays[array_handle]
    else:
        pol = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                f90wrap.runtime.empty_handle,
                                _qepy.f90wrap_alpha2f_vals__array__pol)
