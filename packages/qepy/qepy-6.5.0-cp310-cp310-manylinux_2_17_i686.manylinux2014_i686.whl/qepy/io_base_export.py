...
Defined at pw4gww.fpp lines 19-25
...
def get_file_version():
    ...
    Defined at pw4gww.fpp line 24
    
    """
    return _qepy.f90wrap_io_base_export__get__file_version()
...
def get_restart_module_verbosity():
    ...
    """
    return _qepy.f90wrap_io_base_export__get__restart_module_verbosity()

def set_restart_module_verbosity(restart_module_verbosity):
    _qepy.f90wrap_io_base_export__set__restart_module_verbosity(restart_module_verbosity)
