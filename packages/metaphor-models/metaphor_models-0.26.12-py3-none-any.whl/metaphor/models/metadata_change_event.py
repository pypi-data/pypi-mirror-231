...
class PowerBIDataflow:
    ...
    def from_dict(obj: Any) -> 'PowerBIDataflow':
        ...
        return PowerBIDataflow(created_at, aspect_type, configured_by, content, power_bi_dataflow_created_at, description, document, entity_id, id, modified_by, modified_date_time, name, refresh_schedule)
