...
if __name__ == '__main__':
    ...
    # print(dur)
    # speech_cn = r'C:\Users\Administrator\Documents\我的POPO\08_TestDstFiles\nertc_speech_new_ns_test_1_OnePlus_10_pro____\anr\Speech\01_Common_clean_files\speech_cn\nertc\0\speech_cn.wav'
    # testfile = r'C:\Users\Administrator\Documents\我的POPO\08_TestDstFiles\nertc_speech_new_ns_test_1_OnePlus_10_pro____\anr\Speech\nertcTestCase_69_cafe_0\nertc_speech_cn\0\mixDstFile.wav'
    # mixfile = r'C:\Users\Administrator\Documents\我的POPO\08_TestDstFiles\nertc_speech_new_ns_test_1_OnePlus_10_pro____\anr\Speech\nertcTestCase_69_cafe_0\nertc_speech_cn\0\mixFile.wav'
    ...
    #                             speechSection=[[16.43,18.78],[19.57,21.365],[22.01,24.22]],musicMode=False)
    #print(dur)
    ...
    for subfile in noiseList:
        ...
        # fileLen = 27*fs
        # noise,pause = len(curdata),len(curdata)
        # n = int(fileLen // (noise + pause))
        # for i in range(n):
        #     overallarray = np.concatenate((overallarray,curdata))
        #     overallarray = np.concatenate((overallarray, blankData))
        #     speechListInTran.append([i * (noise + pause), i * (noise + pause) + noise])
        # extra = timeduration - (noise + pause) * n
        # lastPoint = speechListInTran[-1][1] + pause
        # if extra > 0:
