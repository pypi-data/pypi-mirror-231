...
class IoK8sApiCoreV1PersistentVolumeList(BaseModel):
    """
    PersistentVolumeList is a list of PersistentVolume items.  # noqa: E501
    """
    ...
    items: conlist(IoK8sApiCoreV1PersistentVolume) = Field(..., description="List of persistent volumes. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1PersistentVolumeList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1PersistentVolumeList:
        """Create an instance of IoK8sApiCoreV1PersistentVolumeList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1PersistentVolumeList.parse_obj(obj)

        _obj = IoK8sApiCoreV1PersistentVolumeList.parse_obj({
            "api_version": obj.get("apiVersion"),
            "items": [IoK8sApiCoreV1PersistentVolume.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
