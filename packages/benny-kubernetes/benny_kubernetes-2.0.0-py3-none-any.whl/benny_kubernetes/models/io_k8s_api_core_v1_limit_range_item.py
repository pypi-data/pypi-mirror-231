...
class IoK8sApiCoreV1LimitRangeItem(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1LimitRangeItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1LimitRangeItem:
        """Create an instance of IoK8sApiCoreV1LimitRangeItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1LimitRangeItem.parse_obj(obj)

        _obj = IoK8sApiCoreV1LimitRangeItem.parse_obj({
