...
class IoK8sApiCoordinationV1LeaseSpec(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoordinationV1LeaseSpec:
        """Create an instance of IoK8sApiCoordinationV1LeaseSpec from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoordinationV1LeaseSpec:
        """Create an instance of IoK8sApiCoordinationV1LeaseSpec from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoordinationV1LeaseSpec.parse_obj(obj)

        _obj = IoK8sApiCoordinationV1LeaseSpec.parse_obj({
