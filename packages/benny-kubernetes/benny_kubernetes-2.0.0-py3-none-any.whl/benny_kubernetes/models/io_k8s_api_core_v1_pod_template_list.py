...
class IoK8sApiCoreV1PodTemplateList(BaseModel):
    """
    PodTemplateList is a list of PodTemplates.  # noqa: E501
    """
    ...
    items: conlist(IoK8sApiCoreV1PodTemplate) = Field(..., description="List of pod templates")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1PodTemplateList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1PodTemplateList:
        """Create an instance of IoK8sApiCoreV1PodTemplateList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1PodTemplateList.parse_obj(obj)

        _obj = IoK8sApiCoreV1PodTemplateList.parse_obj({
            "api_version": obj.get("apiVersion"),
            "items": [IoK8sApiCoreV1PodTemplate.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
