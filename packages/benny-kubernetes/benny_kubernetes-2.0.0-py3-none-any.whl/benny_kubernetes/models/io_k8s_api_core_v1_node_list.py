...
class IoK8sApiCoreV1NodeList(BaseModel):
    """
    NodeList is the whole list of all Nodes which have been registered with master.  # noqa: E501
    """
    ...
    items: conlist(IoK8sApiCoreV1Node) = Field(..., description="List of nodes")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1NodeList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1NodeList:
        """Create an instance of IoK8sApiCoreV1NodeList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1NodeList.parse_obj(obj)

        _obj = IoK8sApiCoreV1NodeList.parse_obj({
            "api_version": obj.get("apiVersion"),
            "items": [IoK8sApiCoreV1Node.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
