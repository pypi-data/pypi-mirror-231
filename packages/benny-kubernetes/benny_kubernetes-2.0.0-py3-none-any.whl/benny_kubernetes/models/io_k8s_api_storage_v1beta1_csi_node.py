...
class IoK8sApiStorageV1beta1CSINode(BaseModel):
    ...
    spec: IoK8sApiStorageV1beta1CSINodeSpec = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiStorageV1beta1CSINode:
        """Create an instance of IoK8sApiStorageV1beta1CSINode from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiStorageV1beta1CSINode:
        """Create an instance of IoK8sApiStorageV1beta1CSINode from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiStorageV1beta1CSINode.parse_obj(obj)

        _obj = IoK8sApiStorageV1beta1CSINode.parse_obj({
            ...
            "spec": IoK8sApiStorageV1beta1CSINodeSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
