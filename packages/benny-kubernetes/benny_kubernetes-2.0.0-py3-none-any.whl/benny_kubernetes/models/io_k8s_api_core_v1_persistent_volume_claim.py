...
class IoK8sApiCoreV1PersistentVolumeClaim(BaseModel):
    """
    PersistentVolumeClaim is a user's request for and claim to a persistent volume  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1PersistentVolumeClaim:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1PersistentVolumeClaim:
        """Create an instance of IoK8sApiCoreV1PersistentVolumeClaim from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1PersistentVolumeClaim.parse_obj(obj)

        _obj = IoK8sApiCoreV1PersistentVolumeClaim.parse_obj({
            ...
            "spec": IoK8sApiCoreV1PersistentVolumeClaimSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "status": IoK8sApiCoreV1PersistentVolumeClaimStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
