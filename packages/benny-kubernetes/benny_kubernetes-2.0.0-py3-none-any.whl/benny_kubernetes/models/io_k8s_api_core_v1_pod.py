...
class IoK8sApiCoreV1Pod(BaseModel):
    """
    Pod is a collection of containers that can run on a host. This resource is created by clients and scheduled onto hosts.  # noqa: E501
    """
    ...
    status: Optional[IoK8sApiCoreV1PodStatus] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1Pod:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1Pod:
        """Create an instance of IoK8sApiCoreV1Pod from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1Pod.parse_obj(obj)

        _obj = IoK8sApiCoreV1Pod.parse_obj({
            ...
            "status": IoK8sApiCoreV1PodStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
