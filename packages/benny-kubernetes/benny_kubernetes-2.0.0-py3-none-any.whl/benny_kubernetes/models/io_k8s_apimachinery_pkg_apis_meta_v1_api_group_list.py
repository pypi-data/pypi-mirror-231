...
class IoK8sApimachineryPkgApisMetaV1APIGroupList(BaseModel):
    """
    APIGroupList is a list of APIGroup, to allow clients to discover the API at /apis.  # noqa: E501
    """
    ...
    groups: conlist(IoK8sApimachineryPkgApisMetaV1APIGroup) = Field(..., description="groups is a list of APIGroup.")
    ...
    __properties = ["apiVersion", "groups", "kind"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApimachineryPkgApisMetaV1APIGroupList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApimachineryPkgApisMetaV1APIGroupList:
        """Create an instance of IoK8sApimachineryPkgApisMetaV1APIGroupList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApimachineryPkgApisMetaV1APIGroupList.parse_obj(obj)

        _obj = IoK8sApimachineryPkgApisMetaV1APIGroupList.parse_obj({
