...
class IoK8sApiCoreV1SecretList(BaseModel):
    """
    SecretList is a list of Secret.  # noqa: E501
    """
    ...
    items: conlist(IoK8sApiCoreV1Secret) = Field(..., description="Items is a list of secret objects. More info: https://kubernetes.io/docs/concepts/configuration/secret")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1SecretList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1SecretList:
        """Create an instance of IoK8sApiCoreV1SecretList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1SecretList.parse_obj(obj)

        _obj = IoK8sApiCoreV1SecretList.parse_obj({
            "api_version": obj.get("apiVersion"),
            "items": [IoK8sApiCoreV1Secret.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
