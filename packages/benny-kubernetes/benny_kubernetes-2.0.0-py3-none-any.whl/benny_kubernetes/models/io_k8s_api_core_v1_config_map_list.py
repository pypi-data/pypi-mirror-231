...
class IoK8sApiCoreV1ConfigMapList(BaseModel):
    """
    ConfigMapList is a resource containing a list of ConfigMap objects.  # noqa: E501
    """
    ...
    items: conlist(IoK8sApiCoreV1ConfigMap) = Field(..., description="Items is the list of ConfigMaps.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1ConfigMapList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1ConfigMapList:
        """Create an instance of IoK8sApiCoreV1ConfigMapList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1ConfigMapList.parse_obj(obj)

        _obj = IoK8sApiCoreV1ConfigMapList.parse_obj({
            "api_version": obj.get("apiVersion"),
            "items": [IoK8sApiCoreV1ConfigMap.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
