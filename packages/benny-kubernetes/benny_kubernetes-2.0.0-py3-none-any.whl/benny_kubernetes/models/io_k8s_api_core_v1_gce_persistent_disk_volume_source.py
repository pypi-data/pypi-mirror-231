...
class IoK8sApiCoreV1GCEPersistentDiskVolumeSource(BaseModel):
    ...
    partition: Optional[StrictInt] = Field(None, description="The partition in the volume that you want to mount. If omitted, the default is to mount by volume name. Examples: For volume /dev/sda1, you specify the partition as \"1\". Similarly, the volume partition for /dev/sda is \"0\" (or you can leave the property empty). More info: https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk")
    pd_name: StrictStr = Field(..., alias="pdName", description="Unique name of the PD resource in GCE. Used to identify the disk in GCE. More info: https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk")
    read_only: Optional[StrictBool] = Field(None, alias="readOnly", description="ReadOnly here will force the ReadOnly setting in VolumeMounts. Defaults to false. More info: https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1GCEPersistentDiskVolumeSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1GCEPersistentDiskVolumeSource:
        """Create an instance of IoK8sApiCoreV1GCEPersistentDiskVolumeSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1GCEPersistentDiskVolumeSource.parse_obj(obj)

        _obj = IoK8sApiCoreV1GCEPersistentDiskVolumeSource.parse_obj({
