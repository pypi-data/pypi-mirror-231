...
class IoK8sApiCoordinationV1Lease(BaseModel):
    ...
    spec: Optional[IoK8sApiCoordinationV1LeaseSpec] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoordinationV1Lease:
        """Create an instance of IoK8sApiCoordinationV1Lease from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoordinationV1Lease:
        """Create an instance of IoK8sApiCoordinationV1Lease from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoordinationV1Lease.parse_obj(obj)

        _obj = IoK8sApiCoordinationV1Lease.parse_obj({
            ...
            "spec": IoK8sApiCoordinationV1LeaseSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
