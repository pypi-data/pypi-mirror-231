...
class IoK8sApiCoreV1HostPathVolumeSource(BaseModel):
    ...
    type: Optional[StrictStr] = Field(None, description="Type for HostPath Volume Defaults to \"\" More info: https://kubernetes.io/docs/concepts/storage/volumes#hostpath")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1HostPathVolumeSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1HostPathVolumeSource:
        """Create an instance of IoK8sApiCoreV1HostPathVolumeSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1HostPathVolumeSource.parse_obj(obj)

        _obj = IoK8sApiCoreV1HostPathVolumeSource.parse_obj({
            "path": obj.get("path"),
            "type": obj.get("type")
        })
        return _obj
