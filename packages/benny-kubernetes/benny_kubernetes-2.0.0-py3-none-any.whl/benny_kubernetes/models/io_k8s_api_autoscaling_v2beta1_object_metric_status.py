...
class IoK8sApiAutoscalingV2beta1ObjectMetricStatus(BaseModel):
    """
    ...
    __properties = ["averageValue", "currentValue", "metricName", "selector", "target"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiAutoscalingV2beta1ObjectMetricStatus:
        """Create an instance of IoK8sApiAutoscalingV2beta1ObjectMetricStatus from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiAutoscalingV2beta1ObjectMetricStatus:
        """Create an instance of IoK8sApiAutoscalingV2beta1ObjectMetricStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiAutoscalingV2beta1ObjectMetricStatus.parse_obj(obj)

        _obj = IoK8sApiAutoscalingV2beta1ObjectMetricStatus.parse_obj({
