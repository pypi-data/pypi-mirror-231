...
class IoK8sApiNetworkingV1beta1HTTPIngressPath(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiNetworkingV1beta1HTTPIngressPath:
        """Create an instance of IoK8sApiNetworkingV1beta1HTTPIngressPath from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiNetworkingV1beta1HTTPIngressPath:
        """Create an instance of IoK8sApiNetworkingV1beta1HTTPIngressPath from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiNetworkingV1beta1HTTPIngressPath.parse_obj(obj)

        _obj = IoK8sApiNetworkingV1beta1HTTPIngressPath.parse_obj({
