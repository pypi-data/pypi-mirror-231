...
class IoK8sApiCoreV1Binding(BaseModel):
    ...
    target: IoK8sApiCoreV1ObjectReference = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1Binding:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1Binding:
        """Create an instance of IoK8sApiCoreV1Binding from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1Binding.parse_obj(obj)

        _obj = IoK8sApiCoreV1Binding.parse_obj({
            ...
            "target": IoK8sApiCoreV1ObjectReference.from_dict(obj.get("target")) if obj.get("target") is not None else None
        })
        return _obj
