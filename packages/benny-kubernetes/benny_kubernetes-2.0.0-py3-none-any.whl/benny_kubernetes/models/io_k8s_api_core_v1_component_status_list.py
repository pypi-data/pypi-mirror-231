...
class IoK8sApiCoreV1ComponentStatusList(BaseModel):
    """
    Status of all the conditions for the component as a list of ComponentStatus objects.  # noqa: E501
    """
    ...
    items: conlist(IoK8sApiCoreV1ComponentStatus) = Field(..., description="List of ComponentStatus objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1ComponentStatusList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1ComponentStatusList:
        """Create an instance of IoK8sApiCoreV1ComponentStatusList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1ComponentStatusList.parse_obj(obj)

        _obj = IoK8sApiCoreV1ComponentStatusList.parse_obj({
            "api_version": obj.get("apiVersion"),
            "items": [IoK8sApiCoreV1ComponentStatus.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
