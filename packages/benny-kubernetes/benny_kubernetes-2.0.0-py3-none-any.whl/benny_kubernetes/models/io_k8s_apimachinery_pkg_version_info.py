...
class IoK8sApimachineryPkgVersionInfo(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApimachineryPkgVersionInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApimachineryPkgVersionInfo:
        """Create an instance of IoK8sApimachineryPkgVersionInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApimachineryPkgVersionInfo.parse_obj(obj)

        _obj = IoK8sApimachineryPkgVersionInfo.parse_obj({
