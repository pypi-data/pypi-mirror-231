...
class IoK8sApiCoreV1WeightedPodAffinityTerm(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1WeightedPodAffinityTerm:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1WeightedPodAffinityTerm:
        """Create an instance of IoK8sApiCoreV1WeightedPodAffinityTerm from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1WeightedPodAffinityTerm.parse_obj(obj)

        _obj = IoK8sApiCoreV1WeightedPodAffinityTerm.parse_obj({
            "pod_affinity_term": IoK8sApiCoreV1PodAffinityTerm.from_dict(obj.get("podAffinityTerm")) if obj.get("podAffinityTerm") is not None else None,
