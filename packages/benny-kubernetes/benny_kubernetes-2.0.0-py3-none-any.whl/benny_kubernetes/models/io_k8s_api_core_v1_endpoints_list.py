...
class IoK8sApiCoreV1EndpointsList(BaseModel):
    """
    EndpointsList is a list of endpoints.  # noqa: E501
    """
    ...
    items: conlist(IoK8sApiCoreV1Endpoints) = Field(..., description="List of endpoints.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1EndpointsList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1EndpointsList:
        """Create an instance of IoK8sApiCoreV1EndpointsList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1EndpointsList.parse_obj(obj)

        _obj = IoK8sApiCoreV1EndpointsList.parse_obj({
            "api_version": obj.get("apiVersion"),
            "items": [IoK8sApiCoreV1Endpoints.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
