...
class IoK8sApiCoreV1EventList(BaseModel):
    """
    EventList is a list of events.  # noqa: E501
    """
    ...
    items: conlist(IoK8sApiCoreV1Event) = Field(..., description="List of events")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1EventList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1EventList:
        """Create an instance of IoK8sApiCoreV1EventList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1EventList.parse_obj(obj)

        _obj = IoK8sApiCoreV1EventList.parse_obj({
            "api_version": obj.get("apiVersion"),
            "items": [IoK8sApiCoreV1Event.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
