...
class IoK8sApiRbacV1alpha1Role(BaseModel):
    """
    ...
    rules: Optional[conlist(IoK8sApiRbacV1alpha1PolicyRule)] = Field(None, description="Rules holds all the PolicyRules for this Role")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiRbacV1alpha1Role:
        """Create an instance of IoK8sApiRbacV1alpha1Role from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiRbacV1alpha1Role:
        """Create an instance of IoK8sApiRbacV1alpha1Role from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiRbacV1alpha1Role.parse_obj(obj)

        _obj = IoK8sApiRbacV1alpha1Role.parse_obj({
