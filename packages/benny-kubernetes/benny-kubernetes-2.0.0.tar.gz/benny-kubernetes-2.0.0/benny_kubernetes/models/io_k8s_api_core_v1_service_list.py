...
class IoK8sApiCoreV1ServiceList(BaseModel):
    """
    ServiceList holds a list of services.  # noqa: E501
    """
    ...
    items: conlist(IoK8sApiCoreV1Service) = Field(..., description="List of services")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1ServiceList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1ServiceList:
        """Create an instance of IoK8sApiCoreV1ServiceList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1ServiceList.parse_obj(obj)

        _obj = IoK8sApiCoreV1ServiceList.parse_obj({
            "api_version": obj.get("apiVersion"),
            "items": [IoK8sApiCoreV1Service.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
