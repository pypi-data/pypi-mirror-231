...
class IoK8sApiAdmissionregistrationV1MutatingWebhook(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiAdmissionregistrationV1MutatingWebhook:
        """Create an instance of IoK8sApiAdmissionregistrationV1MutatingWebhook from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiAdmissionregistrationV1MutatingWebhook:
        """Create an instance of IoK8sApiAdmissionregistrationV1MutatingWebhook from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiAdmissionregistrationV1MutatingWebhook.parse_obj(obj)

        _obj = IoK8sApiAdmissionregistrationV1MutatingWebhook.parse_obj({
