...
class IoK8sApiNetworkingV1NetworkPolicy(BaseModel):
    """
    NetworkPolicy describes what network traffic is allowed for a set of Pods  # noqa: E501
    """
    ...
    spec: Optional[IoK8sApiNetworkingV1NetworkPolicySpec] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiNetworkingV1NetworkPolicy:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiNetworkingV1NetworkPolicy:
        """Create an instance of IoK8sApiNetworkingV1NetworkPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiNetworkingV1NetworkPolicy.parse_obj(obj)

        _obj = IoK8sApiNetworkingV1NetworkPolicy.parse_obj({
            ...
            "spec": IoK8sApiNetworkingV1NetworkPolicySpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
