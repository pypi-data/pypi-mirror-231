...
class IoK8sApiCoreV1LimitRange(BaseModel):
    """
    LimitRange sets resource usage limits for each kind of resource in a Namespace.  # noqa: E501
    """
    ...
    spec: Optional[IoK8sApiCoreV1LimitRangeSpec] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1LimitRange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1LimitRange:
        """Create an instance of IoK8sApiCoreV1LimitRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1LimitRange.parse_obj(obj)

        _obj = IoK8sApiCoreV1LimitRange.parse_obj({
            ...
            "spec": IoK8sApiCoreV1LimitRangeSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
