...
class IoK8sApiCoreV1PodList(BaseModel):
    """
    PodList is a list of Pods.  # noqa: E501
    """
    ...
    items: conlist(IoK8sApiCoreV1Pod) = Field(..., description="List of pods. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1PodList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1PodList:
        """Create an instance of IoK8sApiCoreV1PodList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1PodList.parse_obj(obj)

        _obj = IoK8sApiCoreV1PodList.parse_obj({
            "api_version": obj.get("apiVersion"),
            "items": [IoK8sApiCoreV1Pod.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
