...
class IoK8sApiCoreV1Namespace(BaseModel):
    """
    Namespace provides a scope for Names. Use of multiple namespaces is optional.  # noqa: E501
    """
    ...
    spec: Optional[IoK8sApiCoreV1NamespaceSpec] = None
    status: Optional[IoK8sApiCoreV1NamespaceStatus] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1Namespace:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1Namespace:
        """Create an instance of IoK8sApiCoreV1Namespace from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1Namespace.parse_obj(obj)

        _obj = IoK8sApiCoreV1Namespace.parse_obj({
            ...
            "spec": IoK8sApiCoreV1NamespaceSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "status": IoK8sApiCoreV1NamespaceStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
