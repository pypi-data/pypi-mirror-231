...
class IoK8sApiCoreV1ReplicationController(BaseModel):
    """
    ReplicationController represents the configuration of a replication controller.  # noqa: E501
    """
    ...
    spec: Optional[IoK8sApiCoreV1ReplicationControllerSpec] = None
    status: Optional[IoK8sApiCoreV1ReplicationControllerStatus] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1ReplicationController:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1ReplicationController:
        """Create an instance of IoK8sApiCoreV1ReplicationController from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1ReplicationController.parse_obj(obj)

        _obj = IoK8sApiCoreV1ReplicationController.parse_obj({
            ...
            "spec": IoK8sApiCoreV1ReplicationControllerSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "status": IoK8sApiCoreV1ReplicationControllerStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
