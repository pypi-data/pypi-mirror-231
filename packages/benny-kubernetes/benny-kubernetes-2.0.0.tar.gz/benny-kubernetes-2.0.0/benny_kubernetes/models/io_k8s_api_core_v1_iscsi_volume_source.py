...
class IoK8sApiCoreV1ISCSIVolumeSource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1ISCSIVolumeSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1ISCSIVolumeSource:
        """Create an instance of IoK8sApiCoreV1ISCSIVolumeSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1ISCSIVolumeSource.parse_obj(obj)

        _obj = IoK8sApiCoreV1ISCSIVolumeSource.parse_obj({
