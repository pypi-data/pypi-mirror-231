...
class IoK8sApiCoreV1KeyToPath(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1KeyToPath:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1KeyToPath:
        """Create an instance of IoK8sApiCoreV1KeyToPath from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1KeyToPath.parse_obj(obj)

        _obj = IoK8sApiCoreV1KeyToPath.parse_obj({
            "key": obj.get("key"),
            "mode": obj.get("mode"),
            "path": obj.get("path")
        })
