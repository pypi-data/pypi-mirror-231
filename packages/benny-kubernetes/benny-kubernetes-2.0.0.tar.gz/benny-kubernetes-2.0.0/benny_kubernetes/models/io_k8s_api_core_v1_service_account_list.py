...
class IoK8sApiCoreV1ServiceAccountList(BaseModel):
    ...
    items: conlist(IoK8sApiCoreV1ServiceAccount) = Field(..., description="List of ServiceAccounts. More info: https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1ServiceAccountList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1ServiceAccountList:
        """Create an instance of IoK8sApiCoreV1ServiceAccountList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1ServiceAccountList.parse_obj(obj)

        _obj = IoK8sApiCoreV1ServiceAccountList.parse_obj({
            "api_version": obj.get("apiVersion"),
            "items": [IoK8sApiCoreV1ServiceAccount.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
