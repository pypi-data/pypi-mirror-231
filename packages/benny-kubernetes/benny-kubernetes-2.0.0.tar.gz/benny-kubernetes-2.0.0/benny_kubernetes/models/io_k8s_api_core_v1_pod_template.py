...
class IoK8sApiCoreV1PodTemplate(BaseModel):
    """
    PodTemplate describes a template for creating copies of a predefined pod.  # noqa: E501
    """
    ...
    __properties = ["apiVersion", "kind", "metadata", "template"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1PodTemplate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1PodTemplate:
        """Create an instance of IoK8sApiCoreV1PodTemplate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1PodTemplate.parse_obj(obj)

        _obj = IoK8sApiCoreV1PodTemplate.parse_obj({
