...
class IoK8sApiCoreV1FlexVolumeSource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1FlexVolumeSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1FlexVolumeSource:
        """Create an instance of IoK8sApiCoreV1FlexVolumeSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1FlexVolumeSource.parse_obj(obj)

        _obj = IoK8sApiCoreV1FlexVolumeSource.parse_obj({
