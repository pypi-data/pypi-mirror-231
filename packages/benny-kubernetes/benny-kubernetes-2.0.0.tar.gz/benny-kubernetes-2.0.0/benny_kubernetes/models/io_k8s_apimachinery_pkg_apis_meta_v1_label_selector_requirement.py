...
class IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement(BaseModel):
    ...
    values: Optional[conlist(StrictStr)] = Field(None, description="values is an array of string values. If the operator is In or NotIn, the values array must be non-empty. If the operator is Exists or DoesNotExist, the values array must be empty. This array is replaced during a strategic merge patch.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement:
        """Create an instance of IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement.parse_obj(obj)

        _obj = IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement.parse_obj({
            "key": obj.get("key"),
