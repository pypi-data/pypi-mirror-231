...
class IoK8sApiCoreV1Node(BaseModel):
    """
    Node is a worker node in Kubernetes. Each node will have a unique identifier in the cache (i.e. in etcd).  # noqa: E501
    """
    ...
    spec: Optional[IoK8sApiCoreV1NodeSpec] = None
    status: Optional[IoK8sApiCoreV1NodeStatus] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1Node:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1Node:
        """Create an instance of IoK8sApiCoreV1Node from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1Node.parse_obj(obj)

        _obj = IoK8sApiCoreV1Node.parse_obj({
            ...
            "spec": IoK8sApiCoreV1NodeSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "status": IoK8sApiCoreV1NodeStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
