...
class IoK8sApiCoreV1PersistentVolume(BaseModel):
    ...
    spec: Optional[IoK8sApiCoreV1PersistentVolumeSpec] = None
    status: Optional[IoK8sApiCoreV1PersistentVolumeStatus] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1PersistentVolume:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1PersistentVolume:
        """Create an instance of IoK8sApiCoreV1PersistentVolume from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1PersistentVolume.parse_obj(obj)

        _obj = IoK8sApiCoreV1PersistentVolume.parse_obj({
            ...
            "spec": IoK8sApiCoreV1PersistentVolumeSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "status": IoK8sApiCoreV1PersistentVolumeStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
