...
class IoK8sApiCoreV1TopologySelectorLabelRequirement(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1TopologySelectorLabelRequirement:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1TopologySelectorLabelRequirement:
        """Create an instance of IoK8sApiCoreV1TopologySelectorLabelRequirement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1TopologySelectorLabelRequirement.parse_obj(obj)

        _obj = IoK8sApiCoreV1TopologySelectorLabelRequirement.parse_obj({
            "key": obj.get("key"),
