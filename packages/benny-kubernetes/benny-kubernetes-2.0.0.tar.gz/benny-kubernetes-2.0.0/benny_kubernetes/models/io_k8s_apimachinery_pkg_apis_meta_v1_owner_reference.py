...
class IoK8sApimachineryPkgApisMetaV1OwnerReference(BaseModel):
    ...
    block_owner_deletion: Optional[StrictBool] = Field(None, alias="blockOwnerDeletion", description="If true, AND if the owner has the \"foregroundDeletion\" finalizer, then the owner cannot be deleted from the key-value store until this reference is removed. Defaults to false. To set this field, a user needs \"delete\" permission of the owner, otherwise 422 (Unprocessable Entity) will be returned.")
    controller: Optional[StrictBool] = Field(None, description="If true, this reference points to the managing controller.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApimachineryPkgApisMetaV1OwnerReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApimachineryPkgApisMetaV1OwnerReference:
        """Create an instance of IoK8sApimachineryPkgApisMetaV1OwnerReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApimachineryPkgApisMetaV1OwnerReference.parse_obj(obj)

        _obj = IoK8sApimachineryPkgApisMetaV1OwnerReference.parse_obj({
