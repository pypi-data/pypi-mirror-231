...
class IoK8sApiCoreV1ResourceQuota(BaseModel):
    """
    ResourceQuota sets aggregate quota restrictions enforced per namespace  # noqa: E501
    """
    ...
    spec: Optional[IoK8sApiCoreV1ResourceQuotaSpec] = None
    status: Optional[IoK8sApiCoreV1ResourceQuotaStatus] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1ResourceQuota:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1ResourceQuota:
        """Create an instance of IoK8sApiCoreV1ResourceQuota from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1ResourceQuota.parse_obj(obj)

        _obj = IoK8sApiCoreV1ResourceQuota.parse_obj({
            ...
            "spec": IoK8sApiCoreV1ResourceQuotaSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "status": IoK8sApiCoreV1ResourceQuotaStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
