...
class IoK8sApiCoreV1NodeSystemInfo(BaseModel):
    ...
    container_runtime_version: StrictStr = Field(..., alias="containerRuntimeVersion", description="ContainerRuntime Version reported by the node through runtime remote API (e.g. docker://1.5.0).")
    ...
    system_uuid: StrictStr = Field(..., alias="systemUUID", description="SystemUUID reported by the node. For unique machine identification MachineID is preferred. This field is specific to Red Hat hosts https://access.redhat.com/documentation/en-US/Red_Hat_Subscription_Management/1/html/RHSM/getting-system-uuid.html")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1NodeSystemInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1NodeSystemInfo:
        """Create an instance of IoK8sApiCoreV1NodeSystemInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1NodeSystemInfo.parse_obj(obj)

        _obj = IoK8sApiCoreV1NodeSystemInfo.parse_obj({
