...
class IoK8sApiRbacV1RoleBinding(BaseModel):
    """
    RoleBinding references a role, but does not contain it.  It can reference a Role in the same namespace or a ClusterRole in the global namespace. It adds who information via Subjects and namespace information by which namespace it exists in.  RoleBindings in a given namespace only have effect in that namespace.  # noqa: E501
    """
    ...
    role_ref: IoK8sApiRbacV1RoleRef = Field(..., alias="roleRef")
    subjects: Optional[conlist(IoK8sApiRbacV1Subject)] = Field(None, description="Subjects holds references to the objects the role applies to.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiRbacV1RoleBinding:
        """Create an instance of IoK8sApiRbacV1RoleBinding from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiRbacV1RoleBinding:
        """Create an instance of IoK8sApiRbacV1RoleBinding from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiRbacV1RoleBinding.parse_obj(obj)

        _obj = IoK8sApiRbacV1RoleBinding.parse_obj({
            ...
            "role_ref": IoK8sApiRbacV1RoleRef.from_dict(obj.get("roleRef")) if obj.get("roleRef") is not None else None,
            "subjects": [IoK8sApiRbacV1Subject.from_dict(_item) for _item in obj.get("subjects")] if obj.get("subjects") is not None else None
        })
        return _obj
