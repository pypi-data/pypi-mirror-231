...
class IoK8sApiCoreV1QuobyteVolumeSource(BaseModel):
    ...
    """
    group: Optional[StrictStr] = Field(None, description="Group to map volume access to Default is no group")
    read_only: Optional[StrictBool] = Field(None, alias="readOnly", description="ReadOnly here will force the Quobyte volume to be mounted with read-only permissions. Defaults to false.")
    ...
    tenant: Optional[StrictStr] = Field(None, description="Tenant owning the given Quobyte volume in the Backend Used with dynamically provisioned Quobyte volumes, value is set by the plugin")
    user: Optional[StrictStr] = Field(None, description="User to map volume access to Defaults to serivceaccount user")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1QuobyteVolumeSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1QuobyteVolumeSource:
        """Create an instance of IoK8sApiCoreV1QuobyteVolumeSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1QuobyteVolumeSource.parse_obj(obj)

        _obj = IoK8sApiCoreV1QuobyteVolumeSource.parse_obj({
            "group": obj.get("group"),
