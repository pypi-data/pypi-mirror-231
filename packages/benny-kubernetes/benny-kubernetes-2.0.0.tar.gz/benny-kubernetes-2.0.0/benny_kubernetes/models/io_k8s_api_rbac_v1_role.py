...
class IoK8sApiRbacV1Role(BaseModel):
    """
    Role is a namespaced, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding.  # noqa: E501
    """
    ...
    rules: Optional[conlist(IoK8sApiRbacV1PolicyRule)] = Field(None, description="Rules holds all the PolicyRules for this Role")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiRbacV1Role:
        """Create an instance of IoK8sApiRbacV1Role from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiRbacV1Role:
        """Create an instance of IoK8sApiRbacV1Role from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiRbacV1Role.parse_obj(obj)

        _obj = IoK8sApiRbacV1Role.parse_obj({
