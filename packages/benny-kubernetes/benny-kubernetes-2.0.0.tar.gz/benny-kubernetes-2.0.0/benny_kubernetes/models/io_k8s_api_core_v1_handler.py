...
class IoK8sApiCoreV1Handler(BaseModel):
    """
    Handler defines a specific action that should be taken  # noqa: E501
    """
    ...
    __properties = ["exec", "httpGet", "tcpSocket"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1Handler:
        """Create an instance of IoK8sApiCoreV1Handler from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1Handler:
        """Create an instance of IoK8sApiCoreV1Handler from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1Handler.parse_obj(obj)

        _obj = IoK8sApiCoreV1Handler.parse_obj({
