...
class IoK8sApiBatchV1Job(BaseModel):
    """
    Job represents the configuration of a single job.  # noqa: E501
    """
    ...
    status: Optional[IoK8sApiBatchV1JobStatus] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiBatchV1Job:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiBatchV1Job:
        """Create an instance of IoK8sApiBatchV1Job from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiBatchV1Job.parse_obj(obj)

        _obj = IoK8sApiBatchV1Job.parse_obj({
            ...
            "status": IoK8sApiBatchV1JobStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
