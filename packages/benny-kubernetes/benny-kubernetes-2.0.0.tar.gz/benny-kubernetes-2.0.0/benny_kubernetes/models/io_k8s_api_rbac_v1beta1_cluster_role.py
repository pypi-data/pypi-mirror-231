...
class IoK8sApiRbacV1beta1ClusterRole(BaseModel):
    """
    ...
    """
    aggregation_rule: Optional[IoK8sApiRbacV1beta1AggregationRule] = Field(None, alias="aggregationRule")
    ...
    rules: Optional[conlist(IoK8sApiRbacV1beta1PolicyRule)] = Field(None, description="Rules holds all the PolicyRules for this ClusterRole")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiRbacV1beta1ClusterRole:
        """Create an instance of IoK8sApiRbacV1beta1ClusterRole from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiRbacV1beta1ClusterRole:
        """Create an instance of IoK8sApiRbacV1beta1ClusterRole from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiRbacV1beta1ClusterRole.parse_obj(obj)

        _obj = IoK8sApiRbacV1beta1ClusterRole.parse_obj({
            "aggregation_rule": IoK8sApiRbacV1beta1AggregationRule.from_dict(obj.get("aggregationRule")) if obj.get("aggregationRule") is not None else None,
            ...
            "rules": [IoK8sApiRbacV1beta1PolicyRule.from_dict(_item) for _item in obj.get("rules")] if obj.get("rules") is not None else None
        })
        return _obj
