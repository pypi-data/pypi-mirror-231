...
class IoK8sApiCoreV1Sysctl(BaseModel):
    """
    Sysctl defines a kernel parameter to be set  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1Sysctl:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1Sysctl:
        """Create an instance of IoK8sApiCoreV1Sysctl from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1Sysctl.parse_obj(obj)

        _obj = IoK8sApiCoreV1Sysctl.parse_obj({
            "name": obj.get("name"),
            "value": obj.get("value")
        })
        return _obj
