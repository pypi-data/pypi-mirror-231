...
class IoK8sApiCoreV1HTTPHeader(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiCoreV1HTTPHeader:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiCoreV1HTTPHeader:
        """Create an instance of IoK8sApiCoreV1HTTPHeader from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiCoreV1HTTPHeader.parse_obj(obj)

        _obj = IoK8sApiCoreV1HTTPHeader.parse_obj({
            "name": obj.get("name"),
            "value": obj.get("value")
        })
        return _obj
