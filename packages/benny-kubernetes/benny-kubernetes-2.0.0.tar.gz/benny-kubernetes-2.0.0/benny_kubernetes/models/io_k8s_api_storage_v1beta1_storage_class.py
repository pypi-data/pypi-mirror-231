...
class IoK8sApiStorageV1beta1StorageClass(BaseModel):
    """
    ...
    allowed_topologies: Optional[conlist(IoK8sApiCoreV1TopologySelectorTerm)] = Field(None, alias="allowedTopologies", description="Restrict the node topologies where volumes can be dynamically provisioned. Each volume plugin defines its own supported topology specifications. An empty TopologySelectorTerm list means there is no topology restriction. This field is only honored by servers that enable the VolumeScheduling feature.")
    ...
    mount_options: Optional[conlist(StrictStr)] = Field(None, alias="mountOptions", description="Dynamically provisioned PersistentVolumes of this storage class are created with these mountOptions, e.g. [\"ro\", \"soft\"]. Not validated - mount of the PVs will simply fail if one is invalid.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiStorageV1beta1StorageClass:
        """Create an instance of IoK8sApiStorageV1beta1StorageClass from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiStorageV1beta1StorageClass:
        """Create an instance of IoK8sApiStorageV1beta1StorageClass from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiStorageV1beta1StorageClass.parse_obj(obj)

        _obj = IoK8sApiStorageV1beta1StorageClass.parse_obj({
            "allow_volume_expansion": obj.get("allowVolumeExpansion"),
            "allowed_topologies": [IoK8sApiCoreV1TopologySelectorTerm.from_dict(_item) for _item in obj.get("allowedTopologies")] if obj.get("allowedTopologies") is not None else None,
