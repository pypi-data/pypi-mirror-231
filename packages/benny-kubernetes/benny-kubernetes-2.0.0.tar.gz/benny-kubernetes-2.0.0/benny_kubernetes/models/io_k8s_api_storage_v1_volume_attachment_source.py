...
class IoK8sApiStorageV1VolumeAttachmentSource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IoK8sApiStorageV1VolumeAttachmentSource:
        """Create an instance of IoK8sApiStorageV1VolumeAttachmentSource from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IoK8sApiStorageV1VolumeAttachmentSource:
        """Create an instance of IoK8sApiStorageV1VolumeAttachmentSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IoK8sApiStorageV1VolumeAttachmentSource.parse_obj(obj)

        _obj = IoK8sApiStorageV1VolumeAttachmentSource.parse_obj({
