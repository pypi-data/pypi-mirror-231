...
import benny_kubernetes.models
from benny_kubernetes import rest
from benny_kubernetes.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(benny_kubernetes.models, klass)
