...
class AuthenticationV1Api:
    ...
    def create_authentication_v1_token_review(self, body : IoK8sApiAuthenticationV1TokenReview, dry_run : Annotated[Optional[StrictStr], Field(description="When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed")] = None, field_manager : Annotated[Optional[StrictStr], Field(description="fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.")] = None, pretty : Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None, **kwargs) -> IoK8sApiAuthenticationV1TokenReview:  # noqa: E501
        ...
        >>> thread = api.create_authentication_v1_token_review(body, dry_run, field_manager, pretty, async_req=True)
        >>> result = thread.get()

        :param body: (required)
        :type body: IoK8sApiAuthenticationV1TokenReview
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_authentication_v1_token_review_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_authentication_v1_token_review_with_http_info(body, dry_run, field_manager, pretty, **kwargs)  # noqa: E501

    @validate_arguments
    def create_authentication_v1_token_review_with_http_info(self, body : IoK8sApiAuthenticationV1TokenReview, dry_run : Annotated[Optional[StrictStr], Field(description="When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed")] = None, field_manager : Annotated[Optional[StrictStr], Field(description="fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.")] = None, pretty : Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """create_authentication_v1_token_review  # noqa: E501
        ...
        >>> thread = api.create_authentication_v1_token_review_with_http_info(body, dry_run, field_manager, pretty, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IoK8sApiAuthenticationV1TokenReview, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_authentication_v1_token_review" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_authentication_v1_api_resources(self, **kwargs) -> IoK8sApimachineryPkgApisMetaV1APIResourceList:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_authentication_v1_api_resources_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_authentication_v1_api_resources_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_authentication_v1_api_resources_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """get_authentication_v1_api_resources  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_authentication_v1_api_resources" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
