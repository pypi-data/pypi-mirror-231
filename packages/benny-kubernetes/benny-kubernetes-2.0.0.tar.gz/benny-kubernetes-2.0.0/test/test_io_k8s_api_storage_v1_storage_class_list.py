...
from benny_kubernetes.models.io_k8s_api_storage_v1_storage_class_list import IoK8sApiStorageV1StorageClassList  # noqa: E501
...
class TestIoK8sApiStorageV1StorageClassList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiStorageV1StorageClassList:
        """Test IoK8sApiStorageV1StorageClassList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiStorageV1StorageClassList`
        """
        model = IoK8sApiStorageV1StorageClassList()  # noqa: E501
        if include_optional:
            return IoK8sApiStorageV1StorageClassList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/storage/v1/storage_class.io.k8s.api.storage.v1.StorageClass(
