...
from benny_kubernetes.models.io_k8s_apimachinery_pkg_apis_meta_v1_watch_event import IoK8sApimachineryPkgApisMetaV1WatchEvent  # noqa: E501
...
class TestIoK8sApimachineryPkgApisMetaV1WatchEvent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApimachineryPkgApisMetaV1WatchEvent:
        ...
        """
        model = IoK8sApimachineryPkgApisMetaV1WatchEvent()  # noqa: E501
        if include_optional:
            return IoK8sApimachineryPkgApisMetaV1WatchEvent(
                object = benny_kubernetes.models.data.data(),
                type = ''
            )
        else:
            return IoK8sApimachineryPkgApisMetaV1WatchEvent(
