...
from benny_kubernetes.models.io_k8s_api_core_v1_env_from_source import IoK8sApiCoreV1EnvFromSource  # noqa: E501
...
class TestIoK8sApiCoreV1EnvFromSource(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1EnvFromSource:
        ...
        """
        model = IoK8sApiCoreV1EnvFromSource()  # noqa: E501
        if include_optional:
