...
from benny_kubernetes.models.io_k8s_api_core_v1_event_list import IoK8sApiCoreV1EventList  # noqa: E501
...
class TestIoK8sApiCoreV1EventList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1EventList:
        """Test IoK8sApiCoreV1EventList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1EventList`
        """
        model = IoK8sApiCoreV1EventList()  # noqa: E501
        if include_optional:
            return IoK8sApiCoreV1EventList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/core/v1/event.io.k8s.api.core.v1.Event(
                        action = '', 
                        api_version = '', 
                        count = 56, 
