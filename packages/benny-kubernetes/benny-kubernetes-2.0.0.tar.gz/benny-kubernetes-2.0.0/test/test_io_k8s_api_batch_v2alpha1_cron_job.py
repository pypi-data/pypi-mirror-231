...
from benny_kubernetes.models.io_k8s_api_batch_v2alpha1_cron_job import IoK8sApiBatchV2alpha1CronJob  # noqa: E501
...
class TestIoK8sApiBatchV2alpha1CronJob(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiBatchV2alpha1CronJob:
        """Test IoK8sApiBatchV2alpha1CronJob
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiBatchV2alpha1CronJob`
        """
        model = IoK8sApiBatchV2alpha1CronJob()  # noqa: E501
        if include_optional:
