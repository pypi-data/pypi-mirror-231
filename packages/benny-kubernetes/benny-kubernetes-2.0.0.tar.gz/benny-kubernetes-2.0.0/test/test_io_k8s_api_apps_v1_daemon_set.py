...
from benny_kubernetes.models.io_k8s_api_apps_v1_daemon_set import IoK8sApiAppsV1DaemonSet  # noqa: E501
...
class TestIoK8sApiAppsV1DaemonSet(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiAppsV1DaemonSet:
        """Test IoK8sApiAppsV1DaemonSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiAppsV1DaemonSet`
        """
        model = IoK8sApiAppsV1DaemonSet()  # noqa: E501
        if include_optional:
