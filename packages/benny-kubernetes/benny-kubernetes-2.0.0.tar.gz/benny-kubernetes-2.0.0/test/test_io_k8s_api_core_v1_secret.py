...
from benny_kubernetes.models.io_k8s_api_core_v1_secret import IoK8sApiCoreV1Secret  # noqa: E501
...
class TestIoK8sApiCoreV1Secret(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1Secret:
        """Test IoK8sApiCoreV1Secret
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1Secret`
        """
        model = IoK8sApiCoreV1Secret()  # noqa: E501
        if include_optional:
