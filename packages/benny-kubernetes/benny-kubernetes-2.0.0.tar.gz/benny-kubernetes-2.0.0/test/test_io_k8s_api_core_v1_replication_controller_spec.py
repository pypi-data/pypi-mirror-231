...
from benny_kubernetes.models.io_k8s_api_core_v1_replication_controller_spec import IoK8sApiCoreV1ReplicationControllerSpec  # noqa: E501
...
class TestIoK8sApiCoreV1ReplicationControllerSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1ReplicationControllerSpec:
        """Test IoK8sApiCoreV1ReplicationControllerSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1ReplicationControllerSpec`
        """
        model = IoK8sApiCoreV1ReplicationControllerSpec()  # noqa: E501
        if include_optional:
