...
from benny_kubernetes.models.io_k8s_api_apps_v1_deployment_spec import IoK8sApiAppsV1DeploymentSpec  # noqa: E501
...
class TestIoK8sApiAppsV1DeploymentSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiAppsV1DeploymentSpec:
        """Test IoK8sApiAppsV1DeploymentSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiAppsV1DeploymentSpec`
        """
        model = IoK8sApiAppsV1DeploymentSpec()  # noqa: E501
        if include_optional:
