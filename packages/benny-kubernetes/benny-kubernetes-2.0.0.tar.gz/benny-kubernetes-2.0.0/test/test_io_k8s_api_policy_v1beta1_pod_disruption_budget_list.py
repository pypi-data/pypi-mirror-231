...
from benny_kubernetes.models.io_k8s_api_policy_v1beta1_pod_disruption_budget_list import IoK8sApiPolicyV1beta1PodDisruptionBudgetList  # noqa: E501
...
class TestIoK8sApiPolicyV1beta1PodDisruptionBudgetList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiPolicyV1beta1PodDisruptionBudgetList:
        """Test IoK8sApiPolicyV1beta1PodDisruptionBudgetList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiPolicyV1beta1PodDisruptionBudgetList`
        """
        model = IoK8sApiPolicyV1beta1PodDisruptionBudgetList()  # noqa: E501
        if include_optional:
            return IoK8sApiPolicyV1beta1PodDisruptionBudgetList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/policy/v1beta1/pod_disruption_budget.io.k8s.api.policy.v1beta1.PodDisruptionBudget(
                        api_version = '', 
                        kind = '', 
