...
from benny_kubernetes.models.io_k8s_api_batch_v1_job import IoK8sApiBatchV1Job  # noqa: E501
...
class TestIoK8sApiBatchV1Job(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiBatchV1Job:
        """Test IoK8sApiBatchV1Job
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiBatchV1Job`
        """
        model = IoK8sApiBatchV1Job()  # noqa: E501
        if include_optional:
