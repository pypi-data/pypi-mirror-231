...
from benny_kubernetes.models.io_k8s_api_batch_v1beta1_cron_job_spec import IoK8sApiBatchV1beta1CronJobSpec  # noqa: E501
...
class TestIoK8sApiBatchV1beta1CronJobSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiBatchV1beta1CronJobSpec:
        """Test IoK8sApiBatchV1beta1CronJobSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiBatchV1beta1CronJobSpec`
        """
        model = IoK8sApiBatchV1beta1CronJobSpec()  # noqa: E501
        if include_optional:
