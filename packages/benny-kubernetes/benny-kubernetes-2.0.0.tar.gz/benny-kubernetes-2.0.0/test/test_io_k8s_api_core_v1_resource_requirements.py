...
from benny_kubernetes.models.io_k8s_api_core_v1_resource_requirements import IoK8sApiCoreV1ResourceRequirements  # noqa: E501
...
class TestIoK8sApiCoreV1ResourceRequirements(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1ResourceRequirements:
        ...
        """
        model = IoK8sApiCoreV1ResourceRequirements()  # noqa: E501
        if include_optional:
