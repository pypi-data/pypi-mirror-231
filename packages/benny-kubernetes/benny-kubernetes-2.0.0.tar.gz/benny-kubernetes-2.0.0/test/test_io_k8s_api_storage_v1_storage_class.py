...
from benny_kubernetes.models.io_k8s_api_storage_v1_storage_class import IoK8sApiStorageV1StorageClass  # noqa: E501
...
class TestIoK8sApiStorageV1StorageClass(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiStorageV1StorageClass:
        """Test IoK8sApiStorageV1StorageClass
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiStorageV1StorageClass`
        """
        model = IoK8sApiStorageV1StorageClass()  # noqa: E501
        if include_optional:
