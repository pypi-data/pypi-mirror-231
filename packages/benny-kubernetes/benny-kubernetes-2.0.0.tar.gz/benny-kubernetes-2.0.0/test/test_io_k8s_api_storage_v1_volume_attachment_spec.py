...
from benny_kubernetes.models.io_k8s_api_storage_v1_volume_attachment_spec import IoK8sApiStorageV1VolumeAttachmentSpec  # noqa: E501
...
class TestIoK8sApiStorageV1VolumeAttachmentSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiStorageV1VolumeAttachmentSpec:
        """Test IoK8sApiStorageV1VolumeAttachmentSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiStorageV1VolumeAttachmentSpec`
        """
        model = IoK8sApiStorageV1VolumeAttachmentSpec()  # noqa: E501
        if include_optional:
