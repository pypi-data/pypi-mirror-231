...
from benny_kubernetes.models.io_k8s_api_core_v1_binding import IoK8sApiCoreV1Binding  # noqa: E501
...
class TestIoK8sApiCoreV1Binding(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1Binding:
        """Test IoK8sApiCoreV1Binding
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1Binding`
        """
        model = IoK8sApiCoreV1Binding()  # noqa: E501
        if include_optional:
            return IoK8sApiCoreV1Binding(
                ...
                metadata = benny_kubernetes.models.io/k8s/apimachinery/pkg/apis/meta/v1/object_meta.io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta(
                    ...
                    self_link = '', 
                    uid = '', ),
                target = benny_kubernetes.models.io/k8s/api/core/v1/object_reference.io.k8s.api.core.v1.ObjectReference(
                    api_version = '', 
                    field_path = '', 
                    kind = '', 
                    name = '', 
