...
from benny_kubernetes.models.io_k8s_api_core_v1_node_list import IoK8sApiCoreV1NodeList  # noqa: E501
...
class TestIoK8sApiCoreV1NodeList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1NodeList:
        """Test IoK8sApiCoreV1NodeList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1NodeList`
        """
        model = IoK8sApiCoreV1NodeList()  # noqa: E501
        if include_optional:
            return IoK8sApiCoreV1NodeList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/core/v1/node.io.k8s.api.core.v1.Node(
                        api_version = '', 
                        kind = '', 
