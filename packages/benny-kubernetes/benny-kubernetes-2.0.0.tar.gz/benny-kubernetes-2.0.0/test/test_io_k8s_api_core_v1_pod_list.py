...
from benny_kubernetes.models.io_k8s_api_core_v1_pod_list import IoK8sApiCoreV1PodList  # noqa: E501
...
class TestIoK8sApiCoreV1PodList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1PodList:
        """Test IoK8sApiCoreV1PodList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1PodList`
        """
        model = IoK8sApiCoreV1PodList()  # noqa: E501
        if include_optional:
            return IoK8sApiCoreV1PodList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/core/v1/pod.io.k8s.api.core.v1.Pod(
                        api_version = '', 
                        kind = '', 
                        ...
                        status = benny_kubernetes.models.io/k8s/api/core/v1/pod_status.io.k8s.api.core.v1.PodStatus(
                            conditions = [
