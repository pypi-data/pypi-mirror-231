...
from benny_kubernetes.models.io_k8s_api_networking_v1_network_policy import IoK8sApiNetworkingV1NetworkPolicy  # noqa: E501
...
class TestIoK8sApiNetworkingV1NetworkPolicy(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiNetworkingV1NetworkPolicy:
        """Test IoK8sApiNetworkingV1NetworkPolicy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiNetworkingV1NetworkPolicy`
        """
        model = IoK8sApiNetworkingV1NetworkPolicy()  # noqa: E501
        if include_optional:
