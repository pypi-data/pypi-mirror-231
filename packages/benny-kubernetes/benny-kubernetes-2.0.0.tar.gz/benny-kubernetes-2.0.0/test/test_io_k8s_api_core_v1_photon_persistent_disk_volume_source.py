...
from benny_kubernetes.models.io_k8s_api_core_v1_photon_persistent_disk_volume_source import IoK8sApiCoreV1PhotonPersistentDiskVolumeSource  # noqa: E501
...
class TestIoK8sApiCoreV1PhotonPersistentDiskVolumeSource(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1PhotonPersistentDiskVolumeSource:
        ...
        """
        model = IoK8sApiCoreV1PhotonPersistentDiskVolumeSource()  # noqa: E501
        if include_optional:
