...
from benny_kubernetes.models.io_k8s_api_core_v1_pod_dns_config_option import IoK8sApiCoreV1PodDNSConfigOption  # noqa: E501
...
class TestIoK8sApiCoreV1PodDNSConfigOption(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1PodDNSConfigOption:
        ...
        """
        model = IoK8sApiCoreV1PodDNSConfigOption()  # noqa: E501
        if include_optional:
