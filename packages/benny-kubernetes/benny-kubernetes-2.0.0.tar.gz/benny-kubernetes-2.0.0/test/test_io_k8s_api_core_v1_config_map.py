...
from benny_kubernetes.models.io_k8s_api_core_v1_config_map import IoK8sApiCoreV1ConfigMap  # noqa: E501
...
class TestIoK8sApiCoreV1ConfigMap(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1ConfigMap:
        """Test IoK8sApiCoreV1ConfigMap
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1ConfigMap`
        """
        model = IoK8sApiCoreV1ConfigMap()  # noqa: E501
        if include_optional:
