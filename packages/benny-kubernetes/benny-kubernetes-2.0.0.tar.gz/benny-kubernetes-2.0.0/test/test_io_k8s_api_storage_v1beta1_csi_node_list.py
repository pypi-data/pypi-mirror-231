...
from benny_kubernetes.models.io_k8s_api_storage_v1beta1_csi_node_list import IoK8sApiStorageV1beta1CSINodeList  # noqa: E501
...
class TestIoK8sApiStorageV1beta1CSINodeList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiStorageV1beta1CSINodeList:
        """Test IoK8sApiStorageV1beta1CSINodeList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiStorageV1beta1CSINodeList`
        """
        model = IoK8sApiStorageV1beta1CSINodeList()  # noqa: E501
        if include_optional:
            return IoK8sApiStorageV1beta1CSINodeList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/storage/v1beta1/csi_node.io.k8s.api.storage.v1beta1.CSINode(
                        api_version = '', 
                        kind = '', 
                        metadata = benny_kubernetes.models.io/k8s/apimachinery/pkg/apis/meta/v1/object_meta.io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = benny_kubernetes.models.io/k8s/api/storage/v1beta1/csi_node_spec.io.k8s.api.storage.v1beta1.CSINodeSpec(
                            drivers = [
                                benny_kubernetes.models.io/k8s/api/storage/v1beta1/csi_node_driver.io.k8s.api.storage.v1beta1.CSINodeDriver(
