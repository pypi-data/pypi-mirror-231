...
from benny_kubernetes.models.io_k8s_api_rbac_v1alpha1_cluster_role_list import IoK8sApiRbacV1alpha1ClusterRoleList  # noqa: E501
...
class TestIoK8sApiRbacV1alpha1ClusterRoleList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiRbacV1alpha1ClusterRoleList:
        """Test IoK8sApiRbacV1alpha1ClusterRoleList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiRbacV1alpha1ClusterRoleList`
        """
        model = IoK8sApiRbacV1alpha1ClusterRoleList()  # noqa: E501
        if include_optional:
            return IoK8sApiRbacV1alpha1ClusterRoleList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/rbac/v1alpha1/cluster_role.io.k8s.api.rbac.v1alpha1.ClusterRole(
                        aggregation_rule = benny_kubernetes.models.io/k8s/api/rbac/v1alpha1/aggregation_rule.io.k8s.api.rbac.v1alpha1.AggregationRule(
