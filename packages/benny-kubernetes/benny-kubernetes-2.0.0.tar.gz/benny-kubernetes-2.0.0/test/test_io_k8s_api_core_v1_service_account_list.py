...
from benny_kubernetes.models.io_k8s_api_core_v1_service_account_list import IoK8sApiCoreV1ServiceAccountList  # noqa: E501
...
class TestIoK8sApiCoreV1ServiceAccountList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1ServiceAccountList:
        """Test IoK8sApiCoreV1ServiceAccountList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1ServiceAccountList`
        """
        model = IoK8sApiCoreV1ServiceAccountList()  # noqa: E501
        if include_optional:
            return IoK8sApiCoreV1ServiceAccountList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/core/v1/service_account.io.k8s.api.core.v1.ServiceAccount(
                        api_version = '', 
