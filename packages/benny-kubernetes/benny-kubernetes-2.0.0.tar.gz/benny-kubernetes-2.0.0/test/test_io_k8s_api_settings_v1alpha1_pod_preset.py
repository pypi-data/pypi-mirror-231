...
from benny_kubernetes.models.io_k8s_api_settings_v1alpha1_pod_preset import IoK8sApiSettingsV1alpha1PodPreset  # noqa: E501
...
class TestIoK8sApiSettingsV1alpha1PodPreset(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiSettingsV1alpha1PodPreset:
        """Test IoK8sApiSettingsV1alpha1PodPreset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiSettingsV1alpha1PodPreset`
        """
        model = IoK8sApiSettingsV1alpha1PodPreset()  # noqa: E501
        if include_optional:
