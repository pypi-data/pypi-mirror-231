...
from benny_kubernetes.models.io_k8s_api_core_v1_pod_template_list import IoK8sApiCoreV1PodTemplateList  # noqa: E501
...
class TestIoK8sApiCoreV1PodTemplateList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1PodTemplateList:
        """Test IoK8sApiCoreV1PodTemplateList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1PodTemplateList`
        """
        model = IoK8sApiCoreV1PodTemplateList()  # noqa: E501
        if include_optional:
            return IoK8sApiCoreV1PodTemplateList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/core/v1/pod_template.io.k8s.api.core.v1.PodTemplate(
                        api_version = '', 
                        kind = '', 
