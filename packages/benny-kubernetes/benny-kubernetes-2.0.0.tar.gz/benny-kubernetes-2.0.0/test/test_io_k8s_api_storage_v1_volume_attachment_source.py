...
from benny_kubernetes.models.io_k8s_api_storage_v1_volume_attachment_source import IoK8sApiStorageV1VolumeAttachmentSource  # noqa: E501
...
class TestIoK8sApiStorageV1VolumeAttachmentSource(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiStorageV1VolumeAttachmentSource:
        """Test IoK8sApiStorageV1VolumeAttachmentSource
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiStorageV1VolumeAttachmentSource`
        """
        model = IoK8sApiStorageV1VolumeAttachmentSource()  # noqa: E501
        if include_optional:
