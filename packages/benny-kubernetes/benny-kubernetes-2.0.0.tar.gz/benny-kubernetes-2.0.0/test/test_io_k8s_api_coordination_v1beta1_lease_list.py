...
from benny_kubernetes.models.io_k8s_api_coordination_v1beta1_lease_list import IoK8sApiCoordinationV1beta1LeaseList  # noqa: E501
...
class TestIoK8sApiCoordinationV1beta1LeaseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoordinationV1beta1LeaseList:
        """Test IoK8sApiCoordinationV1beta1LeaseList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoordinationV1beta1LeaseList`
        """
        model = IoK8sApiCoordinationV1beta1LeaseList()  # noqa: E501
        if include_optional:
            return IoK8sApiCoordinationV1beta1LeaseList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/coordination/v1beta1/lease.io.k8s.api.coordination.v1beta1.Lease(
                        api_version = '', 
                        kind = '', 
