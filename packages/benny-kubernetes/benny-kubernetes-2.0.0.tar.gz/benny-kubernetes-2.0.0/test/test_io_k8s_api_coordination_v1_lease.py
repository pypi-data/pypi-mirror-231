...
from benny_kubernetes.models.io_k8s_api_coordination_v1_lease import IoK8sApiCoordinationV1Lease  # noqa: E501
...
class TestIoK8sApiCoordinationV1Lease(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoordinationV1Lease:
        """Test IoK8sApiCoordinationV1Lease
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoordinationV1Lease`
        """
        model = IoK8sApiCoordinationV1Lease()  # noqa: E501
        if include_optional:
