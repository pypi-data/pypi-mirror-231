...
from benny_kubernetes.models.io_k8s_api_core_v1_config_map_key_selector import IoK8sApiCoreV1ConfigMapKeySelector  # noqa: E501
...
class TestIoK8sApiCoreV1ConfigMapKeySelector(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1ConfigMapKeySelector:
        ...
        """
        model = IoK8sApiCoreV1ConfigMapKeySelector()  # noqa: E501
        if include_optional:
