...
from benny_kubernetes.models.io_k8s_api_scheduling_v1_priority_class_list import IoK8sApiSchedulingV1PriorityClassList  # noqa: E501
...
class TestIoK8sApiSchedulingV1PriorityClassList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiSchedulingV1PriorityClassList:
        """Test IoK8sApiSchedulingV1PriorityClassList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiSchedulingV1PriorityClassList`
        """
        model = IoK8sApiSchedulingV1PriorityClassList()  # noqa: E501
        if include_optional:
            return IoK8sApiSchedulingV1PriorityClassList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/scheduling/v1/priority_class.io.k8s.api.scheduling.v1.PriorityClass(
                        api_version = '', 
                        description = '', 
                        global_default = True, 
                        kind = '', 
