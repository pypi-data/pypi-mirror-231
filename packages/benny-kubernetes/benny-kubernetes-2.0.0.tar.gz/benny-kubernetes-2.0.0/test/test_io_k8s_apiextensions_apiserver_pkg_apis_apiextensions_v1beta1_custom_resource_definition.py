...
from benny_kubernetes.models.io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1beta1_custom_resource_definition import IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition  # noqa: E501
...
class TestIoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition:
        """Test IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition`
        """
        model = IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition()  # noqa: E501
        if include_optional:
