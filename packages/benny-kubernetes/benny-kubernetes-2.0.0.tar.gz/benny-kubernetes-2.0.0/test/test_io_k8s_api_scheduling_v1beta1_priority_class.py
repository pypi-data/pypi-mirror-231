...
from benny_kubernetes.models.io_k8s_api_scheduling_v1beta1_priority_class import IoK8sApiSchedulingV1beta1PriorityClass  # noqa: E501
...
class TestIoK8sApiSchedulingV1beta1PriorityClass(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiSchedulingV1beta1PriorityClass:
        """Test IoK8sApiSchedulingV1beta1PriorityClass
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiSchedulingV1beta1PriorityClass`
        """
        model = IoK8sApiSchedulingV1beta1PriorityClass()  # noqa: E501
        if include_optional:
