...
from benny_kubernetes.models.io_k8s_api_autoscaling_v2beta1_metric_spec import IoK8sApiAutoscalingV2beta1MetricSpec  # noqa: E501
...
class TestIoK8sApiAutoscalingV2beta1MetricSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiAutoscalingV2beta1MetricSpec:
        """Test IoK8sApiAutoscalingV2beta1MetricSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiAutoscalingV2beta1MetricSpec`
        """
        model = IoK8sApiAutoscalingV2beta1MetricSpec()  # noqa: E501
        if include_optional:
