...
from benny_kubernetes.models.io_k8s_api_events_v1beta1_event import IoK8sApiEventsV1beta1Event  # noqa: E501
...
class TestIoK8sApiEventsV1beta1Event(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiEventsV1beta1Event:
        """Test IoK8sApiEventsV1beta1Event
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiEventsV1beta1Event`
        """
        model = IoK8sApiEventsV1beta1Event()  # noqa: E501
        if include_optional:
