...
from benny_kubernetes.models.io_k8s_api_core_v1_glusterfs_volume_source import IoK8sApiCoreV1GlusterfsVolumeSource  # noqa: E501
...
class TestIoK8sApiCoreV1GlusterfsVolumeSource(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1GlusterfsVolumeSource:
        ...
        """
        model = IoK8sApiCoreV1GlusterfsVolumeSource()  # noqa: E501
        if include_optional:
