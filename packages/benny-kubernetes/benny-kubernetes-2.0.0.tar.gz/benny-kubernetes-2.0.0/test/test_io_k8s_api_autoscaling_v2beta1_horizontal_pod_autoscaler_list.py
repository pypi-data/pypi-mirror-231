...
from benny_kubernetes.models.io_k8s_api_autoscaling_v2beta1_horizontal_pod_autoscaler_list import IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerList  # noqa: E501
...
class TestIoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerList:
        """Test IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerList`
        """
        model = IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerList()  # noqa: E501
        if include_optional:
            return IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/autoscaling/v2beta1/horizontal_pod_autoscaler.io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscaler(
                        api_version = '', 
                        kind = '', 
