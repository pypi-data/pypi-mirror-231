...
from benny_kubernetes.models.io_k8s_api_core_v1_se_linux_options import IoK8sApiCoreV1SELinuxOptions  # noqa: E501
...
class TestIoK8sApiCoreV1SELinuxOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1SELinuxOptions:
        ...
        """
        model = IoK8sApiCoreV1SELinuxOptions()  # noqa: E501
        if include_optional:
