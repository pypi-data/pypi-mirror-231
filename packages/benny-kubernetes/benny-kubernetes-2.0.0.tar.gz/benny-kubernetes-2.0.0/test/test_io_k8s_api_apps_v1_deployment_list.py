...
from benny_kubernetes.models.io_k8s_api_apps_v1_deployment_list import IoK8sApiAppsV1DeploymentList  # noqa: E501
...
class TestIoK8sApiAppsV1DeploymentList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiAppsV1DeploymentList:
        """Test IoK8sApiAppsV1DeploymentList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiAppsV1DeploymentList`
        """
        model = IoK8sApiAppsV1DeploymentList()  # noqa: E501
        if include_optional:
            return IoK8sApiAppsV1DeploymentList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/apps/v1/deployment.io.k8s.api.apps.v1.Deployment(
                        api_version = '', 
                        kind = '', 
                        metadata = benny_kubernetes.models.io/k8s/apimachinery/pkg/apis/meta/v1/object_meta.io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = benny_kubernetes.models.io/k8s/api/apps/v1/deployment_spec.io.k8s.api.apps.v1.DeploymentSpec(
                            ...
                            strategy = benny_kubernetes.models.io/k8s/api/apps/v1/deployment_strategy.io.k8s.api.apps.v1.DeploymentStrategy(
                        ...
                        status = benny_kubernetes.models.io/k8s/api/apps/v1/deployment_status.io.k8s.api.apps.v1.DeploymentStatus(
