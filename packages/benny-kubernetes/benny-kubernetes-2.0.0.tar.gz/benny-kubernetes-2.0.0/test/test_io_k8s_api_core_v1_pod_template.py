...
from benny_kubernetes.models.io_k8s_api_core_v1_pod_template import IoK8sApiCoreV1PodTemplate  # noqa: E501
...
class TestIoK8sApiCoreV1PodTemplate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1PodTemplate:
        """Test IoK8sApiCoreV1PodTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1PodTemplate`
        """
        model = IoK8sApiCoreV1PodTemplate()  # noqa: E501
        if include_optional:
