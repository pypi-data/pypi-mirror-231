...
from benny_kubernetes.models.io_k8s_api_apps_v1_deployment import IoK8sApiAppsV1Deployment  # noqa: E501
...
class TestIoK8sApiAppsV1Deployment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiAppsV1Deployment:
        """Test IoK8sApiAppsV1Deployment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiAppsV1Deployment`
        """
        model = IoK8sApiAppsV1Deployment()  # noqa: E501
        if include_optional:
