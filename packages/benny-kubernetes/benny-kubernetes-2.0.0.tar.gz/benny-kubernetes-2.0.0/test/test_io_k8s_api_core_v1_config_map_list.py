...
from benny_kubernetes.models.io_k8s_api_core_v1_config_map_list import IoK8sApiCoreV1ConfigMapList  # noqa: E501
...
class TestIoK8sApiCoreV1ConfigMapList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoreV1ConfigMapList:
        """Test IoK8sApiCoreV1ConfigMapList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoreV1ConfigMapList`
        """
        model = IoK8sApiCoreV1ConfigMapList()  # noqa: E501
        if include_optional:
            return IoK8sApiCoreV1ConfigMapList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/core/v1/config_map.io.k8s.api.core.v1.ConfigMap(
                        api_version = '', 
                        binary_data = {
                            'key' : 'YQ=='
                            }, 
