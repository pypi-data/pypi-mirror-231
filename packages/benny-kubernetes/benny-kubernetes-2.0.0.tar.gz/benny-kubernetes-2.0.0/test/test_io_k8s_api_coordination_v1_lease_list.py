...
from benny_kubernetes.models.io_k8s_api_coordination_v1_lease_list import IoK8sApiCoordinationV1LeaseList  # noqa: E501
...
class TestIoK8sApiCoordinationV1LeaseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApiCoordinationV1LeaseList:
        """Test IoK8sApiCoordinationV1LeaseList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApiCoordinationV1LeaseList`
        """
        model = IoK8sApiCoordinationV1LeaseList()  # noqa: E501
        if include_optional:
            return IoK8sApiCoordinationV1LeaseList(
                api_version = '',
                items = [
                    benny_kubernetes.models.io/k8s/api/coordination/v1/lease.io.k8s.api.coordination.v1.Lease(
                        api_version = '', 
                        kind = '', 
                        metadata = benny_kubernetes.models.io/k8s/apimachinery/pkg/apis/meta/v1/object_meta.io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = benny_kubernetes.models.io/k8s/api/coordination/v1/lease_spec.io.k8s.api.coordination.v1.LeaseSpec(
