...
class TestLeagueNavigator(unittest.TestCase):
    ...
    def test_getNumberOfGamesPlayed_countLeagueMedianGamesAsTwoGames_countsLeagueMedianGamesAsTwoGames(
        ...
        response = LeagueNavigator.getNumberOfGamesPlayed(
            league, allTimeFilters, countLeagueMedianGamesAsTwoGames=True
        )
    ...
    def test_getNumberOfGamesPlayed_countMultiWeekMatchupsAsOneGameIsTrue(self):
        ...
        response = LeagueNavigator.getNumberOfGamesPlayed(
            league, allTimeFilters, countMultiWeekMatchupsAsOneGame=True
        )
