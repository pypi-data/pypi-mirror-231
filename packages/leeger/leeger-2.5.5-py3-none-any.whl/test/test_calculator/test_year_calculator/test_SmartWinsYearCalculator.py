...
class TestSmartWinsYearCalculator(unittest.TestCase):
    ...
    def test_getOpponentSmartWinsPerGame_multiWeekMatchups(self):
        ...
        self.assertEqual(Deci("0.5555555555555555555555555556"), response[teams[0].id])
        self.assertEqual(Deci("0"), response[teams[1].id])
        self.assertEqual(Deci("0.5555555555555555555555555555"), response[teams[2].id])
        self.assertEqual(Deci("0.1666666666666666666666666667"), response[teams[3].id])
        self.assertEqual(Deci("0.9444444444444444444444444445"), response[teams[4].id])
        self.assertEqual(Deci("0.5555555555555555555555555555"), response[teams[5].id])
