...
class TestSleeperLeagueLoader(unittest.TestCase):
    ...
    def test_load_league_happyPath_playoffRoundType_twoWeekChampionshipRound(
        ...
        mockSleeperMatchups2022_5 = [
            self.__generateMockSleeperMatchup(matchupId=20220501, rosterId=202201, points=100),
            self.__generateMockSleeperMatchup(matchupId=20220501, rosterId=202202, points=99),
        ]
    ...
    def test_load_league_happyPath_playoffRoundType_twoWeeksPerRound(
        ...
        # playoffs 2
        mockSleeperMatchups2022_4 = [
            self.__generateMockSleeperMatchup(matchupId=20220401, rosterId=202202, points=100),
            self.__generateMockSleeperMatchup(matchupId=20220401, rosterId=202203, points=90.5),
        ]
        ...
        mockSleeperMatchups2022_6 = [
            self.__generateMockSleeperMatchup(matchupId=20220601, rosterId=202201, points=100),
            self.__generateMockSleeperMatchup(matchupId=20220601, rosterId=202202, points=99),
        ]
