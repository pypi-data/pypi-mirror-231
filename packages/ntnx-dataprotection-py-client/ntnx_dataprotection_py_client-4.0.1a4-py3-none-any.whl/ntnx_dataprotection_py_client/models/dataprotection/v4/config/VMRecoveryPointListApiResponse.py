...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.config.VMRecoveryPointListApiResponsedata import VMRecoveryPointListApiResponsedata  # noqa: F401,E501
...
class VMRecoveryPointListApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdataprotection.v4.config.VMRecoveryPointListApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.VMRecoveryPointListApiResponse'

    def _initialize_fq_object_type(self):
        return 'dataprotection.v4.r0.a4.config.VMRecoveryPointListApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VMRecoveryPointListApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VMRecoveryPointListApiResponse):
            return False
