...
class VolumeGroup(object):
    ...
    :param name: (:attr:`name`) The name of the volume group that is captured as part of this Recovery point.
    :type name: 
    ...
    def __init__(self, volume_group_ext_id=None, name=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.VolumeGroup'

    def _initialize_fq_object_type(self):
        return 'dataprotection.v4.r0.a4.config.VolumeGroup'
