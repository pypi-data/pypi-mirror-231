...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.config.VMRecoveryPointApiResponsedata import VMRecoveryPointApiResponsedata  # noqa: F401,E501
...
class VMRecoveryPointApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdataprotection.v4.config.VMRecoveryPointApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.VMRecoveryPointApiResponse'

    def _initialize_fq_object_type(self):
        return 'dataprotection.v4.r0.a4.config.VMRecoveryPointApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VMRecoveryPointApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VMRecoveryPointApiResponse):
            return False
