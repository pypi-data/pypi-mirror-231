...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.config.VolumeGroupRecoveryPointListApiResponsedata import VolumeGroupRecoveryPointListApiResponsedata  # noqa: F401,E501
...
class VolumeGroupRecoveryPointListApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdataprotection.v4.config.VolumeGroupRecoveryPointListApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.VolumeGroupRecoveryPointListApiResponse'

    def _initialize_fq_object_type(self):
        return 'dataprotection.v4.r0.a4.config.VolumeGroupRecoveryPointListApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.VolumeGroupRecoveryPoint` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VolumeGroupRecoveryPointListApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VolumeGroupRecoveryPointListApiResponse):
            return False
