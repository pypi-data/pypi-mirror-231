...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.config.VolumeGroupRecoveryPointApiResponsedata import VolumeGroupRecoveryPointApiResponsedata  # noqa: F401,E501
...
class VolumeGroupRecoveryPointApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdataprotection.v4.config.VolumeGroupRecoveryPointApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.VolumeGroupRecoveryPointApiResponse'

    def _initialize_fq_object_type(self):
        return 'dataprotection.v4.r0.a4.config.VolumeGroupRecoveryPointApiResponse'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VolumeGroupRecoveryPointApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VolumeGroupRecoveryPointApiResponse):
            return False
