...
from ntnx_dataprotection_py_client.models.OneOfdataprotection.v4.config.WitnessApiResponsedata import WitnessApiResponsedata  # noqa: F401,E501
...
class WitnessApiResponse(object):
    ...
    swagger_types = {
        ...
        'data': 'OneOfdataprotection.v4.config.WitnessApiResponsedata',
    ...
    def _initialize_object_type(self):
        return 'dataprotection.v4.config.WitnessApiResponse'

    def _initialize_fq_object_type(self):
        return 'dataprotection.v4.r0.a4.config.WitnessApiResponse'
    ...
    def data(self):
        ...
        :type:
                :class:`~ntnx_dataprotection_py_client.models.dataprotection.v4.config.Witness` | 
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(WitnessApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WitnessApiResponse):
            return False
