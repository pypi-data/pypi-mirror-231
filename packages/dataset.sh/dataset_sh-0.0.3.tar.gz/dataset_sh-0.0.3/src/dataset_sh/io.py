...
from .utils.misc import readfile_or_default, is_name_legit, parse_dataset_name, read_jsonl
...
def import_file(name, file, store_base=None):
...
def import_url(name, url, store_base=None):
    manager = DatasetStorageManager(store_base=store_base)
    store, dataset = parse_dataset_name(name)
