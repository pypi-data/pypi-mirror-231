...
from keras_core.src.backend.common.global_state import get_global_attribute
from keras_core.src.backend.common.global_state import set_global_attribute
