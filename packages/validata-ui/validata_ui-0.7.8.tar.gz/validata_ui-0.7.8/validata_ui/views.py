    ...
    if request.method == "GET":
        ...
        # Process URL
            ...
            try:
                ...
                # Validating data ignoring header case by default
                return validate(
                    schema_instance, URLValidataResource(url), header_case=False
                )
        ...
        if input_param == "file":
            ...
            return validate(
                schema_instance,
                FileContentValidataResource(f.filename, bytes_data(f)),
                header_case=False,
            )
