...
def build_spark_operation_spec(operation_alias, spark_discovery, config,
    ...
    worker_command = _launcher_command("Worker", additional_commands=[_unpack_command('livy.tgz', spark_home)],
                                       xmx="2g", extra_java_opts=extra_java_opts, launcher_opts=worker_launcher_opts)
    ...
    livy_environment = {
        ...
        "SPARK_SUBMIT_OPTS": extra_java_opts[0]
    }
    ...
    worker_file_paths.append("//home/spark/livy/{}".format(livy_tgz))
