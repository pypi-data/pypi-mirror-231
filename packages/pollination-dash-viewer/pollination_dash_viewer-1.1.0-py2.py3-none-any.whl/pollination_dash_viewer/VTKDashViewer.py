...
class VTKDashViewer(Component):
    """A VTKDashViewer component.
Viewer component
...
- actionStack (list of boolean | number | string | dict | lists; optional):
    Action stack for external controlled values  E.g.  ```  [{ 'type':
    'dash-screenshot' }]  ```.

- clear (boolean; default True):
    A boolen to clear the current contents from the viewer when
    loading the new content. Default is set to True.

- content (boolean | number | string | dict | list; optional):
    A VTKJS file content. Base64 string or bytes in python.

- screenShotName (string; optional):
    An optional string that will be the default name for a screenshot.

- sider (boolean; default True):
    A boolean to show or hide the sidebar in the viewer. Default is
    set to True.

- style (dict; optional):
    A dictionary to set the style for the viewer. The key and values
    can be        any CSS style attribute. Default {\"border\": \"1px
    solid #d0d7de\", \"borderRadius\": \"2px\"}.
    ...
    - msWrapFlow (a value equal to: 'clear', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'end', 'start', 'both', 'maximum'; optional):
...
- subscribe (boolean; default False):
    A boolean to subscribe or unsubscribe the VTKJS camera and
    renderer content.

- toolbar (boolean; default True):
    A boolean to show or hide the toolbar in the viewer. Default is
    set to True."""
    _children_props = []
    _base_nodes = ['children']
    _namespace = 'pollination_dash_viewer'
    _type = 'VTKDashViewer'
    @_explicitize_args
    def __init__(self, subscribe=Component.UNDEFINED, screenShotName=Component.UNDEFINED, actionStack=Component.UNDEFINED, content=Component.UNDEFINED, toolbar=Component.UNDEFINED, sider=Component.UNDEFINED, clear=Component.UNDEFINED, style=Component.UNDEFINED, id=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'actionStack', 'clear', 'content', 'screenShotName', 'sider', 'style', 'subscribe', 'toolbar']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'actionStack', 'clear', 'content', 'screenShotName', 'sider', 'style', 'subscribe', 'toolbar']
        ...
        if isinstance(args['content'], bytes):
            args['content'] = base64.b64encode(args['content']).decode('ascii')

        super(VTKDashViewer, self).__init__(**args)
