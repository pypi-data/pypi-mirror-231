...
import didi-client.featurepalette.errno.ttypes
import didi-client.featurepalette.response.ttypes
import didi-client.featurepalette.trace.ttypes
...
class FeatureRsp(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRUCT, 'header', (didi-client.featurepalette.response.ttypes.ResponseHeader, didi-client.featurepalette.response.ttypes.ResponseHeader.thrift_spec), None, ),  # 1
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.header = didi-client.featurepalette.response.ttypes.ResponseHeader()
