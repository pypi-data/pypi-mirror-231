...
def upload_and_import_videos(
    ...
    return target_ids, shared_attributes, new_section_name
...
def run_b3_upload(
    *,
    ...
    if video_list:
        ...
        target_ids, shared_attrs, new_section_name = upload_and_import_videos(
    ...
    if wait_for_thumbs(tator_api, media_type.project, target_ids):
