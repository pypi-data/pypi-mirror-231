...
from funfile.compress.utils import tqdm_bar
...
class ProgressFileIO(io.FileIO):
    def __init__(self, path, *args, **kwargs):
        ...
        res = tqdm_bar(path=path, prefix="解压")
...
class TarFile(tarfile.TarFile):
    ...
    def add(self, name, arcname=None, _progress=None, recursive=True, filter=None, *args, **kwargs):
        self._progress = _progress or tqdm_bar(name)
