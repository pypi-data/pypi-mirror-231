...
from ..utils.permission import AnonymousUserPermission, CustomPermission
from ..utils.serializers import CustomModelSerializer
from ..utils.utility_method import build_tree
from ..utils.viewset import CustomModelViewSet
from ..utils.filters import LazyLoadFilter
...
class DeptViewSet(CustomModelViewSet):
    ...
    def all_dept(self, request, *args, **kwargs):
        ...
        if request.query_params.get('is_tree', ""):
            data = build_tree(list(data), "parent", "id")
