...
"""
    ...
    def __init__(self, data=None):
        ...
        Parameters:
            data (str|dict): The core instruction that guides the language model's response.
        ...
        if isinstance(data, str):
            ...
            raise TypeError("Prompt data must be either string or dictionary.")
