...
def write_tag_file(self,database_name:str, schema_name:str, d: dict):
    ...
    data['ALLOWED_VALUES']=self.choose_value_list(data, 'ALLOWED_VALUES', d,'ALLOWED_VALUES', var.EMPTY_STRING)
    data['MASKING_POLICIES']=self.choose_value_list(data, 'MASKING_POLICIES', d,'MASKING_POLICIES', var.EMPTY_STRING)
