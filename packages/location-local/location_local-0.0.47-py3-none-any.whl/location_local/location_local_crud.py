...
class LocationLocal(GenericCRUD):
    ...
    def get_location_table_ids(self, neighborhood_name: str, county_name: str, region_name: str, state_name: str,
        ...
        neighborhood_ids, county_id, region_id, state_id, country_id = None, None, None, None, None
        neighborhood_ids = Neighborhood.get_neighborhood_ids_by_neighborhood_name(neighborhood_name)
        county_id = County.get_county_id_by_county_name(county_name)
        ...
        logger.end(object={"neighborhood_ids": neighborhood_ids, "county_id": county_id, "region_id": region_id,
                           "state_id": state_id, "country_id": country_id})
        return (neighborhood_ids, county_id, region_id, state_id, country_id)
    ...
    def insert(
        ...
        insert_sql = "INSERT INTO location_table (coordinate, address_local_language, address_english," \
    ...
    def update(self, location_id: int, data: Dict[str, any], lang_code: LangCode = "en", is_approved: bool = True):
        ...
        update_location_table_sql = "UPDATE location_table SET coordinate = POINT(%s, %s), address_local_language = %s, " \
    ...
    def read(self, location_id: int) -> tuple([Dict[str, float], str, str, str, str, str, str, str, str, str]):
        ...
        select_sql = '''SELECT ST_X(l.coordinate), ST_Y(l.coordinate), l.address_local_language, l.address_english, n.title, c.title, 
        ...
        self.cursor.execute(select_sql, (location_id,))
        result = None
        coordinate = None
    ...
    def delete(self, location_id: int):
        ...
        update_location_table_sql = "UPDATE location_table SET end_timestamp = NOW() WHERE location_id = %s"
        self.cursor.execute(update_location_table_sql, (location_id,))
    ...
    def _check_details_and_insert_if_not_exist(
        ...
        if ids is None:
            return None
        (neighborhood_ids, county_id, region_id, state_id, country_id) = ids
