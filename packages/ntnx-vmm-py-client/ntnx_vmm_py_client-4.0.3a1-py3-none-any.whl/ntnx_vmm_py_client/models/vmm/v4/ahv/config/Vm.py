...
from ntnx_vmm_py_client.models.vmm.v4.ahv.config.RecoveryPlanState import RecoveryPlanState  # noqa: F401,E501
...
class Vm(ExternalizableAbstractModel):
    ...
    :type num_sockets: 
    :param num_cores_per_socket: (:attr:`num_cores_per_socket`) Number of cores per socket. (**Default** 1)
    :type num_cores_per_socket: 
    :param num_threads_per_core: (:attr:`num_threads_per_core`) Number of threads per core. (**Default** 1)
    ...
    :param generation_uuid: (:attr:`generation_uuid`) Generation UUID of the VM. It should be of type UUID.
    :type generation_uuid: 
    :param bios_uuid: (:attr:`bios_uuid`) BIOS UUID of the VM. It should be of type UUID.
    :type bios_uuid: 
    ...
    :param is_branding_enabled: (:attr:`is_branding_enabled`) Indicates whether to remove AHV branding from VM firmware tables or not. (**Default** True)
    ...
    :type boot_config: 
    :param is_vga_console_enabled: (:attr:`is_vga_console_enabled`) Indicates whether the VGA console should be disabled or not. (**Default** True)
    ...
    :param recovery_plan_states: (:attr:`recovery_plan_states`) Status of the recovery plans associated with the VM.
    :type recovery_plan_states: 
    ...
    def recovery_plan_states(self):
        ...
        :type:
             list[ :class:`~ntnx_vmm_py_client.models.vmm.v4.ahv.config.RecoveryPlanState` ]
        """  # noqa: E501
