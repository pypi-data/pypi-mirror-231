...
class PolicyComplianceState(object):
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.ahv.config.PolicyComplianceState'

    def _initialize_fq_object_type(self):
        return 'vmm.v4.r0.a1.ahv.config.PolicyComplianceState'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PolicyComplianceState, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PolicyComplianceState):
            return False
