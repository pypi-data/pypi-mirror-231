...
class ADSFVolumeGroupReference(object):
    ...
    :param volume_group_ext_id: (:attr:`volume_group_ext_id`) Globally unique identifier of an ADSF volume group. It should be of type UUID.
    ...
    def _initialize_fq_object_type(self):
        return 'vmm.v4.r0.a1.ahv.config.ADSFVolumeGroupReference'
