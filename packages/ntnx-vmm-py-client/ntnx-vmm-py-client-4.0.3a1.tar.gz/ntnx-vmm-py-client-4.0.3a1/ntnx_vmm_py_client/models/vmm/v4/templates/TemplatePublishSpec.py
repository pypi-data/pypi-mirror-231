...
class TemplatePublishSpec(object):
    ...
    :param active_version_number: (:attr:`active_version_number`) Template's active version which will be used as default for a VM deployment or a guest update
    :type active_version_number: required
    ...
    def __init__(self, active_version_number=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'vmm.v4.templates.TemplatePublishSpec'

    def _initialize_fq_object_type(self):
        return 'vmm.v4.r0.a1.templates.TemplatePublishSpec'
    ...
    def active_version_number(self, active_version_number):
        if active_version_number is None:
            raise ValueError("Invalid value for `active_version_number`, must not be `None`")  # noqa: E501
