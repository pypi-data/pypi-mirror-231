...
from azureml.rag.dataindex.data_index import index_data as index_data_func
...
def index_data(
    ...
    **kwargs,
    ...
    experiment_name = kwargs.get("experiment_name", None) or default_name
    ...
    index_job = index_data_func(
        description=data_index.description or kwargs.get("description", None) or default_name,
        display_name=kwargs.get("display_name", None) or default_name,
    ...
    index_pipeline.properties["azureml.mlIndexAssetSource"] = kwargs.get("mlindex_asset_source", "Data Asset")
