...
from src.openapi_client.model.send_events_request_schema import SendEventsRequestSchema
...
class WeftClient:
    ...
    def login(self, access_key_id: str):
        ...
        refresh_token_input = LoginRequestSchema(refresh_token=access_key_id)
