...
class OverCallersBid(Hand):
    ...
    def _overcall_suit_at_two_level(self):
        ...
        if self._has_strong_seven_card_suit():
            ...
            bid = Double('2034')
              ...
              self.suit_holding[self.opener_bid_one.denomination] == 0):
            bid = Double('2035')
    ...
    def _overcall_suit_after_weak_two(self):
        ...
        elif self.suit_length(self.opener_bid_one.denomination) <=2 and self.hcp >= 12:
            bid = Double('2067')
        else:
            bid = Pass('2047')
        self.tracer(__name__, inspection(), bid, self.trace)
    ...
    def _can_make_weak_balanced_overcall(self):
        ...
        result = (self.hcp >= 12 and
                ...
                #    (self.opener_bid_one.level == 2 and self.opener_bid_one.denomination != self.club_suit)
