...
+ time_shift: 1                 # optional time offset e.g. set 1 for BST when local time is GMT
...
0.5.7:<br>
Added time_shift=1 to correct for BST local time when running GMT in the cloud
