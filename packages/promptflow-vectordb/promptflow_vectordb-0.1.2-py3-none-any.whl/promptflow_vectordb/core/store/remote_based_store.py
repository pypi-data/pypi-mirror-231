...
from ..contracts import StoreCoreConfig, FileSizeExceededException, SearchResultEntity
...
class RemoteBasedStore(LocalBasedStore):
    ...
    def merge_from(self, other_store: 'RemoteBasedStore'):
        raise NotImplementedError('merge is not supported for remote based store')
