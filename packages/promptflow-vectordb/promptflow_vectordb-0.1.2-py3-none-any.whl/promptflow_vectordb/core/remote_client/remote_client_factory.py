    ...
    def get_remote_client(
        ...
        if config.storage_type == StorageType.BLOBSTORAGE:
            ...
            if file_relative_paths is None:
                raise ValueError("file_relative_paths must be provided for HttpUrl storage type.")
            ...
            raise NotImplementedError(f"This remote client {config.storage_type} has not been implemented yet.")
