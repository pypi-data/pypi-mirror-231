...
from ..contracts import LoggingConfig, StoreFailureType, StoreCoreEventCustomDimensions, TelemetryEventStatus
...
class StoreLogger(logging.Logger):
    ...
    def telemetry_event_failed(
        self,
        event_name: str,
        failure_type: StoreFailureType = StoreFailureType.UNKNOWN,
        custom_dimensions: dict = None
    ):
        failure_context = {}
