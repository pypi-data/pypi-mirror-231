...
from ....core.contracts import FileSizeExceededException, RemoteResourceAuthenticationException
...
from ...contracts import ErrorMessage, LoadRequestObj, ResultMessage, SearchRequestObj
...
def load():
    try:
        ...
        return ErrorMessage.STORE_NOT_FOUND, HTTPStatus.NOT_FOUND
    except FileSizeExceededException:
        return ErrorMessage.FILE_SIZE_EXCEEDED, HTTPStatus.REQUEST_ENTITY_TOO_LARGE
    except ValueError:
        return ErrorMessage.INVALID_VECTOR_SEARCH_INPUT, HTTPStatus.BAD_REQUEST
    except RemoteResourceAuthenticationException as e:
        return ErrorMessage.AUTHENTICATION_FAILED, e.http_status_code
    except Exception:
        return ErrorMessage.INTERNAL_SERVER_ERROR, HTTPStatus.INTERNAL_SERVER_ERROR
