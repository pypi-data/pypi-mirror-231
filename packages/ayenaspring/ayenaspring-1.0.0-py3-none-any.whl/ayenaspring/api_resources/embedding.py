...
from ayenaspring import util
from ayenaspring.api_resources.abstract.engine_api_resource import EngineAPIResource
from ayenaspring.datalib.numpy_helper import assert_has_numpy
from ayenaspring.datalib.numpy_helper import numpy as np
from ayenaspring.error import TryAgain
...
class Embedding(EngineAPIResource):
    ...
    def create(cls, *args, **kwargs):
        ...
        See https://platform.ayenaspring.com/docs/api-reference/embeddings for a list
        of valid parameters.
        """
        start = time.time()
