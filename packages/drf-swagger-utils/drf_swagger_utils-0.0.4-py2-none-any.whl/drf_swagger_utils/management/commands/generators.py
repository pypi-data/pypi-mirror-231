...
from drf_swagger_utils.server.templates.serializer import SERIALIZER
from drf_swagger_utils.server.templates.apiview import API_URL, API_VIEW
from drf_swagger_utils.server.templates.viewset import VIEW_SET_URL, VIEW_SET_VIEW
from drf_swagger_utils.server.templates.function import FUNCTION_URL, FUNCTION_VIEW
from drf_swagger_utils.server.templates.modelviewset import MODEL_URL, MODEL_VIEW
