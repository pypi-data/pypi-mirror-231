...
import { w as writable } from './index-9e11d9ab.js';
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file, 64, 4, 1393);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file, 60, 4, 1324);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file, 57, 1, 1224);
			...
			add_location(div1, file, 56, 0, 1144);
		},
...
//# sourceMappingURL=StaticTabs-97d005fe.js.map
