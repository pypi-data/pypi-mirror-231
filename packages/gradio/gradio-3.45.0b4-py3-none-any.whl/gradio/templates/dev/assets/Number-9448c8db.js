import { SvelteComponentDev, init, safe_not_equal, dispatch_dev, validate_slots, createEventDispatcher, afterUpdate, tick, element, create_component, space, attr_dev, add_location, toggle_class, insert_dev, mount_component, append_dev, set_input_value, listen_dev, prop_dev, to_number, transition_in, transition_out, detach_dev, destroy_component, run_all, bubble, text, set_data_dev } from '../../../node/dev/svelte-internal.js';
import './Button-f00848ff.js';
import { B as BlockTitle } from './BlockTitle-a0780c9b.js';
import './index-9e11d9ab.js';

const Number_svelte_svelte_type_style_lang = '';

/* home/runner/work/gradio/gradio/js/number/shared/Number.svelte generated by Svelte v4.0.0 */
const file = "home/runner/work/gradio/gradio/js/number/shared/Number.svelte";
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(input, "class", "s-zc9VDSD7RSOb");
			add_location(input, file, 47, 1, 966);
			attr_dev(label_1, "class", "block s-zc9VDSD7RSOb");
...
export { Number as N };
//# sourceMappingURL=Number-9448c8db.js.map
