import { SvelteComponentDev, init, safe_not_equal, dispatch_dev, validate_slots, empty, insert_dev, noop, detach_dev, element, attr_dev, set_style, add_location, listen_dev, prop_dev, run_all, onMount, createEventDispatcher, globals, group_outros, transition_out, check_outros, transition_in, ensure_array_like_dev, space, destroy_each, append_dev, binding_callbacks, bind, text, toggle_class, set_data_dev, create_component, mount_component, add_flush_callback, destroy_component, assign, get_spread_update, get_spread_object } from '../../../node/dev/svelte-internal.js';
import { g as get_next_color } from './color-284a869d.js';
import { B as Block } from './Button-f00848ff.js';
import { c as correct_color_map, m as merge_elements, T as TextHighlight } from './utils-75dde8e7.js';
import { B as BlockLabel } from './BlockLabel-f3c9554b.js';
import { E as Empty } from './Empty-0ffe104b.js';
import { S as Static } from './index-9e11d9ab.js';

const LabelInput_svelte_svelte_type_style_lang = '';

/* home/runner/work/gradio/gradio/js/highlightedtext/interactive/LabelInput.svelte generated by Svelte v4.0.0 */

const file$1 = "home/runner/work/gradio/gradio/js/highlightedtext/interactive/LabelInput.svelte";
...
function create_else_block$2(ctx) {
	...
	const block = {
		c: function create() {
			input = element("input");
			attr_dev(input, "class", "label-input s-8RAhjZnAhpHE");
...
/* home/runner/work/gradio/gradio/js/highlightedtext/interactive/Highlightedtext.svelte generated by Svelte v4.0.0 */

const { Object: Object_1$1 } = globals;
const file = "home/runner/work/gradio/gradio/js/highlightedtext/interactive/Highlightedtext.svelte";
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "textfield s-TqfVXVzNPjpA");
...
function create_if_block_10(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "color-legend s-TqfVXVzNPjpA");
...
function create_if_block_8(ctx) {
	...
	const block = {
		c: function create() {
			span = element("span");
			span.textContent = "×";
			attr_dev(span, "class", "label-clear-button s-TqfVXVzNPjpA");
...
function create_each_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			t3 = space();
			attr_dev(span0, "class", "text s-TqfVXVzNPjpA");
			add_location(span0, file, 333, 6, 9260);
			attr_dev(span1, "class", "textspan score-text s-TqfVXVzNPjpA");
			...
			attr_dev(span2, "class", "score-text-container s-TqfVXVzNPjpA");
...
function create_if_block_6(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			if (if_block) if_block.c();
			attr_dev(div, "class", "class_or_confidence-legend s-TqfVXVzNPjpA");
...
function create_each_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "class_or_confidence-label s-TqfVXVzNPjpA");
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(span1, "role", "button");
			attr_dev(span1, "tabindex", "0");
			attr_dev(span1, "class", "textspan s-TqfVXVzNPjpA");
			toggle_class(span1, "no-cat", /*class_or_confidence*/ ctx[46] === null || /*active*/ ctx[5] && /*active*/ ctx[5] !== /*class_or_confidence*/ ctx[46]);
			toggle_class(span1, "hl", /*class_or_confidence*/ ctx[46] !== null);
			...
			attr_dev(span2, "class", "text-class_or_confidence-container s-TqfVXVzNPjpA");
...
function create_if_block_5(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(span, "class", "label s-TqfVXVzNPjpA");
			attr_dev(span, "role", "button");
			attr_dev(span, "tabindex", "0");
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			if_block.c();
			attr_dev(div, "class", "container s-TqfVXVzNPjpA");
...
/* home/runner/work/gradio/gradio/js/highlightedtext/interactive/InteractiveHighlightedText.svelte generated by Svelte v4.0.0 */
...
//# sourceMappingURL=index-943b0827.js.map
