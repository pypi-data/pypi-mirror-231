...
from dnbc4tools.tools.utils import str_mkdir, judgeFilexits, change_path, logging_call, hamming_distance, read_json, verify_fastq_files, bin_path, get_formatted_time
...
class Data:
    ...
    def run(self):
        ...
        print(f'\n{get_formatted_time()}\n'
            f'Barcode Processing, Alignment.')
        ...
        chromap_cmd += [f'2> {self.outdir}/01.data/alignment_report.tsv']
