import os,shutil
from dnbc4tools.tools.utils import str_mkdir,logging_call,change_path,read_json,judgeFilexits,rm_temp, get_formatted_time
...
class Report:
    ...
    def run(self):
        ...
        ### plotly
        print(f'\n{get_formatted_time()}\n'
            f'Summarizing results and generating a report.')
