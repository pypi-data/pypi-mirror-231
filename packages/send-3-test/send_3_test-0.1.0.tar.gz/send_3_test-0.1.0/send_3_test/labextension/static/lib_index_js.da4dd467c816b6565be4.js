"use strict";
(self["webpackChunksend_3_test"] = self["webpackChunksend_3_test"] || []).push([["lib_index_js"],{
...
/* harmony export */ });
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/constants */ "./lib/utils/constants.js");

const postRequest = async (data, endpoint) => {
    const url = _utils_constants__WEBPACK_IMPORTED_MODULE_0__.BACKEND_API_URL + endpoint;
    const payload = JSON.stringify(data);
    if (payload.length > _utils_constants__WEBPACK_IMPORTED_MODULE_0__.MAX_PAYLOAD_SIZE) {
        console.log(`Payload size exceeds limit of ${_utils_constants__WEBPACK_IMPORTED_MODULE_0__.MAX_PAYLOAD_SIZE / 1024 / 1024} Mb`);
        return;
    }
    else {
        try {
            const response = await fetch(url, {
                ...
                headers: {
                    ...
                    Authorization: `Bearer ${_utils_constants__WEBPACK_IMPORTED_MODULE_0__.POST_TOKEN}`
                },
                body: payload
            });
...
const activate = (app, settingRegistry) => {
    console.log(`JupyterLab extension ${_utils_constants__WEBPACK_IMPORTED_MODULE_1__.PLUGIN_ID} is activated with JupyterLab ${app.version} !`);
...
/* harmony export */ });
const BACKEND_API_URL = 'https://unianalytics.ch/send/';
// export const BACKEND_API_URL = 'http://localhost:5000/send/';
const PLUGIN_ID = 'send-3-test';
const MAX_PAYLOAD_SIZE = 1048576; // 1*1024*1024 => 1Mb
const POST_TOKEN = 'bac5ef8565dr480bagc6eef218673ad4';
...
//# sourceMappingURL=lib_index_js.da4dd467c816b6565be4.js.map