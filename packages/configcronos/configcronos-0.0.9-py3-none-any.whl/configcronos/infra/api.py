...
from configcronos.core.entities import Client, Database, Segment, Phase2, Oracle, SQLs, Schedule, Phase3, Phase3Segmentos
...
def phase3_segmentos() -> Phase3Segmentos:
    return Phase3Service(Phase3RepositoryAPI(headers())).get_phase3_segments()
