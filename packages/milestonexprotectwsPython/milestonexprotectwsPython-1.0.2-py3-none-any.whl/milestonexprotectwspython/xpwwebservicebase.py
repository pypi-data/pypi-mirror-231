...
class XPWWebServiceBase:
    ...
    def GetDictKeyValueBool(oDict:dict, keyName:str, raiseExceptionIfNotFound:bool=False) -> bool:
        ...
        if (XPWWebServiceBase.DictHasKey(oDict, keyName)):
            ...
            try:
                ...
                if (raiseExceptionIfNotFound):
                    raise Exception(XPWAppMessages.DICTIONARY_VALUE_NOT_CONVERTIBLE.format(keyName, value, "bool"))
        ...
        if (XPWWebServiceBase.DictHasKey(oDict, keyName)):
            ...
            # is it a string value? if so, then convert it to a datetime.
                ...
                try:
                    ...
                    # parsing failed; raise exception if requested.
                    if (raiseExceptionIfNotFound):
                        raise Exception(XPWAppMessages.DICTIONARY_VALUE_NOT_CONVERTIBLE.format(keyName, datetime_str, "datetime"))
    ...
    def GetDictKeyValueFloat(oDict:dict, keyName:str, raiseExceptionIfNotFound:bool=False) -> float:
        ...
        if (XPWWebServiceBase.DictHasKey(oDict, keyName)):
            ...
            # is it a string value? if so, then convert it to a float.
            if (isinstance(value, str)):
                ...
                try:
                    ...
                    # parsing failed; raise exception if requested.
                    if (raiseExceptionIfNotFound):
                        raise Exception(XPWAppMessages.DICTIONARY_VALUE_NOT_CONVERTIBLE.format(keyName, value, "float"))
    ...
    def GetDictKeyValueInt(oDict:dict, keyName:str, raiseExceptionIfNotFound:bool=False) -> int:
        ...
        if (XPWWebServiceBase.DictHasKey(oDict, keyName)):
            ...
            # is it a string value? if so, then convert it to an integer.
            if (isinstance(value, str)):
                ...
                try:
                    ...
                    # parsing failed; raise exception if requested.
                    if (raiseExceptionIfNotFound):
                        raise Exception(XPWAppMessages.DICTIONARY_VALUE_NOT_CONVERTIBLE.format(keyName, value, "int"))
    ...
    def GetDictKeyValueString(oDict:dict, keyName:str, raiseExceptionIfNotFound:bool=False) -> str:
        ...
        if (XPWWebServiceBase.DictHasKey(oDict, keyName)):
            ...
            try:
                ...
                # parsing failed; raise exception if requested.
                if (raiseExceptionIfNotFound):
                    raise Exception(XPWAppMessages.DICTIONARY_VALUE_NOT_CONVERTIBLE.format(keyName, value, "string"))
