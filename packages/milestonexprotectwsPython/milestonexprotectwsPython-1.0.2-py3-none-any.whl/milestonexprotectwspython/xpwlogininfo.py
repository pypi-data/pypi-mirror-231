...
class XPWLoginInfo:
    ...
    def __init__(self) -> None:
        ...
        """
        # initialize instance.
        self._fAuthenticationType:XPWAuthenticationType = XPWAuthenticationType.Unknown
    ...
    @property
    def AuthenticationType(self) -> XPWAuthenticationType:
        """ 
    ...
    def AuthenticationType(self, value:XPWAuthenticationType) -> None:
        """ 
