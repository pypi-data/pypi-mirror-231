...
class XPWSpeaker(XPWDevice):
    ...
    def __init__(self) -> None:
        ...
        self._fSpeakerSecurity:XPWSpeakerSecurity = XPWSpeakerSecurity()
    ...
    @property
    def SpeakerSecurity(self) -> XPWSpeakerSecurity:
        """ 
        Security settings.
    ...
    def __eq__(self, other):
        try:
            ...
            if (isinstance(self, XPWSpeaker )) and (isinstance(other, XPWSpeaker )):
                return self.Name == other.Name
            return False
