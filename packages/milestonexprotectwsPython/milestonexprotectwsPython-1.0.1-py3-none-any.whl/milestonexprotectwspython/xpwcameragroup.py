...
class XPWCameraGroup(XPWGroup):
    ...
    def CameraGroups(self) -> XPWCollection:
        """ 
        A collection of XPCameraGroupsInfo objects.
    ...
    def Cameras(self) -> list[str]:
        """ 
        A list of camera device identifiers associated with this group.

        Returns:
            The Cameras property value.
        """
    ...
    def __eq__(self, other):
        try:
            ...
            if (isinstance(self, XPWCameraGroup)) and (isinstance(other, XPWCameraGroup)):
                return self.Name == other.Name
            return False
