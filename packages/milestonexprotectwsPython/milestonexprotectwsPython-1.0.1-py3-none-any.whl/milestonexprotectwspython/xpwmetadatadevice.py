...
@export
class XPWMetadataDevice(XPWDevice):
    """
    ...
    def __init__(self) -> None:
        ...
        self._fMetadataDeviceSecurity:XPWMetadataDeviceSecurity = XPWMetadataDeviceSecurity()
        self._fMetadataTypes:XPWCollection = XPWCollection((XPWMetadataType))
    ...
    @property
    def MetadataDeviceSecurity(self) -> XPWMetadataDeviceSecurity:
        """ 
        Security settings.
        ...
        """
        return self._fMetadataDeviceSecurity


    @property
    def MetadataTypes(self) -> XPWCollection:
        """ 
    ...
    def __eq__(self, other):
        try:
            ...
            if (isinstance(self, XPWMetadataDevice )) and (isinstance(other, XPWMetadataDevice )):
                return self.Name == other.Name
            return False
