...
def get_logging_ipv6_host_vrf_transport(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:iosxe/getLoggingIpv6HostVrfTransport:getLoggingIpv6HostVrfTransport', __args__, opts=opts, typ=GetLoggingIpv6HostVrfTransportResult).value
