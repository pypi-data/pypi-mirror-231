...
def get_logging_ipv4_host_transport(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:iosxe/getLoggingIpv4HostTransport:getLoggingIpv4HostTransport', __args__, opts=opts, typ=GetLoggingIpv4HostTransportResult).value
