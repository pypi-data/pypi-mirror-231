...
__all__ = ['BgpAddressFamilyIpv4VrfArgs', 'BgpAddressFamilyIpv4Vrf']

@pulumi.input_type
class BgpAddressFamilyIpv4VrfArgs:
    def __init__(__self__, *,
                 af_name: pulumi.Input[str],
                 asn: pulumi.Input[str],
                 delete_mode: Optional[pulumi.Input[str]] = None,
                 device: Optional[pulumi.Input[str]] = None,
                 vrfs: Optional[pulumi.Input[Sequence[pulumi.Input['BgpAddressFamilyIpv4VrfVrfArgs']]]] = None):
        """
    ...
    @property
    @pulumi.getter
    def vrfs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['BgpAddressFamilyIpv4VrfVrfArgs']]]]:
        return pulumi.get(self, "vrfs")

    @vrfs.setter
    def vrfs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['BgpAddressFamilyIpv4VrfVrfArgs']]]]):
        pulumi.set(self, "vrfs", value)


@pulumi.input_type
class _BgpAddressFamilyIpv4VrfState:
    def __init__(__self__, *,
...
class BgpAddressFamilyIpv4Vrf(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 delete_mode: Optional[pulumi.Input[str]] = None,
                 device: Optional[pulumi.Input[str]] = None,
                 vrfs: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['BgpAddressFamilyIpv4VrfVrfArgs']]]]] = None,
                 __props__=None):
        """
        Create a BgpAddressFamilyIpv4Vrf resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a BgpAddressFamilyIpv4Vrf resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param BgpAddressFamilyIpv4VrfArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BgpAddressFamilyIpv4VrfArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BgpAddressFamilyIpv4VrfArgs.__new__(BgpAddressFamilyIpv4VrfArgs)
        ...
        super(BgpAddressFamilyIpv4Vrf, __self__).__init__(
            'iosxe:iosxe/bgpAddressFamilyIpv4Vrf:BgpAddressFamilyIpv4Vrf',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            delete_mode: Optional[pulumi.Input[str]] = None,
            device: Optional[pulumi.Input[str]] = None,
            vrfs: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['BgpAddressFamilyIpv4VrfVrfArgs']]]]] = None) -> 'BgpAddressFamilyIpv4Vrf':
        """
        ...
        __props__ = _BgpAddressFamilyIpv4VrfState.__new__(_BgpAddressFamilyIpv4VrfState)
        ...
        __props__.__dict__["device"] = device
        __props__.__dict__["vrfs"] = vrfs
        return BgpAddressFamilyIpv4Vrf(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def vrfs(self) -> pulumi.Output[Optional[Sequence['outputs.BgpAddressFamilyIpv4VrfVrf']]]:
        return pulumi.get(self, "vrfs")
