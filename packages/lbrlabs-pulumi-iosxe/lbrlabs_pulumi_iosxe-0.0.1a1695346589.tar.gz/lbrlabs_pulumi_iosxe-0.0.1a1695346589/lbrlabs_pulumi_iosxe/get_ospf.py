...
def get_ospf(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:index/getOspf:getOspf', __args__, opts=opts, typ=GetOspfResult).value
...
def get_ospf_output(device: Optional[pulumi.Input[Optional[str]]] = None,
