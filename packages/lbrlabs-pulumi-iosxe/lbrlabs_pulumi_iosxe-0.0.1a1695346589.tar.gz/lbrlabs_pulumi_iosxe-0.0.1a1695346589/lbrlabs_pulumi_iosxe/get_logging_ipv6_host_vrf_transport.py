...
__all__ = [
    'GetLoggingIpv6HostVrfTransportResult',
    'AwaitableGetLoggingIpv6HostVrfTransportResult',
    'get_logging_ipv6_host_vrf_transport',
    'get_logging_ipv6_host_vrf_transport_output',
]

@pulumi.output_type
class GetLoggingIpv6HostVrfTransportResult:
    """
    A collection of values returned by getLoggingIpv6HostVrfTransport.
    """
    def __init__(__self__, device=None, id=None, ipv6_host=None, transport_tcp_ports=None, transport_tls_ports=None, transport_udp_ports=None, vrf=None):
...
class AwaitableGetLoggingIpv6HostVrfTransportResult(GetLoggingIpv6HostVrfTransportResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoggingIpv6HostVrfTransportResult(
            device=self.device,
            id=self.id,
...
def get_logging_ipv6_host_vrf_transport(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:index/getLoggingIpv6HostVrfTransport:getLoggingIpv6HostVrfTransport', __args__, opts=opts, typ=GetLoggingIpv6HostVrfTransportResult).value

    return AwaitableGetLoggingIpv6HostVrfTransportResult(
...
@_utilities.lift_output_func(get_logging_ipv6_host_vrf_transport)
def get_logging_ipv6_host_vrf_transport_output(device: Optional[pulumi.Input[Optional[str]]] = None,
