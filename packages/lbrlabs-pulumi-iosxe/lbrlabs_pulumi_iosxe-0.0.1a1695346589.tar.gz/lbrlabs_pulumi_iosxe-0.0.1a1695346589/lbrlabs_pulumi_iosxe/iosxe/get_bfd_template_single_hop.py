...
def get_bfd_template_single_hop(device: Optional[str] = None,
    ...
    example = iosxe.iosxe.get_bfd_template_single_hop(name="SH-TEMPLATE-1")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:iosxe/getBfdTemplateSingleHop:getBfdTemplateSingleHop', __args__, opts=opts, typ=GetBfdTemplateSingleHopResult).value
