...
def get_logging_ipv4_host_vrf_transport(device: Optional[str] = None,
    ...
    example = iosxe.iosxe.get_logging_ipv4_host_vrf_transport(ipv4_host="2.2.2.2",
        vrf="VRF1")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:iosxe/getLoggingIpv4HostVrfTransport:getLoggingIpv4HostVrfTransport', __args__, opts=opts, typ=GetLoggingIpv4HostVrfTransportResult).value
