...
def get_crypto_ipsec_transform_set(device: Optional[str] = None,
    ...
    example = iosxe.iosxe.get_crypto_ipsec_transform_set(name="TEST")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:iosxe/getCryptoIpsecTransformSet:getCryptoIpsecTransformSet', __args__, opts=opts, typ=GetCryptoIpsecTransformSetResult).value
