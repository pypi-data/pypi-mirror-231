...
def get_access_list_standard(device: Optional[str] = None,
    ...
    example = iosxe.iosxe.get_access_list_standard(name="SACL1")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:iosxe/getAccessListStandard:getAccessListStandard', __args__, opts=opts, typ=GetAccessListStandardResult).value
