...
__all__ = [
    'GetBfdTemplateMultiHopResult',
    'AwaitableGetBfdTemplateMultiHopResult',
    'get_bfd_template_multi_hop',
    'get_bfd_template_multi_hop_output',
]

@pulumi.output_type
class GetBfdTemplateMultiHopResult:
    """
    A collection of values returned by getBfdTemplateMultiHop.
    """
    def __init__(__self__, authentication_md5_keychain=None, authentication_meticulous_md5_keychain=None, authentication_meticulous_sha1keychain=None, authentication_sha1_keychain=None, dampening_down_monitoring=None, dampening_half_time=None, dampening_max_suppressing_time=None, dampening_suppress_time=None, dampening_threshold=None, dampening_unsuppress_time=None, device=None, echo=None, id=None, interval_microseconds=None, interval_microseconds_both=None, interval_microseconds_min_rx=None, interval_microseconds_min_tx=None, interval_microseconds_multiplier=None, interval_milliseconds_both=None, interval_milliseconds_min_rx=None, interval_milliseconds_min_tx=None, interval_milliseconds_multiplier=None, name=None):
        ...
        if authentication_meticulous_sha1keychain and not isinstance(authentication_meticulous_sha1keychain, str):
            raise TypeError("Expected argument 'authentication_meticulous_sha1keychain' to be a str")
        ...
        if dampening_down_monitoring and not isinstance(dampening_down_monitoring, bool):
            raise TypeError("Expected argument 'dampening_down_monitoring' to be a bool")
        ...
        if dampening_threshold and not isinstance(dampening_threshold, int):
            raise TypeError("Expected argument 'dampening_threshold' to be a int")
        ...
        if interval_microseconds and not isinstance(interval_microseconds, bool):
            raise TypeError("Expected argument 'interval_microseconds' to be a bool")
        pulumi.set(__self__, "interval_microseconds", interval_microseconds)
        if interval_microseconds_both and not isinstance(interval_microseconds_both, int):
            raise TypeError("Expected argument 'interval_microseconds_both' to be a int")
        ...
        if interval_microseconds_multiplier and not isinstance(interval_microseconds_multiplier, int):
            raise TypeError("Expected argument 'interval_microseconds_multiplier' to be a int")
...
class AwaitableGetBfdTemplateMultiHopResult(GetBfdTemplateMultiHopResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBfdTemplateMultiHopResult(
            ...
            authentication_meticulous_sha1keychain=self.authentication_meticulous_sha1keychain,
            authentication_sha1_keychain=self.authentication_sha1_keychain,
            dampening_down_monitoring=self.dampening_down_monitoring,
            ...
            interval_microseconds_multiplier=self.interval_microseconds_multiplier,
...
def get_bfd_template_multi_hop(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:iosxe/getBfdTemplateMultiHop:getBfdTemplateMultiHop', __args__, opts=opts, typ=GetBfdTemplateMultiHopResult).value

    return AwaitableGetBfdTemplateMultiHopResult(
        ...
        authentication_meticulous_sha1keychain=pulumi.get(__ret__, 'authentication_meticulous_sha1keychain'),
        authentication_sha1_keychain=pulumi.get(__ret__, 'authentication_sha1_keychain'),
        dampening_down_monitoring=pulumi.get(__ret__, 'dampening_down_monitoring'),
        ...
        dampening_threshold=pulumi.get(__ret__, 'dampening_threshold'),
        dampening_unsuppress_time=pulumi.get(__ret__, 'dampening_unsuppress_time'),
        device=pulumi.get(__ret__, 'device'),
        echo=pulumi.get(__ret__, 'echo'),
        id=pulumi.get(__ret__, 'id'),
        interval_microseconds=pulumi.get(__ret__, 'interval_microseconds'),
        interval_microseconds_both=pulumi.get(__ret__, 'interval_microseconds_both'),
        ...
        interval_microseconds_multiplier=pulumi.get(__ret__, 'interval_microseconds_multiplier'),
...
@_utilities.lift_output_func(get_bfd_template_multi_hop)
def get_bfd_template_multi_hop_output(device: Optional[pulumi.Input[Optional[str]]] = None,
