...
def get_bgp_address_family_ipv6_vrf(af_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:index/getBgpAddressFamilyIpv6Vrf:getBgpAddressFamilyIpv6Vrf', __args__, opts=opts, typ=GetBgpAddressFamilyIpv6VrfResult).value
