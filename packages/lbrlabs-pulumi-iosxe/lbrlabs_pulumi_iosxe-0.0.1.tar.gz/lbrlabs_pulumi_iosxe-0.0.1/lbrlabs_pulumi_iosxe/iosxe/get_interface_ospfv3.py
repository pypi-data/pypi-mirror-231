...
def get_interface_ospfv3(device: Optional[str] = None,
    ...
    example = iosxe.iosxe.get_interface_ospfv3(name="1",
        type="Loopback")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:iosxe/getInterfaceOspfv3:getInterfaceOspfv3', __args__, opts=opts, typ=GetInterfaceOspfv3Result).value
