...
def get_interface_port_channel_subinterface(device: Optional[str] = None,
    ...
    example = iosxe.iosxe.get_interface_port_channel_subinterface(name="10.666")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:iosxe/getInterfacePortChannelSubinterface:getInterfacePortChannelSubinterface', __args__, opts=opts, typ=GetInterfacePortChannelSubinterfaceResult).value
