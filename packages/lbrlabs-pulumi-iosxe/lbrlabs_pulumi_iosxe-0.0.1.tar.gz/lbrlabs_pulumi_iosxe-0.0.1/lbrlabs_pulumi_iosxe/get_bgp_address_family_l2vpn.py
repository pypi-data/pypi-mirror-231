...
def get_bgp_address_family_l2vpn(af_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:index/getBgpAddressFamilyL2vpn:getBgpAddressFamilyL2vpn', __args__, opts=opts, typ=GetBgpAddressFamilyL2vpnResult).value
