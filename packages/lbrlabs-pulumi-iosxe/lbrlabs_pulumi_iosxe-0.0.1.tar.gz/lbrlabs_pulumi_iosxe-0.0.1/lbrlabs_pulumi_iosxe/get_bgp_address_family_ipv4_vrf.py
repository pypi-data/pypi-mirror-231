...
def get_bgp_address_family_ipv4_vrf(af_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:index/getBgpAddressFamilyIpv4Vrf:getBgpAddressFamilyIpv4Vrf', __args__, opts=opts, typ=GetBgpAddressFamilyIpv4VrfResult).value
