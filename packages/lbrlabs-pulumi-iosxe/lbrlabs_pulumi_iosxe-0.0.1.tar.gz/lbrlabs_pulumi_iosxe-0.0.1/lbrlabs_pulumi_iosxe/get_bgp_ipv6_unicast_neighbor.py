...
def get_bgp_ipv6_unicast_neighbor(asn: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:index/getBgpIpv6UnicastNeighbor:getBgpIpv6UnicastNeighbor', __args__, opts=opts, typ=GetBgpIpv6UnicastNeighborResult).value
