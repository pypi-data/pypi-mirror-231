...
def get_bgp_ipv4_unicast_neighbor(asn: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:index/getBgpIpv4UnicastNeighbor:getBgpIpv4UnicastNeighbor', __args__, opts=opts, typ=GetBgpIpv4UnicastNeighborResult).value
