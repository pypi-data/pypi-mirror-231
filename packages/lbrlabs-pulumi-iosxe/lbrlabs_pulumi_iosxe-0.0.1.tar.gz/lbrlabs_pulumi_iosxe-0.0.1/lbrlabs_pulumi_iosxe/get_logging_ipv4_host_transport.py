...
__all__ = [
    'GetLoggingIpv4HostTransportResult',
    'AwaitableGetLoggingIpv4HostTransportResult',
    'get_logging_ipv4_host_transport',
    'get_logging_ipv4_host_transport_output',
]

@pulumi.output_type
class GetLoggingIpv4HostTransportResult:
    """
    A collection of values returned by getLoggingIpv4HostTransport.
    """
    def __init__(__self__, device=None, id=None, ipv4_host=None, transport_tcp_ports=None, transport_tls_ports=None, transport_udp_ports=None):
...
class AwaitableGetLoggingIpv4HostTransportResult(GetLoggingIpv4HostTransportResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoggingIpv4HostTransportResult(
            device=self.device,
            id=self.id,
...
def get_logging_ipv4_host_transport(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:index/getLoggingIpv4HostTransport:getLoggingIpv4HostTransport', __args__, opts=opts, typ=GetLoggingIpv4HostTransportResult).value

    return AwaitableGetLoggingIpv4HostTransportResult(
...
@_utilities.lift_output_func(get_logging_ipv4_host_transport)
def get_logging_ipv4_host_transport_output(device: Optional[pulumi.Input[Optional[str]]] = None,
