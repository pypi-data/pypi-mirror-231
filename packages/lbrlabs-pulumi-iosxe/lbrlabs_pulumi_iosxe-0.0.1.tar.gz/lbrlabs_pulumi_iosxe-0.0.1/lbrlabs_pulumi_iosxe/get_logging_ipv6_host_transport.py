...
def get_logging_ipv6_host_transport(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('iosxe:index/getLoggingIpv6HostTransport:getLoggingIpv6HostTransport', __args__, opts=opts, typ=GetLoggingIpv6HostTransportResult).value
