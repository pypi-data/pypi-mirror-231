...
from blazogram.types.objects.objects import PhotoSize
            ...
            if handler[1] == 'message':
                ...
                if check is True:
                    ...
                    if len(handler) == 3:
                        ...
                        await asyncio.wait([asyncio.create_task(middleware(handler=handler[0], update=message, data=data)) for middleware in handler[3]])
                    break
