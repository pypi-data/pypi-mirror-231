...
class Org:
    ...
    def remove_user(self, user_id: str) -> None:
        ...
        Raises:
            roboto_sdk.exceptions.RobotoUnauthorizedException: In a number of different cases:
            ...
            roboto_sdk.exceptions.RobotoNotFoundException: If the target user is not a member of the specified org.
            roboto_sdk.exceptions.RobotoInvalidRequestException:
