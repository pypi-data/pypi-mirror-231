...
HEASERVER_BUCKETS_IMAGE = 'registry.gitlab.com/huntsman-cancer-institute/risr/hea/heaserver-buckets:1.0.0b2'
...
if __name__ == '__main__':
    ...
    swaggerui.run(project_slug='heaserver-folders-aws-s3', desktop_objects=db_values,
                  ...
                  routes=[# Folders
                          ...
                          (get, '/volumes/{volume_id}/buckets/{bucket_id}/awss3folders/{id}/unarchive', service.get_folder_unarchive),
