...
__all__ = ['FeatureOspfv3Args', 'FeatureOspfv3']

@pulumi.input_type
class FeatureOspfv3Args:
...
class FeatureOspfv3(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a FeatureOspfv3 resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a FeatureOspfv3 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param FeatureOspfv3Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FeatureOspfv3Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FeatureOspfv3Args.__new__(FeatureOspfv3Args)
        ...
        super(FeatureOspfv3, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            admin_state: Optional[pulumi.Input[str]] = None,
            device: Optional[pulumi.Input[str]] = None) -> 'FeatureOspfv3':
        """
        ...
        __props__ = _FeatureOspfv3State.__new__(_FeatureOspfv3State)

        __props__.__dict__["admin_state"] = admin_state
        __props__.__dict__["device"] = device
        return FeatureOspfv3(resource_name, opts=opts, __props__=__props__)
