...
__all__ = ['SubinterfaceVrfArgs', 'SubinterfaceVrf']

@pulumi.input_type
class SubinterfaceVrfArgs:
...
class SubinterfaceVrf(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SubinterfaceVrf resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a SubinterfaceVrf resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SubinterfaceVrfArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SubinterfaceVrfArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SubinterfaceVrfArgs.__new__(SubinterfaceVrfArgs)
        ...
        super(SubinterfaceVrf, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            device: Optional[pulumi.Input[str]] = None,
            interface_id: Optional[pulumi.Input[str]] = None,
            vrf_dn: Optional[pulumi.Input[str]] = None) -> 'SubinterfaceVrf':
        """
        ...
        __props__ = _SubinterfaceVrfState.__new__(_SubinterfaceVrfState)

        __props__.__dict__["device"] = device
        __props__.__dict__["interface_id"] = interface_id
        __props__.__dict__["vrf_dn"] = vrf_dn
        return SubinterfaceVrf(resource_name, opts=opts, __props__=__props__)
