...
def get_ipv4_access_list_policy_ingress_interface(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('nxos:nxos/getIpv4AccessListPolicyIngressInterface:getIpv4AccessListPolicyIngressInterface', __args__, opts=opts, typ=GetIpv4AccessListPolicyIngressInterfaceResult).value
