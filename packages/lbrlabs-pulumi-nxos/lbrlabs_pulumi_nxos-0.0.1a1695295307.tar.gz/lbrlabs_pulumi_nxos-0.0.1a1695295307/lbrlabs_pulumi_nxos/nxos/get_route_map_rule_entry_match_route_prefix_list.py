...
def get_route_map_rule_entry_match_route_prefix_list(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('nxos:nxos/getRouteMapRuleEntryMatchRoutePrefixList:getRouteMapRuleEntryMatchRoutePrefixList', __args__, opts=opts, typ=GetRouteMapRuleEntryMatchRoutePrefixListResult).value
