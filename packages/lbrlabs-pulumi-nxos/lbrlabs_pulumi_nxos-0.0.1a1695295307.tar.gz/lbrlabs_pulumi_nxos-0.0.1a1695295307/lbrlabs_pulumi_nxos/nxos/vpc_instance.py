...
class VpcInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a VpcInstance resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[VpcInstanceArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a VpcInstance resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            admin_state: Optional[pulumi.Input[str]] = None,
            device: Optional[pulumi.Input[str]] = None) -> 'VpcInstance':
        """
