...
__all__ = ['FeatureLacpArgs', 'FeatureLacp']

@pulumi.input_type
class FeatureLacpArgs:
...
class FeatureLacp(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a FeatureLacp resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FeatureLacpArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a FeatureLacp resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param FeatureLacpArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FeatureLacpArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FeatureLacpArgs.__new__(FeatureLacpArgs)
        ...
        super(FeatureLacp, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            admin_state: Optional[pulumi.Input[str]] = None,
            device: Optional[pulumi.Input[str]] = None) -> 'FeatureLacp':
        """
        ...
        __props__ = _FeatureLacpState.__new__(_FeatureLacpState)

        __props__.__dict__["admin_state"] = admin_state
        __props__.__dict__["device"] = device
        return FeatureLacp(resource_name, opts=opts, __props__=__props__)
