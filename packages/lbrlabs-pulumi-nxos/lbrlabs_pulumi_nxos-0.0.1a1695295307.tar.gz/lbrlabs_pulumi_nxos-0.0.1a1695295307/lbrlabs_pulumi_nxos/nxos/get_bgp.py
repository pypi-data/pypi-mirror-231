...
def get_bgp(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('nxos:nxos/getBgp:getBgp', __args__, opts=opts, typ=GetBgpResult).value
...
def get_bgp_output(device: Optional[pulumi.Input[Optional[str]]] = None,
