...
def get_evpn_vni_route_target_direction(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('nxos:nxos/getEvpnVniRouteTargetDirection:getEvpnVniRouteTargetDirection', __args__, opts=opts, typ=GetEvpnVniRouteTargetDirectionResult).value
