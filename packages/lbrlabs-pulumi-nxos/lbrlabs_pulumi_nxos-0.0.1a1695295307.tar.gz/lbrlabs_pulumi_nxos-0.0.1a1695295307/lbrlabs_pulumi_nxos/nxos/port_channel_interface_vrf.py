...
__all__ = ['PortChannelInterfaceVrfArgs', 'PortChannelInterfaceVrf']

@pulumi.input_type
class PortChannelInterfaceVrfArgs:
...
@pulumi.input_type
class _PortChannelInterfaceVrfState:
    def __init__(__self__, *,
                 device: Optional[pulumi.Input[str]] = None,
...
class PortChannelInterfaceVrf(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a PortChannelInterfaceVrf resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: PortChannelInterfaceVrfArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a PortChannelInterfaceVrf resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param PortChannelInterfaceVrfArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PortChannelInterfaceVrfArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PortChannelInterfaceVrfArgs.__new__(PortChannelInterfaceVrfArgs)
        ...
        super(PortChannelInterfaceVrf, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            device: Optional[pulumi.Input[str]] = None,
            interface_id: Optional[pulumi.Input[str]] = None,
            vrf_dn: Optional[pulumi.Input[str]] = None) -> 'PortChannelInterfaceVrf':
        """
        ...
        __props__ = _PortChannelInterfaceVrfState.__new__(_PortChannelInterfaceVrfState)

        __props__.__dict__["device"] = device
        __props__.__dict__["interface_id"] = interface_id
        __props__.__dict__["vrf_dn"] = vrf_dn
        return PortChannelInterfaceVrf(resource_name, opts=opts, __props__=__props__)
