...
__all__ = ['Ipv4AccessListPolicyIngressInterfaceArgs', 'Ipv4AccessListPolicyIngressInterface']

@pulumi.input_type
class Ipv4AccessListPolicyIngressInterfaceArgs:
...
@pulumi.input_type
class _Ipv4AccessListPolicyIngressInterfaceState:
    def __init__(__self__, *,
                 access_list_name: Optional[pulumi.Input[str]] = None,
                 device: Optional[pulumi.Input[str]] = None,
...
class Ipv4AccessListPolicyIngressInterface(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a Ipv4AccessListPolicyIngressInterface resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a Ipv4AccessListPolicyIngressInterface resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param Ipv4AccessListPolicyIngressInterfaceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Ipv4AccessListPolicyIngressInterfaceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Ipv4AccessListPolicyIngressInterfaceArgs.__new__(Ipv4AccessListPolicyIngressInterfaceArgs)
        ...
        super(Ipv4AccessListPolicyIngressInterface, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            access_list_name: Optional[pulumi.Input[str]] = None,
            device: Optional[pulumi.Input[str]] = None,
            interface_id: Optional[pulumi.Input[str]] = None) -> 'Ipv4AccessListPolicyIngressInterface':
        """
        ...
        __props__ = _Ipv4AccessListPolicyIngressInterfaceState.__new__(_Ipv4AccessListPolicyIngressInterfaceState)

        __props__.__dict__["access_list_name"] = access_list_name
        __props__.__dict__["device"] = device
        __props__.__dict__["interface_id"] = interface_id
        return Ipv4AccessListPolicyIngressInterface(resource_name, opts=opts, __props__=__props__)
