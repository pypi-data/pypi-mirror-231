...
def get_bgp_peer_template_max_prefix(address_family: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('nxos:nxos/getBgpPeerTemplateMaxPrefix:getBgpPeerTemplateMaxPrefix', __args__, opts=opts, typ=GetBgpPeerTemplateMaxPrefixResult).value
