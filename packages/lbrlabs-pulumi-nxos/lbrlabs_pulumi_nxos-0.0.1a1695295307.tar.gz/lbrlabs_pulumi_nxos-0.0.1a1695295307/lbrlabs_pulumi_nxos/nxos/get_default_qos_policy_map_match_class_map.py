...
def get_default_qos_policy_map_match_class_map(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('nxos:nxos/getDefaultQosPolicyMapMatchClassMap:getDefaultQosPolicyMapMatchClassMap', __args__, opts=opts, typ=GetDefaultQosPolicyMapMatchClassMapResult).value
