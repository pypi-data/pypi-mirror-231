...
def get_default_qos_policy_map_match_class_map_set_qos_group(class_map_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('nxos:nxos/getDefaultQosPolicyMapMatchClassMapSetQosGroup:getDefaultQosPolicyMapMatchClassMapSetQosGroup', __args__, opts=opts, typ=GetDefaultQosPolicyMapMatchClassMapSetQosGroupResult).value
