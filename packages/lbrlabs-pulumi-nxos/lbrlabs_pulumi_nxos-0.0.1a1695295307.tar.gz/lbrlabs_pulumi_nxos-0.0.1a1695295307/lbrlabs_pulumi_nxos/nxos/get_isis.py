...
def get_isis(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('nxos:nxos/getIsis:getIsis', __args__, opts=opts, typ=GetIsisResult).value
...
def get_isis_output(device: Optional[pulumi.Input[Optional[str]]] = None,
