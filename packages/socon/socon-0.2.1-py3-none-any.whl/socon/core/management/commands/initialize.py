...
class InitializeCommand(TemplateCommand):
    help: str = (
        "Creates a Socon workspace directory structure for the given workspace "
        "name in the current directory or optionally in the given directory."
    )
    missing_args_message: str = "You must provide a framework name."
    template_prefix: str = "workspace"

    def add_arguments(self, parser: ArgumentParser) -> None:
        parser.add_argument("name", help="Name of the workspace.")
        parser.add_argument("--target", help="Optional path to the workspace")
