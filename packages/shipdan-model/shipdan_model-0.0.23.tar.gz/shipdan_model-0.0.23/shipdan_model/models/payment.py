...
from shipdan_model import DIET_PAYMENT_SCHEDULE_STATUS, DietPaymentScheduleStatus
from shipdan_model import KST
...
class DietPaymentScheduleAddress(models.Model):
    ...
    user = models.ForeignKey('accounts.User', related_name='diet_payment_schedule_addresses', null=True,
                             on_delete=models.CASCADE)
...
class DietPaymentSchedule(models.Model):
    ...
    user = models.ForeignKey('accounts.User', related_name='diet_payment_schedules', on_delete=models.CASCADE)
    ...
    diet_bundle = models.OneToOneField('diet.DietBundle', related_name='diet_payment_schedule', null=True,
...
class DietPaymentScheduleProfile(models.Model):
    ...
    user = models.OneToOneField('accounts.User', related_name='diet_payment_schedule_profile', on_delete=models.CASCADE)
