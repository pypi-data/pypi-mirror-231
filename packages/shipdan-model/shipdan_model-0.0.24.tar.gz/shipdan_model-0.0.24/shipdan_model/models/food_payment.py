...
class FoodOrder(models.Model):
    ...
    order = models.OneToOneField('payment.Order', related_name='food_order', on_delete=models.CASCADE)
...
class FoodDiscount(models.Model):
    food_product = models.ForeignKey('food.FoodProduct', related_name='food_discounts', on_delete=models.CASCADE)
...
class CouponDiscount(models.Model):
    ...
    user = models.ForeignKey('accounts.User', related_name='coupon_discounts', on_delete=models.CASCADE)
...
class InvitationCouponCode(models.Model):
    user = models.OneToOneField('accounts.User', default=None, null=True, related_name='invitation_code',
...
class OrderFoodProductRelation(models.Model):
    ...
    food_product = models.ForeignKey('food.FoodProduct', related_name='order_rels', on_delete=models.SET_NULL,
                                     null=True)
    quantity = models.IntegerField()
    delivery = models.ForeignKey('delivery.Delivery', on_delete=models.SET_NULL, null=True, blank=True,
...
class OrderDeliveryRelation(models.Model):
    ...
    delivery = models.OneToOneField('delivery.Delivery', on_delete=models.SET_NULL, related_name='order_rel', null=True)
...
class OrderDayDietLog(models.Model):
    user = models.ForeignKey('accounts.User', related_name='order_day_diet_logs', on_delete=models.CASCADE)
...
class OrderDayDietFoodLog(models.Model):
    ...
    food_product = models.ForeignKey(
        'food.FoodProduct', related_name='order_day_diet_logs', on_delete=models.SET_NULL, null=True, blank=True
    )
...
class Point(models.Model):
    ...
    user = models.ForeignKey('accounts.User', related_name='points', on_delete=models.CASCADE)
