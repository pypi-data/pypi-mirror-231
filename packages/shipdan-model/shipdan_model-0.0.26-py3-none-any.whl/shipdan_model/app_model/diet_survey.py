...
class DietOrderSurvey(models.Model):
    user = models.ForeignKey('app_model.User', on_delete=models.CASCADE, related_name='diet_order_surveys')
...
class DietOrderSurveyComplete(models.Model):
    user = models.ForeignKey('app_model.User', on_delete=models.CASCADE, related_name='diet_order_surveys_completed')
...
class DayDietSurveyComplete(models.Model):
    user = models.ForeignKey('app_model.User', on_delete=models.CASCADE, related_name='day_diet_surveys_completed')
