...
class CouponDiscount(models.Model):
    ...
    user = models.ForeignKey('app_model.User', related_name='coupon_discounts', on_delete=models.CASCADE)
...
class InvitationCouponCode(models.Model):
    user = models.OneToOneField('app_model.User', default=None, null=True, related_name='invitation_code',
...
class OrderDayDietLog(models.Model):
    user = models.ForeignKey('app_model.User', related_name='order_day_diet_logs', on_delete=models.CASCADE)
...
class Point(models.Model):
    ...
    user = models.ForeignKey('app_model.User', related_name='points', on_delete=models.CASCADE)
