...
class DayDietRecord(models.Model):
    user = models.ForeignKey('app_model.User', related_name='day_diet_records', on_delete=models.CASCADE)
...
class SearchFoodProductLog(models.Model):
    ...
    user = models.ForeignKey('app_model.User', related_name='user_search_food_products', on_delete=models.CASCADE)
