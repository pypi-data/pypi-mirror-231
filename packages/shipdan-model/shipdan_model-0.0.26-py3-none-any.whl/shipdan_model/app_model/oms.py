...
class OperationProfile(models.Model):
    ...
    user = models.OneToOneField(
        'app_model.User', on_delete=models.SET_NULL, related_name='operation_profile',
        null=True
    )
...
class FoodProductChangeRequest(models.Model):
    ...
    requester = models.ForeignKey(
        'app_model.User', on_delete=models.SET_NULL, related_name='change_requests_from',
        null=True
    )
    approver = models.ForeignKey(
        'app_model.User', on_delete=models.SET_NULL, related_name='change_requests_to',
        null=True
    )
