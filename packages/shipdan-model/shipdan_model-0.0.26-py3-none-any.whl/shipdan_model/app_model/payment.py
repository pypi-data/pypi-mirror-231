...
class Order(models.Model):
    ...
    user = models.ForeignKey('app_model.User', on_delete=models.CASCADE, related_name='orders')
...
class IamportCustomerUid(models.Model):
    ...
    user = models.ForeignKey('app_model.User', related_name='customer_uids', on_delete=models.CASCADE)
...
class IamportOrder(models.Model):
    ...
    user = models.ForeignKey('app_model.User', related_name='iamport_orders', on_delete=models.CASCADE)
...
class DietPaymentScheduleAddress(models.Model):
    ...
    user = models.ForeignKey('app_model.User', related_name='diet_payment_schedule_addresses', null=True,
                             on_delete=models.CASCADE)
...
class DietPaymentSchedule(models.Model):
    ...
    user = models.ForeignKey('app_model.User', related_name='diet_payment_schedules', on_delete=models.CASCADE)
...
class DietPaymentScheduleProfile(models.Model):
    ...
    user = models.OneToOneField('app_model.User', related_name='diet_payment_schedule_profile', on_delete=models.CASCADE)
    status = models.IntegerField(choices=SCHEDULE_STATUS, default=UNDEFINED, help_text='현재 상태')
