...
class DietBundle(models.Model):
    ...
    """
    user = models.ForeignKey('app_model.User', related_name='diet_bundles', on_delete=models.CASCADE)
    ...
    food_order = models.OneToOneField('app_model.FoodOrder', on_delete=models.SET_NULL, null=True, related_name='diet_bundle', )
...
class DayDiet(models.Model):
    user = models.ForeignKey('app_model.User', related_name='day_diets', on_delete=models.CASCADE)
...
class UserMealTag(models.Model):
    ...
    users = models.ManyToManyField('app_model.User', related_name='meal_tags')
...
class DayDietFoodChangeEvent(models.Model):
    ...
    user = models.ForeignKey('app_model.User', related_name='day_diet_change_events', on_delete=models.CASCADE)
