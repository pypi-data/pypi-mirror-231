...
class MainNoticeUserLog(models.Model):
    user = models.ForeignKey('app_model.User', related_name='main_notice_logs', on_delete=models.CASCADE)
...
class FCMDevice(models.Model):
    ...
    user = models.ForeignKey('app_model.User', related_name='fcm_devices', blank=True, null=True,
...
class AirbridgeDevice(models.Model):
    ...
    user = models.ForeignKey('app_model.User', related_name='airbridge_devices', blank=True, null=True,
                             on_delete=models.CASCADE)
...
class AmazonSNSSubscription(models.Model):
    ...
    user = models.ForeignKey(
        'app_model.User', related_name='amazon_sns_subscriptions', on_delete=models.CASCADE, null=True, default=None
    )
    arn = models.CharField(max_length=200, null=True, default=None, unique=True)
    attributes = models.JSONField(default=dict)
...
class PushRoutine(models.Model):
    ...
    user = models.ForeignKey('app_model.User', on_delete=models.CASCADE, related_name='push_routines')
