...
from shipdan_model.models.food import Dish
...
class DietBundle(models.Model):
    ...
    """
    user = models.ForeignKey('accounts.User', related_name='diet_bundles', on_delete=models.CASCADE)
    target_started_at = models.DateTimeField(null=True, default=None)
    target_ended_at = models.DateTimeField(null=True, default=None)
    day_diets = models.ManyToManyField('diet.DayDiet', related_name='diet_bundles')
    # TODO:food_order의 on_delete null  옵션 확인 받기
    food_order = models.OneToOneField('food_payment.FoodOrder', on_delete=models.SET_NULL, null=True, related_name='diet_bundle', )
    day_diet_records = models.ManyToManyField('diary.DayDietRecord', related_name='diet_bundles')
...
class DayDiet(models.Model):
    user = models.ForeignKey('accounts.User', related_name='day_diets', on_delete=models.CASCADE)
    ...
    order = models.ForeignKey('food_payment.FoodOrder', on_delete=models.SET_NULL, null=True, blank=True,
...
class DayDietFood(models.Model):
    ...
    food_product = models.ForeignKey('food.FoodProduct', related_name='day_diet_food_products',
                                     on_delete=models.SET_NULL, null=True, blank=True)
    count = models.IntegerField(default=1)
    meal = models.IntegerField(choices=MEAL_TYPE, default=UNDEFINED)
    dish = models.ForeignKey('food.Dish', related_name='day_diet_foods', to_field='code', default=Dish.UNDEFINED,
...
class UserMealTag(models.Model):
    ...
    users = models.ManyToManyField('accounts.User', related_name='meal_tags')
...
class DayDietFoodChangeEvent(models.Model):
    ...
    user = models.ForeignKey('accounts.User', related_name='day_diet_change_events', on_delete=models.CASCADE)
...
class SampleMealFood(models.Model):
    ...
    food = models.ForeignKey('food.Food', related_name='sample_meal_foods', on_delete=models.CASCADE)
    food_product = models.ForeignKey('food.FoodProduct', related_name='sample_meal_food_products',
                                     on_delete=models.CASCADE, null=True)
    count = models.IntegerField(default=1)
    dish = models.ForeignKey('food.Dish', related_name='sample_meal_foods', to_field='code',
