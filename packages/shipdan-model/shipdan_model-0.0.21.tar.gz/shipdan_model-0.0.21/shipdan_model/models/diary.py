...
from shipdan_model.models.food import NutrientMeta, UnitMeta, FoodGroup
from shipdan_model.models.food_payment import OrderDayDietFoodLog
...
class FoodProductLog(models.Model):
    ...
    food_product = models.ForeignKey('food.FoodProduct', related_name='logs', on_delete=models.SET_NULL, null=True,
                                     blank=True)
...
class UserFoodProductLog(models.Model):
    ...
    food_product = models.ForeignKey('food.UserFoodProduct', related_name='logs', on_delete=models.SET_NULL, null=True,
                                     blank=True)
    count = models.IntegerField(default=1)
    meal = models.IntegerField(choices=MEAL_TYPE, default=UNDEFINED)
...
class DayDietFoodRecordFood(models.Model):
    ...
    dishes = models.ManyToManyField('food.Dish', related_name='record_foods')
    brand = models.ForeignKey('food.FoodBrand', null=True, blank=True, related_name='record_foods',
                              on_delete=models.SET_NULL)
    group = models.ForeignKey('food.FoodGroup', null=True, blank=True, to_field='code', default=FoodGroup.UNDEFINED,
                              related_name='record_foods',
                              on_delete=models.SET_DEFAULT)
    storage_method = models.ForeignKey('food.StorageMethod', on_delete=models.SET_NULL, null=True, default=None)
...
class DayDietRecord(models.Model):
    user = models.ForeignKey('accounts.User', related_name='day_diet_records', on_delete=models.CASCADE)
    day = models.DateField()
    diagnosis = models.ForeignKey('health.Diagnosis', related_name='day_diet_records', on_delete=models.CASCADE)
...
class SearchFoodProductLog(models.Model):
    ...
    user = models.ForeignKey('accounts.User', related_name='user_search_food_products', on_delete=models.CASCADE)
