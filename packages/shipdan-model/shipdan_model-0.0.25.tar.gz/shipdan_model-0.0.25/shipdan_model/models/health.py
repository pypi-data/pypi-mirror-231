...
class HealthProfile(models.Model):
    user = models.OneToOneField('accounts.User', related_name='health_profile', on_delete=models.CASCADE)
...
class Allergy(models.Model):
    ...
    foods = models.ManyToManyField('food.Food', related_name='allergies')
...
class PreferenceFoodCategory(models.Model):
    ...
    third_categories = models.ManyToManyField('food.ThirdCategory', related_name='preference_food_categories')
...
class DislikeCategoryLayerParameter(models.Model):
    ...
    category_codes = models.ManyToManyField('food.ThirdCategory', related_name='dislike_layer_parameters')
...
class FoodProductTaste(models.Model):
    ...
    food_product = models.ForeignKey('food.FoodProduct', related_name='taste_users', on_delete=models.CASCADE)
...
class FoodProductBlock(models.Model):
    ...
    food_product = models.ForeignKey('food.FoodProduct', related_name='food_product_blocks',
