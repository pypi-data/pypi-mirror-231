...
class FoodProductOrigin(models.Model):
    """
        ...
        model - FoodProductChangeRequest
...
class FoodProductBookmark(models.Model):
    profile = models.ForeignKey('health.HealthProfile', related_name='food_product_bookmarks', on_delete=models.CASCADE)
    food_product = models.ForeignKey('food.FoodProduct', related_name='bookmarks', on_delete=models.CASCADE)
...
class UserFood(models.Model):
    user = models.ForeignKey('accounts.User', related_name='user_foods', on_delete=models.CASCADE)
    name = models.CharField(max_length=255)
