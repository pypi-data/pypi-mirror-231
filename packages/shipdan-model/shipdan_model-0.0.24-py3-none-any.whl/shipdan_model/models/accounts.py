...
class UserResign(models.Model):
    user = models.ForeignKey(
        'accounts.User', on_delete=models.SET_NULL, null=True, related_name='resign_logs'
    )
...
class CommonProfile(models.Model):
    ...
    user = models.OneToOneField('accounts.User', on_delete=models.CASCADE, related_name='common_profile')
...
class KeyForResetPassword(models.Model):
    user = models.ForeignKey('accounts.User', on_delete=models.CASCADE, related_name='key_for_password')
...
class TosUserRelation(models.Model):
    user = models.ForeignKey('accounts.User', on_delete=models.CASCADE, related_name='tos_rels')
...
class OnboardingProcessUserRelation(models.Model):
    user = models.ForeignKey('accounts.User', related_name='onboarding_process_rels', on_delete=models.CASCADE)
...
class OnboardingFinish(models.Model):
    user = models.ForeignKey('accounts.User', related_name='onboarding_finished', on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
...
class TemporaryUserLog(models.Model):
    changed_from = models.ForeignKey('accounts.User', related_name='from_user', null=True, on_delete=models.SET_NULL)
    changed_to = models.ForeignKey('accounts.User', related_name='temporary_logs', on_delete=models.CASCADE)
...
class OnboardingAB(models.Model):
    ...
    user = models.OneToOneField('accounts.User', related_name='onboarding_ab', on_delete=models.CASCADE)
...
class DailyActiveUserLog(models.Model):
    user = models.ForeignKey('accounts.User', related_name='dau_logs', on_delete=models.CASCADE)
...
class UserABProperty(models.Model):
    user = models.ForeignKey('accounts.User', related_name='ab_properties', on_delete=models.CASCADE)
