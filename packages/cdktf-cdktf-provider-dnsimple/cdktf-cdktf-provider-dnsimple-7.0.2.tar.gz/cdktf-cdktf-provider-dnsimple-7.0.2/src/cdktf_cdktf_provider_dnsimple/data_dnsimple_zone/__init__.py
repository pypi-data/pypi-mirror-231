...
Refer to the Terraform Registory for docs: [`data_dnsimple_zone`](https://registry.terraform.io/providers/dnsimple/dnsimple/1.2.1/docs/data-sources/zone).
'''
import abc
import builtins
import datetime
...
class DataDnsimpleZone(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Zone Name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.2.1/docs/data-sources/zone#name DataDnsimpleZone#name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
