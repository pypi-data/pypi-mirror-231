...
class InputSource:
    ...
    Args:
        step_input_name (:obj:`str`): Name of the step input to be mapped.
...
class OutputDestination:
    ...
    Args:
        step_output_name (:obj:`str`): Name of the step output to be mapped.
