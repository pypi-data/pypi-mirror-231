...
LastEditTime: 2023-09-22 11:38:49
'''
...
def main():
    ...
    parser.add_argument('--config', default='chg_cal.yaml', type=str, metavar='N')
    ...
    if soc_switch:
        CHG_abs_u_path = input['CHG_u_path']
        CHG_abs_d_path = input['CHG_d_path']
        ...
        CHG_abs_path = input['CHG_path']
        f_json = open(CHG_abs_path)
        orb_data = json.load(f_json, object_pairs_hook=OrderedDict)
        chg_den = orb_data['CHG']
