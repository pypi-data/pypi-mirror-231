...
class BaseDatasetClient():
    ...
    def evaluate_measure(
        ...
        parsed_groupby = [_parse_fully_qualified_column(g) for g in groupby_columns]
        ...
        df = self._evaluate_measure(measure_lst, parsed_groupby, parsed_filters, num_rows, verbose=verbose)
