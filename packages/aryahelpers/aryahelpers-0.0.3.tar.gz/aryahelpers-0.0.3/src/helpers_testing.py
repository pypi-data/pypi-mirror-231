...
from aryahelpers.utils import genericutils
from aryahelpers.utils import mysqlutils
...
if False:
    ...
    save_files(extractCands, CUSTOM_SAVE_PATH, 'custom_analyzed_info', 'p_zip', '')
    # -*--*--*--*--*-
    # Load saved table data
    data_path = os.path.join(CUSTOM_SAVE_PATH, 'extracted_testbed_data', 'custom_analyzed_info.zip')
