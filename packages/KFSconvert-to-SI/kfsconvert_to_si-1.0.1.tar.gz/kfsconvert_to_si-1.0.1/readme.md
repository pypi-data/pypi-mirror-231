...
This library is a collection of miscellaneouns unit conversion factors that turned out to be quite useful to have while creating my other projects.  
...
You can install this library from Pypi with `pip install KFSconvert_to_SI`.
