...
class GenerationsQuery(BaseModel):
    task: str = Field(
        title="Task",
    ...
    page: Optional[int] = Field(
        title="Page",
        description="The page number of the generations to be returned",
    )
    query: Optional[Dict[str, Any]] = Field(
        title="Query",
        description="The query for which the generation is being requested",
    )
