...
# -*- coding: utf-8 -*-
#
# parchords_jupyter documentation build configuration file
#
...
project = 'parchords_jupyter'
copyright = '2023, Alexander Rind'
...
_version_py = os.path.join(repo, 'parchords_jupyter', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'parchords_jupyterdoc'
...
latex_documents = [
    (master_doc, 'parchords_jupyter.tex', 'parchords_jupyter Documentation',
...
man_pages = [
    (master_doc,
    'parchords_jupyter',
    'parchords_jupyter Documentation',
     [author], 1)
]
