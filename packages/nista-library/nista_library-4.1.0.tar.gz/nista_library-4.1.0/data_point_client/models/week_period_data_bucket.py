...
if TYPE_CHECKING:
    ...
    from ..models.week_period_data_point_data import WeekPeriodDataPointData


T = TypeVar("T", bound="WeekPeriodDataBucket")


@attr.s(auto_attribs=True)
class WeekPeriodDataBucket:
    """
    Attributes:
        discriminator (str):
        version (Union[Unset, int]):
        creation_reason (Union[Unset, None, str]):
        ...
        value (Union[Unset, None, List['WeekPeriodDataPointData']]):
    """

    discriminator: str
    version: Union[Unset, int] = UNSET
    creation_reason: Union[Unset, None, str] = UNSET
    ...
    value: Union[Unset, None, List["WeekPeriodDataPointData"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for value_item_data in _value or []:
            value_item = WeekPeriodDataPointData.from_dict(value_item_data)

            value.append(value_item)

        week_period_data_bucket = cls(
            discriminator=discriminator,
            version=version,
        ...
        week_period_data_bucket.additional_properties = d
        return week_period_data_bucket
