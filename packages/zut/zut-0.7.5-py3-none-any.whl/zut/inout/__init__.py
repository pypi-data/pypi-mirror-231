...
def out_table(out: Path|str|IOBase|None = None, *, dir: str|Path|None = None, title: str|None = None, append: bool = False, encoding: str = 'utf-8-sig', headers: list[str] = None, delimiter: str = None, quotechar: str = '"', tz: tzinfo = None, decimal_separator: str = None, atexit: bool|Callable = None, **kwargs) -> OutTable:
    clazz: OutTable = None
