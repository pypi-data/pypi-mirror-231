...
class OutTable(OutFile):
    ...
    def __init__(self, out: str|Path|IOBase|None = None, append: bool = False, headers: list[str] = None, tz: tzinfo = None, ms: bool = True, **kwargs):
    ...
    def _format_value(self, value: Any, index: int, depth: int = 0) -> Any:
        if value is None:
            ...
            if depth == 0 and is_iterable_of(value, (str,int,float,Decimal,bool,type(None),date,datetime,time)):
