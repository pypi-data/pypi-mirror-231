...
def out_table(out: Path|str|IOBase|None = None, *, dir: str|Path|None = None, title: str|None = None, append: bool = False, encoding: str = 'utf-8-sig', headers: list[str] = None, delimiter: str = ';', quotechar: str = '"', tz: tzinfo = None, decimal_separator: str = None, atexit: bool|Callable = None, **kwargs) -> OutTable:
    clazz: OutTable = None
...
def in_table(src: Path|str|IOBase, query: str = None, *args, dir: str|Path|None = None, title: str|None = None, encoding: str = 'utf-8', delimiter: str = ';', quotechar: str = '"', formatters: dict[int|str,Callable] = None, debug: bool = False, limit: int = None, **kwargs) -> InTable:
    clazz: InTable = None
...
def transfer_table(src: Path|str|IOBase, out: str|Path|IOBase, *, formatters: dict[int|str,Callable] = None, headers: list[str]|dict[str, Any] = None, dir: str|Path|None = None, append: bool = False, encoding: str = 'utf-8', delimiter: str = ';', quotechar: str = '"', **kwargs):
    """
