import os
from dnbc4tools.tools.utils import str_mkdir,judgeFilexits,change_path,read_json,rm_temp, get_formatted_time,setup_logging
...
class Analysis:
    ...
    def run(self):
        ...
        print(f'\n{get_formatted_time()}\n'
            f'Performing dimensionality reduction and clustering.')
