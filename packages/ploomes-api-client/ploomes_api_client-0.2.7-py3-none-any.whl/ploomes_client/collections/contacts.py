...
class Contacts:
    ...
    # Métodos para "Contacts@Origins"
    
    def get_contacts_at_origins(
        self,
        filter_=None,
        expand=None,
        top=None,
        ...
        """
        Retrieves origins related to contacts based on the provided filters.
        """
        filters = {
            "$filter": filter_,
            "$inlinecount": inlinecount,
    ...
    def post_contact_at_origins(
        ...
        """
        Creates a new origin related to a contact in the Contacts@Origins subcategory.
        """
        filters = {
            "$filter": filter_,
            "$inlinecount": inlinecount,
    ...
    def patch_contact_at_origins(
        ...
        """
        Updates a origin related to a contact by its ID in the Contacts@Origins subcategory.
        """
        filters = {
            "$filter": filter_,
            "$inlinecount": inlinecount,
        ...
        return self.client.request(
            "PATCH",
            self.path + "@Origins" + f"({id_})",
            filters={k: v for k, v in filters.items() if v is not None},
            payload=payload_json,
        )

    def delete_contact_at_origins(self, id_: int):
        """
        Deletes a origin related to a contact by its ID in the Contacts@Origins subcategory.
        """
        return self.client.request("DELETE", self.path + "@Origins" + f"({id_})")
