...
class Cities:
    ...
    # Método para "Cities@Countries"
    def get_cities_at_countries(
        self,
        filter_=None,
        expand=None,
        top=None,
        ...
        """
        Retrieves countries related to cities based on the provided filters.
        """
        filters = {
            "$filter": filter_,
            "$inlinecount": inlinecount,
    ...
    # Método para "Cities@Countries@States"
    def get_cities_at_countries_at_states(
        self,
        filter_=None,
        expand=None,
        top=None,
        ...
        """
        Retrieves states related to countries and their cities based on the provided filters.
        """
        filters = {
            "$filter": filter_,
            "$inlinecount": inlinecount,
