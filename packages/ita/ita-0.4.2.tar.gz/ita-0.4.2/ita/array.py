...
def make1d(n, value=0, random=False):
    ...
    if random:
        ...
        return [copy.deepcopy(value) for i in range(n)]
...
def make2d(n, m, value=0, random=False):
    ...
    return [make1d(m, value=value, random=random) for i in range(n)]
...
def make3d(n, m, k, value=0, random=False):
    ...
    return [make2d(m, k, value=value, random=random) for i in range(n)]
