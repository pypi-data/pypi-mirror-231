from transformers import DataCollatorWithPadding, AutoModelForSequenceClassification, TrainingArguments, Trainer,EarlyStoppingCallback, TrainerCallback, get_constant_schedule
...
def defamation_binary_sweep(
    ...
    def tokenize(example):
        return tokenizer.encode_plus(text=example["text"], truncation=True, max_length=117)
    ...
    def objective(trial):
        ...
        per_device_train_batch_size, per_device_eval_batch_size, num_labels, num_train_epochs, patience, id2label, label2id = fixed_params.values()
