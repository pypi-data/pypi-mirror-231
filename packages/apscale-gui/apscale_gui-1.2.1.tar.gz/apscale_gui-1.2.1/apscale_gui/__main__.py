...
from apscale_gui.blast_utilities import create_database_from_fasta
from apscale_gui.blast_utilities import create_database_silva
    ...
    while True:
        try:
            ...
            if event == 'open_local_blast':
                ...
                reference_databases = ['Diat.barcode', 'Custom NCBI', 'Midori2', 'pr2', 'silva']
                ...
                while (True):
                    ...
                    if event == 'database_builder':
                        ...
                        if values2['database_source_file'] == '':
                            ...
                            create_database_from_fasta(values2['database_source_file'], project_folder, databases_path)

                        elif values2['database_selection'] == 'pr2':
                            create_database_from_fasta(values2['database_source_file'], project_folder, databases_path)

                        elif values2['database_selection'] == 'silva':
                            create_database_silva(values2['database_source_file'], project_folder, databases_path)
                    ...
                    if event == 'run_blast':
                        if values2['local_blast_fasta_file'] == '' or values2['local_blast_read_table'] == '' or values2['blast_database'] == '':
                            ...
                            blastn('blastn', values2['local_blast_fasta_file'], values2['blast_database'], project_folder, 4, values2['blast_task'])
