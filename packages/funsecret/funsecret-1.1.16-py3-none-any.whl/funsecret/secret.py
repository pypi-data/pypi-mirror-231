...
from funsecret.sqlalchemy import BaseTable, create_engine, create_engine_sqlite, Base
from sqlalchemy import BIGINT, String, create_engine, select, UniqueConstraint
...
class SecretManage(BaseTable):
    ...
    def save_secret_str(self, path="~/.secret/secret_str"):
    ...
    def load_secret_str(self, secret_str=None, path="~/.secret/secret_str"):
        path = path.replace("~", os.environ["HOME"])
