...
class plotPrediction():
    ...
    def plot_hierarchical(self, df_pred: pd.DataFrame, gerarchia: str) -> plotly.graph_objs._figure.Figure:
    ...
    def plot_sum_hierarchy(self, df_pred: pd.DataFrame, gerarchia: str) -> plotly.graph_objs._figure.Figure:
    ...
    def plot_residuals(self, df_pred: pd.DataFrame, df_real: pd.DataFrame, id_pred_real: str, target: str, id_pred: str = None) -> plotly.graph_objs._figure.Figure:
