...
from albertai.config import AddConfig, ChatConfig, QueryConfig
from albertai.config.apps.BaseAppConfig import BaseAppConfig
from albertai.config.QueryConfig import DOCS_SITE_PROMPT_TEMPLATE
from albertai.data_formatter import DataFormatter
from albertai.loaders.base_loader import BaseLoader
from albertai.models.data_type import DataType
from albertai.utils import detect_datatype
...
class EmbedChain:
    ...
    def retrieve_from_database(self, input_query, config: QueryConfig):
        ...
        contents, results = self.db.query(
    ...
    def query(self, input_query, config: QueryConfig = None, dry_run=False):
        ...
        contexts, results = self.retrieve_from_database(input_query, config)
