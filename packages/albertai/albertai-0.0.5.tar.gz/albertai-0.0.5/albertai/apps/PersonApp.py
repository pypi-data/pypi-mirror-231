...
from albertai.apps.App import App
from albertai.apps.OpenSourceApp import OpenSourceApp
from albertai.config import ChatConfig, QueryConfig
from albertai.config.apps.BaseAppConfig import BaseAppConfig
from albertai.config.QueryConfig import (DEFAULT_PROMPT,
...
class PersonApp(EmbedChainPersonApp, App):
    """
    The Person app.
    Extends functionality from albertaiPersonApp and App
    """
...
class PersonOpenSourceApp(EmbedChainPersonApp, OpenSourceApp):
    """
    The Person app.
    Extends functionality from albertaiPersonApp and OpenSourceApp
    """
