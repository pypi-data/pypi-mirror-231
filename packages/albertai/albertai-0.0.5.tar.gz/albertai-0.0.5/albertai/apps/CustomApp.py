...
from albertai.config import ChatConfig, CustomAppConfig
from albertai.embedchain import EmbedChain
from albertai.models import Providers
...
class CustomApp(EmbedChain):
    ...
    def __init__(self, config: CustomAppConfig = None):
        ...
        if config.provider == Providers.GPT4ALL:
            from albertai import OpenSourceApp
