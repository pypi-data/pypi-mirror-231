...
data:extend(
{
  ...
  },
  {
    ...
    controller_steamdeck_paddle2 = make_controller_icon("__core__/graphics/icons/controller/steam-deck/color/L5.png"),
    controller_steamdeck_paddle3 = make_controller_icon("__core__/graphics/icons/controller/steam-deck/color/R4.png"),
    ...
    controller_steamdeck_black_paddle2 = make_controller_icon("__core__/graphics/icons/controller/steam-deck/black/L5.png"),
    controller_steamdeck_black_paddle3 = make_controller_icon("__core__/graphics/icons/controller/steam-deck/black/R4.png"),
