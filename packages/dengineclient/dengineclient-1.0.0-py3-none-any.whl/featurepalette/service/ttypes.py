...
import dengineclient.featurepalette.errno.ttypes
import dengineclient.featurepalette.response.ttypes
import dengineclient.featurepalette.trace.ttypes
...
class FeatureRsp(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRUCT, 'header', (dengineclient.featurepalette.response.ttypes.ResponseHeader, dengineclient.featurepalette.response.ttypes.ResponseHeader.thrift_spec), None, ),  # 1
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.header = dengineclient.featurepalette.response.ttypes.ResponseHeader()
