...
m1_ned = aa.find_instrument_attitude(r_m1,dict_rri['GEIx'], dict_rri['GEIy'], 
                                    ...
                                    method1='ephemeris', 
                                    frame2 = 'itrf', frame3 = 'ned')
m1_enu = urm.ned2enu(m1_ned).T 
# ----------------------------------------------------------------------------
body_m2 = [0, a, a]  # dipole1
r_m2 = aa.rotate_inst(body_m2, dict_rri['roll'], dict_rri['pitch'], 
                      dict_rri['yaw'])
m2_ned = aa.find_instrument_attitude(r_m2,dict_rri['GEIx'], dict_rri['GEIy'], 
                                    dict_rri['GEIz'], dict_rri['GEIVx'], 
                                    dict_rri['GEIVy'], dict_rri['GEIVz'], 
                                    dict_rri['GEOx'], dict_rri['GEOy'], 
                                    dict_rri['GEOz'], dict_rri['time_array'], 
...
m3_ned = aa.find_instrument_attitude(r_m3,dict_rri['GEIx'], dict_rri['GEIy'], 
                                    ...
                                    method1='ephemeris', 
                                    frame2 = 'itrf', frame3 = 'ned')
m3_enu = urm.ned2enu(m3_ned).T 
# ---------------------------------------------------------------------------- 
body_m4 = [0, -a, a]  # dipole2
r_m4 = aa.rotate_inst(body_m4, dict_rri['roll'], dict_rri['pitch'], 
                      dict_rri['yaw'])
m4_ned = aa.find_instrument_attitude(r_m4,dict_rri['GEIx'], dict_rri['GEIy'], 
                                    dict_rri['GEIz'], dict_rri['GEIVx'], 
                                    dict_rri['GEIVy'], dict_rri['GEIVz'], 
                                    dict_rri['GEOx'], dict_rri['GEOy'], 
                                    dict_rri['GEOz'], dict_rri['time_array'], 
