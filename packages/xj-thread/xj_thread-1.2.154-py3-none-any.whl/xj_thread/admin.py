...
class ThreadAdmin(admin.ModelAdmin):
    ...
    list_display = (
        ...
        'has_comment',
        'has_location', 'short_cover', 'short_photos', 'short_video', 'short_files', 'price', 'is_original', 'link',
        'create_time',
        'update_time', 'publish_time', 'short_logs', 'short_more', 'sort', 'language_code',
    )
    search_fields = (
        'title', 'subtitle', 'summary', 'content', 'region_code', 'publish_time'
    )
    fields = (
        ...
        'update_time', 'publish_time', 'logs', 'more', 'sort', 'language_code', 'region_code'
    )
...
class ThreadMainExtendFieldAdmin(admin.ModelAdmin):
    ...
    list_display = ("id", "category", 'field_index', 'field', 'value', "default", 'type', 'unit', 'config_short',
                    'description')
...
class ThreadCategoryAdmin(admin.ModelAdmin):
    list_display = (
        'id', 'platform_code', 'value', 'name', 'need_auth', 'short_description', 'sort', 'parent', "is_deleted",
        "config")
    search_fields = ('id', 'platform_code', 'value', 'name',)
    fields = (
        'id', 'platform_code', 'value', 'name', 'need_auth', 'description', 'sort', 'parent', "is_deleted", "config")
    fields = ('id', 'platform_code', ('value', 'name'), 'need_auth', "config", 'parent', 'description',
              'sort', "is_deleted")
    list_display = ('id', 'platform_code', 'value', 'name', 'need_auth', "config", 'parent', 'short_description',
                    'sort', "is_deleted")
...
class ThreadExtendDataAdmin(admin.ModelAdmin):
    ...
    list_display = (
        ...
        'short_field_6', 'short_field_7', 'short_field_8', 'short_field_9', 'short_field_10',
        'short_field_11', 'short_field_12', 'short_field_13', 'short_field_14', 'short_field_15',
        'short_field_16', 'short_field_17', 'short_field_18', 'short_field_19', 'short_field_20')
    search_fields = (
        'thread_id', 'short_field_1', 'short_field_2', 'short_field_3', 'short_field_4', 'short_field_5',
        'short_field_6', 'short_field_7', 'short_field_8', 'short_field_9', 'short_field_10',
        'short_field_11', 'short_field_12', 'short_field_13', 'short_field_14', 'short_field_15',
...
class ThreadStatisticAdmin(admin.ModelAdmin):
    fields = ('thread_id', 'flag_classifies', 'flag_weights', 'weight', ('views', 'plays', 'comments'), ('likes',
              'favorite', 'shares'),)
    list_display = ('thread_id', 'flag_classifies', 'flag_weights', 'weight', 'views', 'plays', 'comments', 'likes',
                    'favorite', 'shares',)
    search_fields = ('thread_id', 'flag_classifies', 'flag_weights', 'weight', 'views', 'plays', 'comments', 'likes',
                     'favorite', 'shares',)
    raw_id_fields = ['thread_id']
