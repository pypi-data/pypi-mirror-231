...
class SchemaBuilder(object):
    ...
    _global_types: typing.Dict[typing.Any, FieldEncoder] = {}
    ...
    def __init__(
        ...
        :param strict: if true, unknown properties of an object will make the
            validation fail
        """
        self._dataclass = _dataclass_params or _DataClassParams(dataclass)
    ...
    @classmethod
    def register_global_type(cls, type_: typing.Any, encoder: FieldEncoder) -> None:
        """
    ...
    @classmethod
    def unregister_global_type(cls, type_: typing.Any) -> None:
        """
    ...
    def _create_json_schema(
        ...
        param_args = {
            param: arg
            for arg, param in zip(self._dataclass.arguments, self._dataclass.parameters)
        }
        ...
        for vfield in self._fields:
            ...
            is_required = (
                ...
                and vfield.field.default_factory is dataclasses.MISSING
            )
            ...
            for item_type in self._get_types(field_type):
                ...
                try:
                    params = _DataClassParams(item_type, param_args)
        ...
        if field_type in self._global_types:
            ...
            param_args = {
                ...
                for arg, param in zip(
                    self._dataclass.arguments, self._dataclass.parameters
                )
            }
            try:
