...
setuptools.setup(
    name='pollination-sky-view',                                     # will be used for package name
    ...
    keywords='honeybee, radiance, ladybug-tools, sky, view, exposure, spherical, sky-view',# will be used as keywords
