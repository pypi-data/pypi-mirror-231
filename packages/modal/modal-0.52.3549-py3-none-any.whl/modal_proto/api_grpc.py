...
class ModalClientBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def RelayList(self, stream: 'grpclib.server.Stream[google.protobuf.empty_pb2.Empty, modal_proto.api_pb2.RelayListResponse]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            ...
            '/modal.client.ModalClient/RelayList': grpclib.const.Handler(
                self.RelayList,
                grpclib.const.Cardinality.UNARY_UNARY,
                google.protobuf.empty_pb2.Empty,
                modal_proto.api_pb2.RelayListResponse,
            ),
...
class ModalClientStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.RelayList = grpclib.client.UnaryUnaryMethod(
            channel,
