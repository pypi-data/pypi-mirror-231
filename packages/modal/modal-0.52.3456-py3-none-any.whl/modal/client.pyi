...
class _Client:
    def __init__(self, server_url, client_type, credentials, version='0.52.3456', *, no_verify=False):
        ...
    ...
    async def finish_token_flow(self, token_flow_id: str, timeout: float = 40) -> typing.Union[typing.Tuple[str, str], None]:
        ...
...
class Client:
    ...
    class __finish_token_flow_spec(typing_extensions.Protocol):
        def __call__(self, token_flow_id: str, timeout: float = 40) -> typing.Union[typing.Tuple[str, str], None]:
            ...

        async def aio(self, *args, **kwargs) -> typing.Union[typing.Tuple[str, str], None]:
            ...
