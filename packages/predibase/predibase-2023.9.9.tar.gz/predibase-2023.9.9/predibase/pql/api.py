...
class Session:
            ...
            if curr_status != last_status:
                ...
                if curr_status != "training":
                    ...
                    metrics_thread = Thread(
                        ...
                        args=(resp["modelVersion"]["id"], training_bar),
                    )
    ...
    def _stream_model_metrics(self, model_id: str, training_bar: tqdm, max_attempts: int = 10):
            ...
            try:
                ...
                if len(resp["data"]) > 0:
                    ...
                    for epoch_data in metrics_data[run_id]:
                        ...
                        curr_epoch_to_print = epoch_in_data + 1
                ...
                if resp["meta"]["is_completed"]:
                    ...
                    epochs_fraction = ""
                    if steps_per_epoch:
                        epochs = training_bar.total // steps_per_epoch
