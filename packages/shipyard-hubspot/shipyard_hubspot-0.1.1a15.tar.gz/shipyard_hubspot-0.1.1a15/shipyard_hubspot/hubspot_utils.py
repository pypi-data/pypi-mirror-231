...
def handle_import_file(
        filename, file_format="CSV", headers_match=True, hubspot_alternate_id="email", object_type="contacts"
):
    """
    ...
    if headers_match:
        ...
        with open(filename, "r") as file:
            ...
            for header in headers:
                if header == hubspot_alternate_id:  # Apply the unique id tag to email addresses
                    mapping.append(
                        column_to_hubspot(hubspot_property_name=header,
                    ...
                    mapping.append(column_to_hubspot(
