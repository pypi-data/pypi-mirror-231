...
from .settings import (
    DJANGO_REDIS_DATA_MANAGER_REDIS_INSTANCE_CONNECTION_SAFE_FIELD_PASSWORD,
)
...
class RedisInstanceBase(models.Model):
    ...
    connection = SafeCharField(
        max_length=4096,
        password=DJANGO_REDIS_DATA_MANAGER_REDIS_INSTANCE_CONNECTION_SAFE_FIELD_PASSWORD,
        verbose_name=_("Connection"),
    )
    key_separator = models.CharField(
        max_length=16, default=":", verbose_name=_("Key Separator")
    )
