...
def register_renderer(app, id, renderer, force=True):
    ...
    :param force: Whether to overwrite the renderer if a different one
    ...
    def __getitem__(self, key):
        ...
        if callable(item):
            try:
                ...
                raise NavbarRenderingError("Encountered {!r} while trying to render navbar".format(e))
...
class Nav(object):
    ...
    def navigation(self, id=None):
        ...
        :param id: ID to pass on. If ``None``, use the decorated functions
                   name.
        """
        def wrapper(f):
    ...
    def register_element(self, id, elem):
        """Register a navigational element.
        ...
        :param id: I'd to register element with
    ...
    def renderer(self, id=None, force=True):
        ...
        :param id: I'd for the renderer, default to the class name in snake
                   case.
        :param force: Whether to overwrite existing renderers.
        """
        def _(cls):
            name = cls.__name__
