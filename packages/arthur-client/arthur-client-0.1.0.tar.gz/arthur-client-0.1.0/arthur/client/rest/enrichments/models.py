...
#   timestamp: 2023-09-21T20:13:26+00:00
...
class BiasMitigationEnrichmentConfiguration(BaseModel):
    enabled: bool
    """
...
class PipelineStatus(str, Enum):
    """
    status of the enrichment pipeline, the status will be 'updating' while enrichments are being reconfigured, and 'ready' or 'disabled' when the updates are complete.
    """
...
class AnomalyDetectionEnrichmentConfiguration(BiasMitigationEnrichmentConfiguration):
    pass
...
class BiasMitigationEnrichmentResponse(BiasMitigationEnrichmentConfiguration):
    """
    The response object containing configuration and status of an on-by-default enrichment.
    """
...
class HotspotsEnrichmentConfiguration(BiasMitigationEnrichmentConfiguration):
    pass
