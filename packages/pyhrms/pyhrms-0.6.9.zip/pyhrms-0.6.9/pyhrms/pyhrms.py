...
def build_molecular_network(data, parent_cmps,
                            ...
                            insource_frag_RT_threshold=0.1,
                            parent_cmps_color='r',
                            insource_cmp_color='g',
                            tp_cmps_color='m',
                            ...
                            default_color='g',
                            default_size=5,
                            default_edge_widths=0.5,
                            network_type='random_layout',
                            with_labels=False,
                            legend=True, other_cmps=[],
                            figsize=(5, 5), path=None, dpi=300):
    """
    ...
    nx.draw(G, pos, with_labels=with_labels, node_color=colors, node_size=sizes, width=edge_widths)
    # Create and show legend if `legend` is set to True
    if legend:
        # Creating legend entries
        red_patch = mpatches.Patch(color=parent_cmps_color, label='Parent Compounds')
        green_patch = mpatches.Patch(color=insource_cmp_color, label='In-source Fragments')
        magenta_patch = mpatches.Patch(color=tp_cmps_color, label='TP Compounds')
