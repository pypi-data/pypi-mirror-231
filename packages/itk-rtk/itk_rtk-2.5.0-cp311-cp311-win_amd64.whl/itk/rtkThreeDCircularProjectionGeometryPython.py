...
class rtkThreeDCircularProjectionGeometry(itk.rtkProjectionGeometryPython.rtkProjectionGeometry3):
    ...
    GetVerifyAnglesTolerance = _swig_new_instance_method(_rtkThreeDCircularProjectionGeometryPython.rtkThreeDCircularProjectionGeometry_GetVerifyAnglesTolerance)
    SetVerifyAnglesTolerance = _swig_new_instance_method(_rtkThreeDCircularProjectionGeometryPython.rtkThreeDCircularProjectionGeometry_SetVerifyAnglesTolerance)
    GetFixAnglesTolerance = _swig_new_instance_method(_rtkThreeDCircularProjectionGeometryPython.rtkThreeDCircularProjectionGeometry_GetFixAnglesTolerance)
    SetFixAnglesTolerance = _swig_new_instance_method(_rtkThreeDCircularProjectionGeometryPython.rtkThreeDCircularProjectionGeometry_SetFixAnglesTolerance)
