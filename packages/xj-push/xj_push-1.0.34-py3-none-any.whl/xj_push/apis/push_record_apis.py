...
from ..services.push_record_service import PushRecordService
...
class PushRecordApis(APIView):
    ...
    def add(self, *args, user_info, request_params, **kwargs, ):
        ...
        push_set, err = PushRecordService.add(params)
        if err is None:
    ...
    def edit(self, *args, user_info, request_params, **kwargs, ):
        ...
        push_set, err = PushRecordService.edit(params, push_id)
        if err is None:
            return util_response(data=push_set)
        return util_response(err=47767, msg=err)
    ...
    def list(self, *args, user_info, request_params, **kwargs, ):
        ...
        push_set, err = PushRecordService.list(params)
