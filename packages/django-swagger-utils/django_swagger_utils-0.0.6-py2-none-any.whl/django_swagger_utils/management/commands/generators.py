...
from django_swagger_utils.server.templates.serializer import SERIALIZER
from django_swagger_utils.server.templates.apiview import API_URL, API_VIEW
from django_swagger_utils.server.templates.viewset import VIEW_SET_URL, VIEW_SET_VIEW
from django_swagger_utils.server.templates.function import FUNCTION_URL, FUNCTION_VIEW
from django_swagger_utils.server.templates.modelviewset import MODEL_URL, MODEL_VIEW
...
class BaseGenerator(object):
    ...
    def generate_urls(self):
        ...
        filename = 'drf_swagger_utils/urls.py'
        if self.write_file(content, filename):
            return '  - writing %s' % filename
        else:
