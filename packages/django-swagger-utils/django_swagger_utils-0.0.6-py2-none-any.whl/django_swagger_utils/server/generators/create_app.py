import os
import argparse
from django_swagger_utils.server.constants.cleanapp import *
from django_swagger_utils.server.templates.app_template import APP_CONFIG
    ...
    if args.get('app'):
        ...
        if not os.path.exists(app_name):
            try:
                ...
                create_file(app_directory, '../../management/commands/__init__.py')
                ...
                for module in directory_list:
                    ...
                    create_file(module_directory, '../../management/commands/__init__.py')
                    if module == "tests":
