...
from qkd_simulator.grpc_serialization import interfaces_pb2
from enum import Enum
from qkd_simulator.grpc_serialization import interfaces_pb2_grpc
from qkd_simulator.database import ApplicationURI
import json
