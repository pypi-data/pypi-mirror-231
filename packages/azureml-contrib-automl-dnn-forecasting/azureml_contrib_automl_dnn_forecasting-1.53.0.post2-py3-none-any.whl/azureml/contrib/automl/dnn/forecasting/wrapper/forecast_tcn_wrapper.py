...
class ForecastTCNWrapper(DNNForecastWrapper):
    ...
    def train(self, n_epochs: int, X: DataInputType = None, y: DataInputType = None,
        ...
        if self.forecaster is None:
            ...
            self._build_model_forecaster(
                run_update_callback, dset_config, ds, ds.embedding_col_infos, ds._future_channels
            )
    ...
    def _distributed_train(self,
        ...
        _, future_channels, __ = get_dataset_future_features(
            train_featurized_dataset,
            columns,
