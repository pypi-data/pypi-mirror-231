...
from ..pre_record import Service, OrderResults
...
class ClientService:
    ...
    def get_results(self, query: ClientResultsRequest, timeout=3) -> SDKResponse[ClientResultsResponse]:
        params = {
    ...
    def get_lab(self, query: ClientLabOrderRequest, timeout=3) -> SDKResponse[List[ClientLabOrderResponse]]:
        return self._client.get(
            urljoin(
                str(self._url), f"mobil/client/{query.client_uuid}/lab_results/"
            ),
